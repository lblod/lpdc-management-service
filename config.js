...
const ENABLE_CONCEPT_MODIFICATION_FLAG_UPDATE = process.env.ENABLE_CONCEPT_MODIFICATION_FLAG_UPDATE == 'false' ? false : true;
...
export {
  ...
  FORM_MAPPING,
  PREFIXES,
  ENABLE_CONCEPT_MODIFICATION_FLAG_UPDATE,
