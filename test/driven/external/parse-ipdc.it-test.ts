...
export const instancePublishedOnIpdcTni = new InstanceBuilder()
  ...
  .withRequirements([
    new RequirementBuilder()
      .withId(
        new Iri(
          "http://data.lblod.info/id/requirement/2e24c02e-0de5-4460-8366-1a76514e0407",
        ),
      )
      .withUuid("2e24c02e-0de5-4460-8366-1a76514e0407")
      .withTitle(LanguageString.of(undefined, "Voorwaarden"))
      .withDescription(
        LanguageString.of(
          undefined,
      ...
      .withEvidence(
        new EvidenceBuilder()
          .withId(
            new Iri(
              "http://data.lblod.info/id/evidence/d3ec32ba-4ed5-4072-af39-591b5c232974",
            ),
          )
          .withUuid("d3ec32ba-4ed5-4072-af39-591b5c232974")
          .withTitle(LanguageString.of(undefined, "Bewijs"))
          .withDescription(
            LanguageString.of(
              undefined,
  ...
  .withProcedures([
    new ProcedureBuilder()
      .withId(
        new Iri(
          "http://data.lblod.info/id/rule/91e7e795-6d19-4cdd-b039-cc94fb1ccc8f",
        ),
      )
      .withUuid("91e7e795-6d19-4cdd-b039-cc94fb1ccc8f")
      .withTitle(LanguageString.of(undefined, "Procedure"))
      .withDescription(
        LanguageString.of(
          undefined,
      ...
      .withWebsites([
        new WebsiteBuilder()
          .withId(
            new Iri(
              "http://data.lblod.info/id/website/b99e8207-7af5-420e-9d46-d66d7f0a401c",
            ),
          )
          ...
          .withUrl(
            "https://stad.gent/nl/reglementen/subsidiereglement-voor-de-financiele-ondersteuning-van-projecten-kunst-cultuur-en-cultureel-erfgoed",
          )
          .withOrder(0)
          .build(),
        new WebsiteBuilder()
          .withId(
            new Iri(
              "http://data.lblod.info/id/website/a411b281-70b7-42ab-acf4-32e4f1341c53",
            ),
          )
          .withUuid("a411b281-70b7-42ab-acf4-32e4f1341c53")
          .withTitle(
            LanguageString.of(undefined, "Subsidie verfraaing handelspanden"),
          )
          .withDescription(undefined)
          .withUrl(
            "https://stad.gent/nl/ondernemen/ondersteuning-en-premies-voor-ondernemers/sectoroverschrijdend/subsidie-verfraaiing-handelspand/subsidie-verfraaiing-handelspanden",
          )
          .withOrder(1)
          .build(),
      ])
  ...
  .withWebsites([
    new WebsiteBuilder()
      .withId(
        new Iri(
          "http://data.lblod.info/id/website/494dee06-d193-422b-9578-c14c2cecd6aa",
        ),
      )
      .withUuid("494dee06-d193-422b-9578-c14c2cecd6aa")
      .withTitle(LanguageString.of(undefined, "website 1"))
      .withDescription(
        LanguageString.of(
          undefined,
    ...
    new WebsiteBuilder()
      .withId(
        new Iri(
          "http://data.lblod.info/id/website/16711870-514c-4d64-bc9a-45663d4a6b1d",
        ),
      )
      .withUuid("16711870-514c-4d64-bc9a-45663d4a6b1d")
      .withTitle(LanguageString.of(undefined, "Starterscontract"))
      .withDescription(undefined)
      .withUrl(
        "https://stad.gent/nl/ondernemen/een-onderneming-starten-gent/starterscontract",
      )
      .withOrder(1)
      .build(),
  ])
  .withCosts([
    new CostBuilder()
      .withId(
        new Iri(
          "http://data.lblod.info/id/cost/45a39cc3-2201-4661-9759-9d12dff6065b",
        ),
      )
    ...
    new CostBuilder()
      .withId(
        new Iri(
          "http://data.lblod.info/id/cost/e120e5df-cb2d-4d72-bf9d-48854fd2c748",
        ),
      )
  ...
  .withFinancialAdvantages([
    new FinancialAdvantageBuilder()
      .withId(
        new Iri(
          "http://data.lblod.info/id/financial-advantage/9feda2ec-6bc0-479e-ae8a-2bf73c143bbe",
        ),
      )
    ...
    new FinancialAdvantageBuilder()
      .withId(
        new Iri(
          "http://data.lblod.info/id/financial-advantage/d97330de-8110-4fd3-ab68-76e22d71dd39",
        ),
      )
  ...
  .withLegalResources([
    new LegalResourceBuilder()
      .withId(
        new Iri(
          "http://data.lblod.info/id/legal-resource/17f01e3a-3d4a-4492-8989-b0c9e17ff990",
        ),
      )
      .withUuid("17f01e3a-3d4a-4492-8989-b0c9e17ff990")
      .withTitle(LanguageString.of(undefined, "regelgeving titel"))
      .withDescription(
        LanguageString.of(
          undefined,
      ...
      .withUrl(
        "https://codex.vlaanderen.be/Zoeken/Document.aspx?DID=1026320&param=informatie&ref=search&AVIDS=1281445",
      )
      .withOrder(0)
      .build(),
    new LegalResourceBuilder()
      .withId(
        new Iri(
          "http://data.lblod.info/id/legal-resource/75d1ef7f-d31c-4432-8f64-7a5bd4756db3",
        ),
      )
      .withUuid("75d1ef7f-d31c-4432-8f64-7a5bd4756db3")
      .withTitle(LanguageString.of(undefined, "regelgeving 2"))
      .withDescription(
        LanguageString.of(
          undefined,
      ...
      .withUrl(
        "https://codex.vlaanderen.be/Zoeken/Document.aspx?DID=1039211&param=informatie&ref=search&AVIDS=",
      )
      .withOrder(1)
      .build(),
  ])
...
describe("Instance informal language strings fetcher ipdc", () => {
  ...
  test("informal values are parsed into the original dutchLanguage variant", async () => {
    const mappedInstance = await ipdcFetcher.fetchInstanceAndMap(
      bestuurseenheid,
  ...
  test("when receiving an instance with a missing value, throw error", async () => {
    const instance = InstanceBuilder.from(instancePublishedOnIpdcTni)
      ...
      .build();
    await expect(
      ipdcFetcher.fetchInstanceAndMap(bestuurseenheid, instance),
    ).rejects.toThrowWithMessage(
      SystemError,
      `De nieuwe en initiële waarde moeten beiden aanwezig of afwezig zijn {nieuw[{"_nl":"<p data-indentation-level=\\"0\\">Dit is de hoofding voor een volledig ingevulde test zodat u het contract tussen ipdc en lpdc kan testen</p>","_nlFormal":"<p data-indentation-level=\\"0\\">Dit is de hoofding voor een volledig ingevulde test zodat u het contract tussen ipdc en lpdc kan testen</p>","_nlGeneratedInformal":"<p data-indentation-level=\\"0\\">Dit is de hoofding voor een volledig ingevulde test zodat je het contract tussen ipdc en lpdc kan testen</p>"}], initial[undefined], dutchLanguage[nl-be-x-formal]}`,
    );
  });

  test("when instance is not found, throw error", async () => {
    const unexistingInstance = aFullInstance()
      .withCreatedBy(bestuurseenheid.id)
      .build();
    await expect(
      ipdcFetcher.fetchInstanceAndMap(bestuurseenheid, unexistingInstance),
    ).rejects.toThrowWithMessage(
      SystemError,
      `Instantie ${unexistingInstance.id} niet gevonden bij ipdc`,
    );
  });
  ...
  describe("Requirement", () => {
    ...
    test("When receiving an additional requirement, throw error", async () => {
      const additionalRequirement = aMinimalRequirementForInstance()
        .withOrder(1)
        .build();
      const newRequirements = [
        ...instancePublishedOnIpdcTni.requirements,
        additionalRequirement,
      ];

      const instance = InstanceBuilder.from(instancePublishedOnIpdcTni)
        .withRequirements(newRequirements)
        .build();
    ...
    test("when receiving a missing evidence in a requirement, throw error", async () => {
      ...
      requirements[0] = RequirementBuilder.from(requirements[0])
  ...
  describe("Procedure", () => {
    ...
    test("When receiving an additional procedure, throw error", async () => {
      const additionalProcedure = aMinimalProcedureForInstance()
        .withOrder(1)
        .build();
      const newProcedures = [
        ...instancePublishedOnIpdcTni.procedures,
        additionalProcedure,
      ];

      const instance = InstanceBuilder.from(instancePublishedOnIpdcTni)
        .withProcedures(newProcedures)
        .build();
    ...
    test("when receiving a missing website in a procedure, throw error", async () => {
      ...
      procedures[0] = ProcedureBuilder.from(procedures[0])
        .withWebsites([
          new WebsiteBuilder()
            .withId(
              new Iri(
    ...
    test("when receiving an additional website in a procedure, throw error", async () => {
      const procedures = instancePublishedOnIpdcTni.procedures;
      const additionalWebsite = aMinimalWebsiteForInstance()
        .withOrder(2)
        .build();
      procedures[0] = ProcedureBuilder.from(procedures[0])
        .withWebsites([...procedures[0].websites, additionalWebsite])
        .build();
  ...
  describe("Websites", () => {
    ...
    test("when receiving an additional website, throw error", async () => {
      ...
      const newWebsites = [
        ...instancePublishedOnIpdcTni.websites,
        additionalWebsite,
      ];

      const instance = InstanceBuilder.from(instancePublishedOnIpdcTni)
        .withWebsites(newWebsites)
        .build();
      await expect(
        ipdcFetcher.fetchInstanceAndMap(bestuurseenheid, instance),
      ).rejects.toThrowWithMessage(
  ...
  describe("Financial advantages", () => {
    ...
    test("when receiving an additional financial advantage, throw error", async () => {
      const additionalFinancialAdvantage =
        aMinimalFinancialAdvantageForInstance().withOrder(2).build();

      const newFinancialAdvantages = [
        ...instancePublishedOnIpdcTni.financialAdvantages,
        additionalFinancialAdvantage,
      ];

      const instance = InstanceBuilder.from(instancePublishedOnIpdcTni)
        .withFinancialAdvantages(newFinancialAdvantages)
        .build();
      await expect(
        ipdcFetcher.fetchInstanceAndMap(bestuurseenheid, instance),
      ).rejects.toThrowWithMessage(
  ...
  describe("Legal resources", () => {
    ...
    test("when receiving an additional legal resource, throw error", async () => {
      const additionalLegalResource = aMinimalLegalResourceForConcept()
        .withOrder(2)
        .build();

      const newLegalResources = [
        ...instancePublishedOnIpdcTni.legalResources,
        additionalLegalResource,
      ];

      const instance = InstanceBuilder.from(instancePublishedOnIpdcTni)
        .withLegalResources(newLegalResources)
        .build();
      await expect(
        ipdcFetcher.fetchInstanceAndMap(bestuurseenheid, instance),
      ).rejects.toThrowWithMessage(
    ...
    const jsonLdData = `[
  {
    ...
    "http://www.w3.org/ns/adms#status": [
      {
        "@id": "http://lblod.data.gift/concepts/instance-status/verzonden"
      }
    ],
      ...
      parse(
        ...
        (error: any, kb: any) => {
          ...
          if (originalQuads.length < 5) {
            reject(
              new SystemError(
                `Er is een fout opgetreden bij het bevragen van Ipdc voor instance ${instancePublishedOnIpdcTni.id}`,
              ),
            );
          }
          ...
          const allInformalQuads = originalQuads
            .filter(
              (q) =>
                isLiteral(q.object) &&
            ...
            .map((q) =>
              quad(
                q.subject,
                q.predicate,
                literal(`${q.object.value} - informal`, "nl-be-x-informal"),
                q.graph,
              ),
            );
