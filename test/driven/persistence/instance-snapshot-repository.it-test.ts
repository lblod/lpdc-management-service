...
describe("InstanceSnapshotRepository", () => {
  const repository = new InstanceSnapshotSparqlTestRepository(
  ...
  describe("findById", () => {
    test("When full instance snapshot exists with id, then return instance snapshot", async () => {
      ...
      const anotherInstanceSnapshot = aFullInstanceSnapshot()
    ...
    test("When minimal instance snapshot exists with id, then return instance snapshot", async () => {
      ...
      const anotherInstanceSnapshot = aMinimalInstanceSnapshot()
        .withCreatedBy(anotherBestuurseenheid.id)
        .build();
      await repository.save(instanceSnapshotGraph, anotherInstanceSnapshot);
    ...
    test("When instance snapshot does not exist with id, then throw error", async () => {
      ...
      const nonExistentInstanceSnapshotId =
        buildInstanceSnapshotIri("thisiddoesnotexist");

      await expect(
        repository.findById(
          instanceSnapshotGraph,
          nonExistentInstanceSnapshotId,
        ),
      ).rejects.toThrowWithMessage(
        NotFoundError,
        `Kan <http://data.lblod.info/id/public-service-snapshot/thisiddoesnotexist> niet vinden voor type <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#InstancePublicServiceSnapshot> in graph <http://mu.semte.ch/graphs/lpdc/instancesnapshots-ldes-data/an-integrating-partner>`,
      );
    });
    ...
    test("When instance snapshot does not exist in given graph, then throw error", async () => {
      ...
      await expect(
        repository.findById(
          new Iri(INSTANCE_SNAPHOT_LDES_GRAPH("another-integrating-partner")),
          instanceSnapshot.id,
        ),
      ).rejects.toThrowWithMessage(
        NotFoundError,
        `Kan <${instanceSnapshot.id.value}> niet vinden voor type <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#InstancePublicServiceSnapshot> in graph <http://mu.semte.ch/graphs/lpdc/instancesnapshots-ldes-data/another-integrating-partner>`,
      );
    });
    ...
    test("When requesting a graph that is not a subgraph of the instance snapshot graph, then throw error", async () => {
      ...
      await expect(
        repository.findById(new Iri(PUBLIC_GRAPH), instanceSnapshot.id),
      ).rejects.toThrowWithMessage(
        SystemError,
        `Kan Instance Snapshots niet opzoeken in graph <http://mu.semte.ch/graphs/public>`,
      );
    });
  });
  ...
  describe("Verify ontology and mapping", () => {
    test("Verify minimal mapping", async () => {
      ...
      const instanceSnapshot = aMinimalInstanceSnapshot()
        ...
        .withCompetentAuthorities([
          InstanceSnapshotTestBuilder.COMPETENT_AUTHORITIES[0],
        ])
        .withSpatials([InstanceSnapshotTestBuilder.SPATIALS[0]])
        .build();

      await directDatabaseAccess.insertData(instanceSnapshotGraph.value, [
      ...
      const actualInstanceSnapshot = await repository.findById(
        instanceSnapshotGraph,
        instanceSnapshotId,
      );
    ...
    test("Verify minimal mapping with unknown languages", async () => {
      ...
      const instanceSnapshot = aMinimalInstanceSnapshot()
        ...
        .withIsVersionOfInstance(instanceId)
        .withKeywords([
          InstanceSnapshotTestBuilder.KEYWORDS[0],
          InstanceSnapshotTestBuilder.KEYWORDS[1],
        ])
    ...
    test("Unknown ProductType can not be mapped", async () => {
      ...
      await expect(
        repository.findById(instanceSnapshotGraph, instanceSnapshotIri),
      ).rejects.toThrowWithMessage(
        SystemError,
        `Kan '<${instanceSnapshotIri}> <http://purl.org/dc/terms/type> <https://productencatalogus.data.vlaanderen.be/id/concept/Type/UnknownProductType> .' niet mappen.`,
      );
    });
    ...
    test("Unknown Target Audience Type can not be mapped", async () => {
      ...
      await expect(
        ...
        SystemError,
        `Kan '<${instanceSnapshotIri}> <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#targetAudience> <https://productencatalogus.data.vlaanderen.be/id/concept/Doelgroep/NonExistingTargetAudience> .' niet mappen.`,
      );
    });
    ...
    test("Unknown Theme type can not be mapped", async () => {
      ...
      await expect(
        ...
        SystemError,
        `Kan '<${instanceSnapshotIri}> <http://data.europa.eu/m8g/thematicArea> <https://productencatalogus.data.vlaanderen.be/id/concept/Thema/NonExistingTheme> .' niet mappen.`,
      );
    });
    ...
    test("Unknown Competent Authority Level type can not be mapped", async () => {
      ...
      await expect(
        ...
        SystemError,
        `Kan '<${instanceSnapshotIri}> <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#competentAuthorityLevel> <https://productencatalogus.data.vlaanderen.be/id/concept/BevoegdBestuursniveau/NonExistingCompetentAuthorityLevel> .' niet mappen.`,
      );
    });
    ...
    test("Unknown ExecutingAuthorityLevelType can not be mapped", async () => {
      ...
      await expect(
        ...
        SystemError,
        `Kan '<${instanceSnapshotIri}> <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#executingAuthorityLevel> <https://productencatalogus.data.vlaanderen.be/id/concept/UitvoerendBestuursniveau/NonExistingExecutingAuthorityLevel> .' niet mappen.`,
      );
    });
    ...
    test("Unknown PublicationMediumType can not be mapped", async () => {
      ...
      await expect(
        repository.findById(instanceSnapshotGraph, instanceSnapshotId),
      ).rejects.toThrowWithMessage(
        SystemError,
        `Kan '<${instanceSnapshotId}> <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#publicationMedium> <https://productencatalogus.data.vlaanderen.be/id/concept/PublicatieKanaal/NonExistingPublicationMedium> .' niet mappen.`,
      );
    });
    ...
    test("Unknown YourEuropeCategoryType can not be mapped", async () => {
      ...
      await expect(
        ...
        SystemError,
        `Kan '<${instanceSnapshotIri}> <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#yourEuropeCategory> <https://productencatalogus.data.vlaanderen.be/id/concept/YourEuropeCatagory/NonExistingYourEuropeCategory> .' niet mappen.`,
      );
    });
    ...
    test("Unknown LanguageType can not be mapped", async () => {
      ...
      await expect(
        ...
        SystemError,
        `Kan '<${instanceSnapshotId}> <http://purl.org/dc/terms/language> <http://publications.europa.eu/resource/authority/language/NonExistingLanguageType> .' niet mappen.`,
      );
    });
