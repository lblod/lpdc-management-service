        ...
        test('Verify full mapping', async () => {
            ...
            await directDatabaseAccess.insertData(
                ...
                [
                    ...
                    `${sparqlEscapeUri(InstanceSnapshotTestBuilder.REQUIREMENTS[1].id)} <http://data.europa.eu/m8g/hasSupportingEvidence> <${InstanceSnapshotTestBuilder.REQUIREMENTS[1].evidence.id}>`,
                    ...
                    `${sparqlEscapeUri(InstanceSnapshotTestBuilder.REQUIREMENTS[0].id)} <http://data.europa.eu/m8g/hasSupportingEvidence> <${InstanceSnapshotTestBuilder.REQUIREMENTS[0].evidence.id}>`,
                    ...
                    `${sparqlEscapeUri(instanceSnapshotId)} <http://www.w3.org/2000/01/rdf-schema#seeAlso> <${InstanceSnapshotTestBuilder.WEBSITES[1].id}>`,
                    ...
                    `${sparqlEscapeUri(instanceSnapshotId)} <http://www.w3.org/2000/01/rdf-schema#seeAlso> <${InstanceSnapshotTestBuilder.WEBSITES[0].id}>`,
                    ...
                    `${sparqlEscapeUri(instanceSnapshotId)} <http://purl.org/vocab/cpsv#follows> <${InstanceSnapshotTestBuilder.PROCEDURES[1].id}>`,
                    ...
                    `${sparqlEscapeUri(InstanceSnapshotTestBuilder.PROCEDURES[1].id)} <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#hasWebsite> <${InstanceSnapshotTestBuilder.PROCEDURES[1].websites[1].id}>`,
                    ...
                    `${sparqlEscapeUri(InstanceSnapshotTestBuilder.PROCEDURES[1].id)} <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#hasWebsite> <${InstanceSnapshotTestBuilder.PROCEDURES[1].websites[0].id}>`,
                    ...
                    `${sparqlEscapeUri(instanceSnapshotId)} <http://purl.org/vocab/cpsv#follows> <${InstanceSnapshotTestBuilder.PROCEDURES[0].id}>`,
                    ...
                    `${sparqlEscapeUri(InstanceSnapshotTestBuilder.PROCEDURES[0].id)} <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#hasWebsite> <${InstanceSnapshotTestBuilder.PROCEDURES[0].websites[1].id}>`,
                    ...
                    `${sparqlEscapeUri(InstanceSnapshotTestBuilder.PROCEDURES[0].id)} <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#hasWebsite> <${InstanceSnapshotTestBuilder.PROCEDURES[0].websites[0].id}>`,
