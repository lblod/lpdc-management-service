        ...
        test('Verify full mappings', async () => {
            ...
            await directDatabaseAccess.insertData(
                ...
                [`<${conceptId}> a <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#ConceptualPublicService>`,
                    ...
                    `<${ConceptTestBuilder.LEGAL_RESOURCES[0].id}> <http://purl.org/dc/terms/title> """${ConceptTestBuilder.LEGAL_RESOURCES[0].title.en}"""@EN`,
                    ...
                    `<${ConceptTestBuilder.LEGAL_RESOURCES[0].id}> <http://purl.org/dc/terms/description> """${ConceptTestBuilder.LEGAL_RESOURCES[0].description.en}"""@EN`,
                    ...
                    `<${ConceptTestBuilder.LEGAL_RESOURCES[1].id}> <http://purl.org/dc/terms/title> """${ConceptTestBuilder.LEGAL_RESOURCES[1].title.en}"""@EN`,
                    ...
                    `<${ConceptTestBuilder.LEGAL_RESOURCES[1].id}> <http://purl.org/dc/terms/description> """${ConceptTestBuilder.LEGAL_RESOURCES[1].description.en}"""@EN`,
