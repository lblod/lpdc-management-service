        ...
        test('Verify full mappings', async () => {
            ...
            await directDatabaseAccess.insertData(
                ...
                [`<${conceptId}> a <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#ConceptualPublicService>`,
                    ...
                    `<${conceptId}> <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#targetAudience> <${NS.dvc.doelgroep(Array.from(ConceptTestBuilder.TARGET_AUDIENCES)[0]).value}>`,
                    `<${NS.dvc.doelgroep(Array.from(ConceptTestBuilder.TARGET_AUDIENCES)[0]).value}> a <http://www.w3.org/2004/02/skos/core#Concept>`,
                    `<${conceptId}> <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#targetAudience> <${NS.dvc.doelgroep(Array.from(ConceptTestBuilder.TARGET_AUDIENCES)[1]).value}>`,
                    `<${NS.dvc.doelgroep(Array.from(ConceptTestBuilder.TARGET_AUDIENCES)[1]).value}> a <http://www.w3.org/2004/02/skos/core#Concept>`,
                    `<${conceptId}> <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#targetAudience> <${NS.dvc.doelgroep(Array.from(ConceptTestBuilder.TARGET_AUDIENCES)[2]).value}>`,
                    `<${NS.dvc.doelgroep(Array.from(ConceptTestBuilder.TARGET_AUDIENCES)[2]).value}> a <http://www.w3.org/2004/02/skos/core#Concept>`,
                    `<${conceptId}> <http://data.europa.eu/m8g/thematicArea> <${NS.dvc.thema(Array.from(ConceptTestBuilder.THEMES)[0]).value}>`,
                    `<${NS.dvc.thema(Array.from(ConceptTestBuilder.THEMES)[0]).value}> a <http://www.w3.org/2004/02/skos/core#Concept>`,
                    `<${conceptId}> <http://data.europa.eu/m8g/thematicArea> <${NS.dvc.thema(Array.from(ConceptTestBuilder.THEMES)[1]).value}>`,
                    `<${NS.dvc.thema(Array.from(ConceptTestBuilder.THEMES)[1]).value}> a <http://www.w3.org/2004/02/skos/core#Concept>`,
                    `<${conceptId}> <http://data.europa.eu/m8g/thematicArea> <${NS.dvc.thema(Array.from(ConceptTestBuilder.THEMES)[2]).value}>`,
                    `<${NS.dvc.thema(Array.from(ConceptTestBuilder.THEMES)[2]).value}> a <http://www.w3.org/2004/02/skos/core#Concept>`,
                    `<${conceptId}> <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#competentAuthorityLevel> <${NS.dvc.bevoegdBestuursniveau(Array.from(ConceptTestBuilder.COMPETENT_AUTHORITY_LEVELS)[0]).value}>`,
                    `<${NS.dvc.bevoegdBestuursniveau(Array.from(ConceptTestBuilder.COMPETENT_AUTHORITY_LEVELS)[0]).value}> a <http://www.w3.org/2004/02/skos/core#Concept>`,
                    `<${conceptId}> <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#competentAuthorityLevel> <${NS.dvc.bevoegdBestuursniveau(Array.from(ConceptTestBuilder.COMPETENT_AUTHORITY_LEVELS)[1]).value}>`,
                    `<${NS.dvc.bevoegdBestuursniveau(Array.from(ConceptTestBuilder.COMPETENT_AUTHORITY_LEVELS)[1]).value}> a <http://www.w3.org/2004/02/skos/core#Concept>`,
                    `<${conceptId}> <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#competentAuthorityLevel> <${NS.dvc.bevoegdBestuursniveau(Array.from(ConceptTestBuilder.COMPETENT_AUTHORITY_LEVELS)[2]).value}>`,
                    `<${NS.dvc.bevoegdBestuursniveau(Array.from(ConceptTestBuilder.COMPETENT_AUTHORITY_LEVELS)[2]).value}> a <http://www.w3.org/2004/02/skos/core#Concept>`,
                    ...
                    `<${conceptId}> <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#executingAuthorityLevel> <${NS.dvc.uitvoerendBestuursniveau(Array.from(ConceptTestBuilder.EXECUTING_AUTHORITY_LEVELS)[0]).value}>`,
                    `<${NS.dvc.uitvoerendBestuursniveau(Array.from(ConceptTestBuilder.EXECUTING_AUTHORITY_LEVELS)[0]).value}> a <http://www.w3.org/2004/02/skos/core#Concept>`,
                    `<${conceptId}> <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#executingAuthorityLevel> <${NS.dvc.uitvoerendBestuursniveau(Array.from(ConceptTestBuilder.EXECUTING_AUTHORITY_LEVELS)[1]).value}>`,
                    `<${NS.dvc.uitvoerendBestuursniveau(Array.from(ConceptTestBuilder.EXECUTING_AUTHORITY_LEVELS)[1]).value}> a <http://www.w3.org/2004/02/skos/core#Concept>`,
                    `<${conceptId}> <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#executingAuthorityLevel> <${NS.dvc.uitvoerendBestuursniveau(Array.from(ConceptTestBuilder.EXECUTING_AUTHORITY_LEVELS)[2]).value}>`,
                    `<${NS.dvc.uitvoerendBestuursniveau(Array.from(ConceptTestBuilder.EXECUTING_AUTHORITY_LEVELS)[2]).value}> a <http://www.w3.org/2004/02/skos/core#Concept>`,
                    ...
                    `<${conceptId}> <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#publicationMedium> <${NS.dvc.publicatieKanaal(Array.from(ConceptTestBuilder.PUBLICATION_MEDIA)[0]).value}>`,
                    `<${NS.dvc.publicatieKanaal(Array.from(ConceptTestBuilder.PUBLICATION_MEDIA)[0]).value}> a <http://www.w3.org/2004/02/skos/core#Concept>`,
                    `<${conceptId}> <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#publicationMedium> <${NS.dvc.publicatieKanaal(Array.from(ConceptTestBuilder.PUBLICATION_MEDIA)[1]).value}>`,
                    `<${NS.dvc.publicatieKanaal(Array.from(ConceptTestBuilder.PUBLICATION_MEDIA)[1]).value}> a <http://www.w3.org/2004/02/skos/core#Concept>`,
                    `<${conceptId}> <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#yourEuropeCategory> <${NS.dvc.yourEuropeCategorie(Array.from(ConceptTestBuilder.YOUR_EUROPE_CATEGORIES)[0]).value}>`,
                    `<${NS.dvc.yourEuropeCategorie(Array.from(ConceptTestBuilder.YOUR_EUROPE_CATEGORIES)[0]).value}> a <http://www.w3.org/2004/02/skos/core#Concept>`,
                    `<${conceptId}> <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#yourEuropeCategory> <${NS.dvc.yourEuropeCategorie(Array.from(ConceptTestBuilder.YOUR_EUROPE_CATEGORIES)[1]).value}>`,
                    `<${NS.dvc.yourEuropeCategorie(Array.from(ConceptTestBuilder.YOUR_EUROPE_CATEGORIES)[1]).value}> a <http://www.w3.org/2004/02/skos/core#Concept>`,
                    `<${conceptId}> <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#yourEuropeCategory> <${NS.dvc.yourEuropeCategorie(Array.from(ConceptTestBuilder.YOUR_EUROPE_CATEGORIES)[2]).value}>`,
                    `<${NS.dvc.yourEuropeCategorie(Array.from(ConceptTestBuilder.YOUR_EUROPE_CATEGORIES)[2]).value}> a <http://www.w3.org/2004/02/skos/core#Concept>`,
                    ...
                    `<${conceptId}> <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#hasLatestFunctionalChange> <${concept.latestFunctionallyChangedConceptSnapshot}>`,
                    `<${conceptId}> <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#conceptTag> <${NS.dvc.conceptTag(Array.from(ConceptTestBuilder.CONCEPT_TAGS)[0]).value}>`,
                    `<${conceptId}> <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#conceptTag> <${NS.dvc.conceptTag(Array.from(ConceptTestBuilder.CONCEPT_TAGS)[1]).value}>`,
