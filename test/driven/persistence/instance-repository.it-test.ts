        ...
        test('Verify full mapping', async () => {
            ...
            await directDatabaseAccess.insertData(
                ...
                [
                    ...
                    `<${InstanceTestBuilder.LEGAL_RESOURCES[0].id}> <http://www.w3.org/2000/01/rdf-schema#seeAlso> <${InstanceTestBuilder.LEGAL_RESOURCES[0].url}>`,
                    ...
                    `<${InstanceTestBuilder.LEGAL_RESOURCES[1].id}> <http://www.w3.org/2000/01/rdf-schema#seeAlso> <${InstanceTestBuilder.LEGAL_RESOURCES[1].url}>`,
