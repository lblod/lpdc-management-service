        ...
        test('Verify full mapping', async () => {
            ...
            await directDatabaseAccess.insertData(
                ...
                [
                    ...
                    `<${InstanceTestBuilder.CONTACT_POINTS[0].address.id}> <https://data.vlaanderen.be/ns/adres#gemeentenaam> """${AddressTestBuilder.GEMEENTENAAM_EN}"""@EN`,
                    ...
                    `<${InstanceTestBuilder.CONTACT_POINTS[0].address.id}> <https://data.vlaanderen.be/ns/adres#gemeentenaam> """${AddressTestBuilder.GEMEENTENAAM_NL_FORMAL}"""@nl-BE-x-formal`,
                    `<${InstanceTestBuilder.CONTACT_POINTS[0].address.id}> <https://data.vlaanderen.be/ns/adres#gemeentenaam> """${AddressTestBuilder.GEMEENTENAAM_NL_INFORMAL}"""@nl-BE-x-informal`,
                    `<${InstanceTestBuilder.CONTACT_POINTS[0].address.id}> <https://data.vlaanderen.be/ns/adres#gemeentenaam> """${AddressTestBuilder.GEMEENTENAAM_NL_GENERATED_FORMAL}"""@nl-BE-x-generated-formal`,
                    `<${InstanceTestBuilder.CONTACT_POINTS[0].address.id}> <https://data.vlaanderen.be/ns/adres#gemeentenaam> """${AddressTestBuilder.GEMEENTENAAM_NL_GENERATED_INFORMAL}"""@nl-BE-x-generated-informal`,
                    `<${InstanceTestBuilder.CONTACT_POINTS[0].address.id}> <https://data.vlaanderen.be/ns/adres#land> """${AddressTestBuilder.LAND_EN}"""@EN`,
                    `<${InstanceTestBuilder.CONTACT_POINTS[0].address.id}> <https://data.vlaanderen.be/ns/adres#land> """${AddressTestBuilder.LAND_NL}"""@NL`,
                    `<${InstanceTestBuilder.CONTACT_POINTS[0].address.id}> <https://data.vlaanderen.be/ns/adres#land> """${AddressTestBuilder.LAND_NL_FORMAL}"""@nl-BE-x-formal`,
                    `<${InstanceTestBuilder.CONTACT_POINTS[0].address.id}> <https://data.vlaanderen.be/ns/adres#land> """${AddressTestBuilder.LAND_NL_INFORMAL}"""@nl-BE-x-informal`,
                    `<${InstanceTestBuilder.CONTACT_POINTS[0].address.id}> <https://data.vlaanderen.be/ns/adres#land> """${AddressTestBuilder.LAND_NL_GENERATED_FORMAL}"""@nl-BE-x-generated-formal`,
                    `<${InstanceTestBuilder.CONTACT_POINTS[0].address.id}> <https://data.vlaanderen.be/ns/adres#land> """${AddressTestBuilder.LAND_NL_GENERATED_INFORMAL}"""@nl-BE-x-generated-informal`,
                    ...
                    `<${InstanceTestBuilder.CONTACT_POINTS[0].address.id}> <https://data.vlaanderen.be/ns/adres#Straatnaam> """${AddressTestBuilder.STRAATNAAM_EN}"""@EN`,
                    ...
                    `<${InstanceTestBuilder.CONTACT_POINTS[0].address.id}> <https://data.vlaanderen.be/ns/adres#Straatnaam> """${AddressTestBuilder.STRAATNAAM_NL_FORMAL}"""@nl-BE-x-formal`,
                    `<${InstanceTestBuilder.CONTACT_POINTS[0].address.id}> <https://data.vlaanderen.be/ns/adres#Straatnaam> """${AddressTestBuilder.STRAATNAAM_NL_INFORMAL}"""@nl-BE-x-informal`,
                    `<${InstanceTestBuilder.CONTACT_POINTS[0].address.id}> <https://data.vlaanderen.be/ns/adres#Straatnaam> """${AddressTestBuilder.STRAATNAAM_NL_GENERATED_FORMAL}"""@nl-BE-x-generated-formal`,
                    `<${InstanceTestBuilder.CONTACT_POINTS[0].address.id}> <https://data.vlaanderen.be/ns/adres#Straatnaam> """${AddressTestBuilder.STRAATNAAM_NL_GENERATED_INFORMAL}"""@nl-BE-x-generated-informal`,
