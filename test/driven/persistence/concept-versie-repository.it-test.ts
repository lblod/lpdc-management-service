        ...
        test('Verify full mappings', async () => {
            ...
            await directDatabaseAccess.insertData(
                ...
                [`<${conceptVersieId}> a <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#ConceptualPublicService>`,
                    ...
                    `<${conceptVersieId}> <http://purl.org/vocab/cpsv#follows> <${ConceptVersieTestBuilder.PROCEDURES[1].id}>`,
                    `<${ConceptVersieTestBuilder.PROCEDURES[1].id}> a <http://purl.org/vocab/cpsv#Rule>`,
                    `<${ConceptVersieTestBuilder.PROCEDURES[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.PROCEDURES[1].title.en}"""@EN`,
                    `<${ConceptVersieTestBuilder.PROCEDURES[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.PROCEDURES[1].title.nl}"""@NL`,
                    `<${ConceptVersieTestBuilder.PROCEDURES[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.PROCEDURES[1].title.nlFormal}"""@nl-BE-x-formal`,
                    `<${ConceptVersieTestBuilder.PROCEDURES[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.PROCEDURES[1].title.nlInformal}"""@nl-BE-x-informal`,
                    `<${ConceptVersieTestBuilder.PROCEDURES[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.PROCEDURES[1].title.nlGeneratedFormal}"""@nl-BE-x-generated-formal`,
                    `<${ConceptVersieTestBuilder.PROCEDURES[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.PROCEDURES[1].title.nlGeneratedInformal}"""@nl-BE-x-generated-informal`,
                    `<${ConceptVersieTestBuilder.PROCEDURES[1].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.PROCEDURES[1].description.en}"""@EN`,
                    `<${ConceptVersieTestBuilder.PROCEDURES[1].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.PROCEDURES[1].description.nl}"""@NL`,
                    `<${ConceptVersieTestBuilder.PROCEDURES[1].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.PROCEDURES[1].description.nlFormal}"""@nl-BE-x-formal`,
                    `<${ConceptVersieTestBuilder.PROCEDURES[1].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.PROCEDURES[1].description.nlInformal}"""@nl-BE-x-informal`,
                    ...
                    `<${ConceptVersieTestBuilder.PROCEDURES[0].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.PROCEDURES[0].title.nl}"""@NL`,
                    `<${ConceptVersieTestBuilder.PROCEDURES[0].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.PROCEDURES[0].title.nlFormal}"""@nl-BE-x-formal`,
                    `<${ConceptVersieTestBuilder.PROCEDURES[0].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.PROCEDURES[0].title.nlInformal}"""@nl-BE-x-informal`,
                    `<${ConceptVersieTestBuilder.PROCEDURES[0].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.PROCEDURES[0].title.nlGeneratedFormal}"""@nl-BE-x-generated-formal`,
                    `<${ConceptVersieTestBuilder.PROCEDURES[0].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.PROCEDURES[0].title.nlGeneratedInformal}"""@nl-BE-x-generated-informal`,
                    `<${ConceptVersieTestBuilder.PROCEDURES[0].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.PROCEDURES[0].description.en}"""@EN`,
                    `<${ConceptVersieTestBuilder.PROCEDURES[0].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.PROCEDURES[0].description.nl}"""@NL`,
                    `<${ConceptVersieTestBuilder.PROCEDURES[0].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.PROCEDURES[0].description.nlFormal}"""@nl-BE-x-formal`,
                    `<${ConceptVersieTestBuilder.PROCEDURES[0].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.PROCEDURES[0].description.nlInformal}"""@nl-BE-x-informal`,
                    ...
                    `<${conceptVersieId}> <http://www.w3.org/2000/01/rdf-schema#seeAlso> <${ConceptVersieTestBuilder.WEBSITES[1].id}>`,
                    `<${ConceptVersieTestBuilder.WEBSITES[1].id}> a <http://schema.org/WebSite>`,
                    `<${ConceptVersieTestBuilder.WEBSITES[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.WEBSITES[1].title.en}"""@EN`,
                    `<${ConceptVersieTestBuilder.WEBSITES[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.WEBSITES[1].title.nl}"""@NL`,
                    `<${ConceptVersieTestBuilder.WEBSITES[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.WEBSITES[1].title.nlFormal}"""@nl-BE-x-formal`,
                    `<${ConceptVersieTestBuilder.WEBSITES[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.WEBSITES[1].title.nlInformal}"""@nl-BE-x-informal`,
                    `<${ConceptVersieTestBuilder.WEBSITES[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.WEBSITES[1].title.nlGeneratedFormal}"""@nl-BE-x-generated-formal`,
                    `<${ConceptVersieTestBuilder.WEBSITES[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.WEBSITES[1].title.nlGeneratedInformal}"""@nl-BE-x-generated-informal`,
                    `<${ConceptVersieTestBuilder.WEBSITES[1].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.WEBSITES[1].description.en}"""@EN`,
                    `<${ConceptVersieTestBuilder.WEBSITES[1].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.WEBSITES[1].description.nl}"""@NL`,
                    `<${ConceptVersieTestBuilder.WEBSITES[1].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.WEBSITES[1].description.nlFormal}"""@nl-BE-x-formal`,
                    `<${ConceptVersieTestBuilder.WEBSITES[1].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.WEBSITES[1].description.nlInformal}"""@nl-BE-x-informal`,
                    `<${ConceptVersieTestBuilder.WEBSITES[1].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.WEBSITES[1].description.nlGeneratedFormal}"""@nl-BE-x-generated-formal`,
                    `<${ConceptVersieTestBuilder.WEBSITES[1].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.WEBSITES[1].description.nlGeneratedInformal}"""@nl-BE-x-generated-informal`,
                    `<${ConceptVersieTestBuilder.WEBSITES[1].id}> <http://schema.org/url> """${ConceptVersieTestBuilder.WEBSITES[1].url}"""`,
                    `<${ConceptVersieTestBuilder.WEBSITES[1].id}> <http://www.w3.org/ns/shacl#order> """1"""^^<http://www.w3.org/2001/XMLSchema#integer>`,
                    `<${conceptVersieId}> <http://www.w3.org/2000/01/rdf-schema#seeAlso> <${ConceptVersieTestBuilder.WEBSITES[0].id}>`,
                    `<${ConceptVersieTestBuilder.WEBSITES[0].id}> a <http://schema.org/WebSite>`,
                    `<${ConceptVersieTestBuilder.WEBSITES[0].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.WEBSITES[0].title.en}"""@EN`,
                    `<${ConceptVersieTestBuilder.WEBSITES[0].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.WEBSITES[0].title.nl}"""@NL`,
                    `<${ConceptVersieTestBuilder.WEBSITES[0].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.WEBSITES[0].title.nlFormal}"""@nl-BE-x-formal`,
                    `<${ConceptVersieTestBuilder.WEBSITES[0].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.WEBSITES[0].title.nlInformal}"""@nl-BE-x-informal`,
                    `<${ConceptVersieTestBuilder.WEBSITES[0].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.WEBSITES[0].title.nlGeneratedFormal}"""@nl-BE-x-generated-formal`,
                    `<${ConceptVersieTestBuilder.WEBSITES[0].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.WEBSITES[0].title.nlGeneratedInformal}"""@nl-BE-x-generated-informal`,
                    `<${ConceptVersieTestBuilder.WEBSITES[0].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.WEBSITES[0].description.en}"""@EN`,
                    `<${ConceptVersieTestBuilder.WEBSITES[0].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.WEBSITES[0].description.nl}"""@NL`,
                    `<${ConceptVersieTestBuilder.WEBSITES[0].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.WEBSITES[0].description.nlFormal}"""@nl-BE-x-formal`,
                    `<${ConceptVersieTestBuilder.WEBSITES[0].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.WEBSITES[0].description.nlInformal}"""@nl-BE-x-informal`,
                    `<${ConceptVersieTestBuilder.WEBSITES[0].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.WEBSITES[0].description.nlGeneratedFormal}"""@nl-BE-x-generated-formal`,
                    `<${ConceptVersieTestBuilder.WEBSITES[0].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.WEBSITES[0].description.nlGeneratedInformal}"""@nl-BE-x-generated-informal`,
                    `<${ConceptVersieTestBuilder.WEBSITES[0].id}> <http://schema.org/url> """${ConceptVersieTestBuilder.WEBSITES[0].url}"""`,
                    `<${ConceptVersieTestBuilder.WEBSITES[0].id}> <http://www.w3.org/ns/shacl#order> """0"""^^<http://www.w3.org/2001/XMLSchema#integer>`,
                    `<${conceptVersieId}> <http://data.europa.eu/m8g/hasCost> <${ConceptVersieTestBuilder.COSTS[1].id}>`,
                    `<${ConceptVersieTestBuilder.COSTS[1].id}> a <http://data.europa.eu/m8g/Cost>`,
                    `<${ConceptVersieTestBuilder.COSTS[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.COSTS[1].title.en}"""@EN`,
                    `<${ConceptVersieTestBuilder.COSTS[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.COSTS[1].title.nl}"""@NL`,
                    `<${ConceptVersieTestBuilder.COSTS[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.COSTS[1].title.nlFormal}"""@nl-BE-x-formal`,
                    `<${ConceptVersieTestBuilder.COSTS[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.COSTS[1].title.nlInformal}"""@nl-BE-x-informal`,
                    `<${ConceptVersieTestBuilder.COSTS[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.COSTS[1].title.nlGeneratedFormal}"""@nl-BE-x-generated-formal`,
                    `<${ConceptVersieTestBuilder.COSTS[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.COSTS[1].title.nlGeneratedInformal}"""@nl-BE-x-generated-informal`,
                    `<${ConceptVersieTestBuilder.COSTS[1].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.COSTS[1].description.en}"""@EN`,
                    `<${ConceptVersieTestBuilder.COSTS[1].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.COSTS[1].description.nl}"""@NL`,
                    `<${ConceptVersieTestBuilder.COSTS[1].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.COSTS[1].description.nlFormal}"""@nl-BE-x-formal`,
                    `<${ConceptVersieTestBuilder.COSTS[1].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.COSTS[1].description.nlInformal}"""@nl-BE-x-informal`,
                    `<${ConceptVersieTestBuilder.COSTS[1].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.COSTS[1].description.nlGeneratedFormal}"""@nl-BE-x-generated-formal`,
                    `<${ConceptVersieTestBuilder.COSTS[1].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.COSTS[1].description.nlGeneratedInformal}"""@nl-BE-x-generated-informal`,
                    `<${ConceptVersieTestBuilder.COSTS[1].id}> <http://www.w3.org/ns/shacl#order> """1"""^^<http://www.w3.org/2001/XMLSchema#integer>`,
                    `<${conceptVersieId}> <http://data.europa.eu/m8g/hasCost> <${ConceptVersieTestBuilder.COSTS[0].id}>`,
                    `<${ConceptVersieTestBuilder.COSTS[0].id}> a <http://data.europa.eu/m8g/Cost>`,
                    `<${ConceptVersieTestBuilder.COSTS[0].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.COSTS[0].title.en}"""@EN`,
                    `<${ConceptVersieTestBuilder.COSTS[0].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.COSTS[0].title.nl}"""@NL`,
                    `<${ConceptVersieTestBuilder.COSTS[0].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.COSTS[0].title.nlFormal}"""@nl-BE-x-formal`,
                    `<${ConceptVersieTestBuilder.COSTS[0].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.COSTS[0].title.nlInformal}"""@nl-BE-x-informal`,
                    `<${ConceptVersieTestBuilder.COSTS[0].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.COSTS[0].title.nlGeneratedFormal}"""@nl-BE-x-generated-formal`,
                    `<${ConceptVersieTestBuilder.COSTS[0].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.COSTS[0].title.nlGeneratedInformal}"""@nl-BE-x-generated-informal`,
                    `<${ConceptVersieTestBuilder.COSTS[0].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.COSTS[0].description.en}"""@EN`,
                    `<${ConceptVersieTestBuilder.COSTS[0].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.COSTS[0].description.nl}"""@NL`,
                    `<${ConceptVersieTestBuilder.COSTS[0].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.COSTS[0].description.nlFormal}"""@nl-BE-x-formal`,
                    `<${ConceptVersieTestBuilder.COSTS[0].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.COSTS[0].description.nlInformal}"""@nl-BE-x-informal`,
                    `<${ConceptVersieTestBuilder.COSTS[0].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.COSTS[0].description.nlGeneratedFormal}"""@nl-BE-x-generated-formal`,
                    `<${ConceptVersieTestBuilder.COSTS[0].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.COSTS[0].description.nlGeneratedInformal}"""@nl-BE-x-generated-informal`,
                    `<${ConceptVersieTestBuilder.COSTS[0].id}> <http://www.w3.org/ns/shacl#order> """0"""^^<http://www.w3.org/2001/XMLSchema#integer>`,
                    `<${conceptVersieId}> <http://purl.org/vocab/cpsv#produces> <${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].id}>`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].id}> a <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#FinancialAdvantage>`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].title.en}"""@EN`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].title.nl}"""@NL`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].title.nlFormal}"""@nl-BE-x-formal`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].title.nlInformal}"""@nl-BE-x-informal`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].title.nlGeneratedFormal}"""@nl-BE-x-generated-formal`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].title.nlGeneratedInformal}"""@nl-BE-x-generated-informal`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].description.en}"""@EN`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].description.nl}"""@NL`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].description.nlFormal}"""@nl-BE-x-formal`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].description.nlInformal}"""@nl-BE-x-informal`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].description.nlGeneratedFormal}"""@nl-BE-x-generated-formal`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].description.nlGeneratedInformal}"""@nl-BE-x-generated-informal`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[1].id}> <http://www.w3.org/ns/shacl#order> """1"""^^<http://www.w3.org/2001/XMLSchema#integer>`,
                    `<${conceptVersieId}> <http://purl.org/vocab/cpsv#produces> <${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[0].id}>`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[0].id}> a <https://productencatalogus.data.vlaanderen.be/ns/ipdc-lpdc#FinancialAdvantage>`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[0].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[0].title.en}"""@EN`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[0].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[0].title.nl}"""@NL`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[0].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[0].title.nlFormal}"""@nl-BE-x-formal`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[0].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[0].title.nlInformal}"""@nl-BE-x-informal`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[0].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[0].title.nlGeneratedFormal}"""@nl-BE-x-generated-formal`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[0].id}> <http://purl.org/dc/terms/title> """${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[0].title.nlGeneratedInformal}"""@nl-BE-x-generated-informal`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[0].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[0].description.en}"""@EN`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[0].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[0].description.nl}"""@NL`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[0].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[0].description.nlFormal}"""@nl-BE-x-formal`,
                    `<${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[0].id}> <http://purl.org/dc/terms/description> """${ConceptVersieTestBuilder.FINANCIAL_ADVANTAGES[0].description.nlInformal}"""@nl-BE-x-informal`,
