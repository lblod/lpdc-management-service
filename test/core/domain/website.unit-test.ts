...
describe("forConcept", () => {
  test("Undefined id throws error", () => {
    ...
    expect(() => Website.forConcept(website.build())).toThrowWithMessage(
      InvariantError,
  ...
  test("Invalid iri id throws error", () => {
    expect(() =>
      Website.forConcept(aFullWebsite().withId(new Iri("   ")).build()),
  ...
  test("Undefined order throws error", () => {
    expect(() =>
      Website.forConcept(aFullWebsite().withOrder(undefined).build()),
...
describe("forConceptSnapshot", () => {
  test("Undefined id throws error", () => {
    const website = aFullWebsite().withId(undefined);
    expect(() =>
      Website.forConceptSnapshot(website.build()),
    ).toThrowWithMessage(InvariantError, "id mag niet ontbreken");
  });

  test("Invalid iri id throws error", () => {
    expect(() =>
      Website.forConceptSnapshot(aFullWebsite().withId(new Iri("   ")).build()),
    ).toThrowWithMessage(InvariantError, "iri mag niet leeg zijn");
  });
  ...
  test("Undefined title throws error", () => {
    ...
    expect(() => Website.forConceptSnapshot(website)).toThrowWithMessage(
      InvariantError,
      "title mag niet ontbreken",
    );
  });
  ...
  test("Undefined order throws error", () => {
    expect(() =>
      Website.forConceptSnapshot(aFullWebsite().withOrder(undefined).build()),
    ).toThrowWithMessage(InvariantError, "order mag niet ontbreken");
  });
});
...
describe("for instance", () => {
  ...
  test("Undefined id throws error", () => {
    ...
    expect(() => Website.forInstance(website.build())).toThrowWithMessage(
      InvariantError,
      "id mag niet ontbreken",
    );
  });
  ...
  test("Undefined Uuid throws error", () => {
    ...
    expect(() => Website.forInstance(website).uuid).toThrowWithMessage(
      InvariantError,
      "uuid mag niet ontbreken",
    );
  });
  ...
  test("If title and description have different nl languages, throws error", () => {
    ...
    expect(() => Website.forInstance(website)).toThrowWithMessage(
      InvariantError,
  ...
  test("Undefined order throws error", () => {
    expect(() =>
      Website.forInstance(
        aFullWebsiteForInstance().withOrder(undefined).build(),
      ),
    ).toThrowWithMessage(InvariantError, "order mag niet ontbreken");
  });
});
...
describe("for instance snapshot", () => {
  ...
  test("Undefined id throws error", () => {
    ...
    expect(() =>
      Website.forInstanceSnapshot(website.build()),
    ).toThrowWithMessage(InvariantError, "id mag niet ontbreken");
  });

  test("Undefined Uuid does not throw error", () => {
    const website = aFullWebsiteForInstanceSnapshot()
      .withUuid(undefined)
      .build();
  ...
  test("If title and description have different nl languages, throws error", () => {
    ...
    expect(() => Website.forInstanceSnapshot(website)).toThrowWithMessage(
      InvariantError,
      "Er is meer dan een nl-taal aanwezig",
    );
  });
  ...
  test("Undefined order throws error", () => {
    expect(() =>
      Website.forInstanceSnapshot(
        aFullWebsiteForInstanceSnapshot().withOrder(undefined).build(),
      ),
    ).toThrowWithMessage(InvariantError, "order mag niet ontbreken");
  });
});
...
describe("transformLanguage", () => {
  test("should transform website with title, description", () => {
    ...
    expect(
      website.transformLanguage(Language.FORMAL, Language.INFORMAL),
    ).toEqual(
