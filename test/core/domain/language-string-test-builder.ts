...
export function aMinimalLanguageString(value: string = ''): LanguageStringTestBuilder {
...
export class LanguageStringTestBuilder {
    ...
    public withNlGeneratedFormal(nlGeneratedFormal: string): LanguageStringTestBuilder {
        this.nlGeneratedFormal = nlGeneratedFormal;
        return this;
    }

    public withNlGeneratedInformal(nlGeneratedInformal: string): LanguageStringTestBuilder {
