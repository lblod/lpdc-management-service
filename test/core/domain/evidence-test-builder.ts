...
export function aFullEvidenceForInstance(): EvidenceBuilder {
  ...
  return new EvidenceBuilder()
    ...
    .withUuid(uniqueId)
    .withTitle(
      LanguageString.of(undefined, EvidenceTestBuilder.TITLE_NL_FORMAL),
    )
    .withDescription(
      LanguageString.of(undefined, EvidenceTestBuilder.DESCRIPTION_NL_FORMAL),
    );
}
...
export function anotherFullEvidenceForInstance(): EvidenceBuilder {
  ...
  return new EvidenceBuilder()
    ...
    .withUuid(uniqueId)
    .withTitle(
      LanguageString.of(undefined, EvidenceTestBuilder.ANOTHER_TITLE_NL_FORMAL),
    )
    .withDescription(
      LanguageString.of(
        undefined,
...
export class EvidenceTestBuilder {
  ...
  public static readonly TITLE_NL_GENERATED_FORMAL =
    "Evidence Title - nl-generated-formal";
  public static readonly TITLE_NL_GENERATED_INFORMAL =
    "Evidence Title - nl-generated-informal";
