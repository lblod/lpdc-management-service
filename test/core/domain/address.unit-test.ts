...
describe("constructing", () => {
  describe("forInstance", () => {
    test("Undefined id throws error", () => {
      expect(() =>
        Address.forInstance(
          aFullAddressForInstance().withId(undefined).build(),
        ),
    ...
    test("Invalid iri id throws error", () => {
      expect(() =>
        Address.forInstance(
          aFullAddressForInstance().withId(new Iri("  ")).build(),
        ),
    ...
    test("Undefined uuid throws error", () => {
      expect(() =>
        Address.forInstance(
          aFullAddressForInstance().withUuid(undefined).build(),
        ),
    ...
    test("Blank uuid throws error", () => {
      expect(() =>
        Address.forInstance(aFullAddressForInstance().withUuid("   ").build()),
    ...
    test("Invalid iri verwijst naar throws error", () => {
      expect(() =>
        Address.forInstance(
          aFullAddressForInstance()
            .withVerwijstNaar(new Iri("bad iri"))
            .build(),
        ),
      ).toThrowWithMessage(
        InvariantError,
      ...
      test("invalid gemeentenaam throws error", () => {
        expect(() =>
          Address.forInstance(
            aFullAddressForInstance()
              .withGemeentenaam(
                LanguageString.of("nl gemeentenaam", "formal gemeentenaam"),
              )
              .build(),
          ),
        ).toThrowWithMessage(
      ...
      test("invalid straatnaam throws error", () => {
        expect(() =>
          Address.forInstance(
            aFullAddressForInstance()
              .withGemeentenaam(
                LanguageString.of("nl straatnaam", "formal straatnaam"),
              )
              .build(),
          ),
        ).toThrowWithMessage(
      ...
      test("straatnaam, land and straatnaam should have nl languageString", () => {
        expect(() =>
          Address.forInstance(
            aFullAddressForInstance()
              .withGemeentenaam(
                LanguageString.of(undefined, "formal gemeentenaam"),
              )
  ...
  describe("forInstanceSnapshot", () => {
    test("Undefined id throws error", () => {
      expect(() =>
        Address.forInstanceSnapshot(
          aFullAddressForInstanceSnapshot().withId(undefined).build(),
        ),
      ).toThrowWithMessage(InvariantError, "id mag niet ontbreken");
    });
    ...
    test("Undefined uuid does not throw error", () => {
      expect(
        Address.forInstanceSnapshot(
          aFullAddressForInstanceSnapshot().withUuid(undefined).build(),
        ).uuid,
      ).toBeUndefined();
    });
