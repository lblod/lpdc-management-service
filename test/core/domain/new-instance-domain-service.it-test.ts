...
import { ConceptDisplayConfigurationSparqlTestRepository } from "../../driven/persistence/concept-display-configuration-sparql-test-repository";
...
describe("Creating a new Instance domain service", () => {
  ...
  describe("create new empty", () => {
    test("Create new empty", async () => {
      ...
      const expectedInstance = new InstanceBuilder()
  ...
  describe("Create new from concept", () => {
    test("Create new from concept", async () => {
      ...
      const displayConfiguration = aFullConceptDisplayConfiguration()
        ...
        .build();
      await conceptDisplayConfigurationTestRepository.save(
        bestuurseenheid,
      ...
      const expectedInstance = new InstanceBuilder()
        ...
        .withDescription(
          LanguageString.of(undefined, concept.description.nlFormal),
        )
        .withAdditionalDescription(
          LanguageString.of(undefined, concept.additionalDescription.nlFormal),
        )
        .withException(LanguageString.of(undefined, concept.exception.nlFormal))
        .withRegulation(
          LanguageString.of(undefined, concept.regulation.nlFormal),
        )
        ...
        .withRequirements([
          new RequirementBuilder()
            ...
            .withTitle(
              LanguageString.of(
                undefined,
                concept.requirements[0].title.nlFormal,
              ),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                concept.requirements[0].description.nlFormal,
              ),
            )
            .withOrder(1)
            .withEvidence(
              new EvidenceBuilder()
                ...
                .withTitle(
                  LanguageString.of(
                    undefined,
                    concept.requirements[0].evidence.title.nlFormal,
                  ),
                )
                .withDescription(
                  LanguageString.of(
                    undefined,
                    concept.requirements[0].evidence.description.nlFormal,
                  ),
                )
                .build(),
            )
          ...
          new RequirementBuilder()
            ...
            .withTitle(
              LanguageString.of(
                undefined,
                concept.requirements[1].title.nlFormal,
              ),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                concept.requirements[1].description.nlFormal,
              ),
            )
            .withOrder(2)
            .withEvidence(
              new EvidenceBuilder()
                ...
                .withTitle(
                  LanguageString.of(
                    undefined,
                    concept.requirements[1].evidence.title.nlFormal,
                  ),
                )
                .withDescription(
                  LanguageString.of(
                    undefined,
                    concept.requirements[1].evidence.description.nlFormal,
                  ),
                )
                .build(),
            )
        ...
        .withProcedures([
          new ProcedureBuilder()
            ...
            .withTitle(
              LanguageString.of(
                undefined,
                concept.procedures[0].title.nlFormal,
              ),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                concept.procedures[0].description.nlFormal,
              ),
            )
            .withOrder(1)
            .withWebsites([
              new WebsiteBuilder()
                ...
                .withTitle(
                  LanguageString.of(
                    undefined,
                    concept.procedures[0].websites[0].title.nlFormal,
                  ),
                )
                .withDescription(
                  LanguageString.of(
                    undefined,
                    concept.procedures[0].websites[0].description.nlFormal,
                  ),
                )
                .withOrder(1)
              ...
              new WebsiteBuilder()
                ...
                .withTitle(
                  LanguageString.of(
                    undefined,
                    concept.procedures[0].websites[1].title.nlFormal,
                  ),
                )
                .withDescription(
                  LanguageString.of(
                    undefined,
                    concept.procedures[0].websites[1].description.nlFormal,
                  ),
                )
                .withOrder(2)
          ...
          new ProcedureBuilder()
            ...
            .withTitle(
              LanguageString.of(
                undefined,
                concept.procedures[1].title.nlFormal,
              ),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                concept.procedures[1].description.nlFormal,
              ),
            )
            .withOrder(2)
            .withWebsites([
              new WebsiteBuilder()
                ...
                .withTitle(
                  LanguageString.of(
                    undefined,
                    concept.procedures[1].websites[0].title.nlFormal,
                  ),
                )
                .withDescription(
                  LanguageString.of(
                    undefined,
                    concept.procedures[1].websites[0].description.nlFormal,
                  ),
                )
                .withOrder(1)
              ...
              new WebsiteBuilder()
                ...
                .withTitle(
                  LanguageString.of(
                    undefined,
                    concept.procedures[1].websites[1].title.nlFormal,
                  ),
                )
                .withDescription(
                  LanguageString.of(
                    undefined,
                    concept.procedures[1].websites[1].description.nlFormal,
                  ),
                )
                .withOrder(2)
        ...
        .withWebsites([
          new WebsiteBuilder()
            ...
            .withTitle(
              LanguageString.of(undefined, concept.websites[0].title.nlFormal),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                concept.websites[0].description.nlFormal,
              ),
            )
            .withOrder(1)
          ...
          new WebsiteBuilder()
            ...
            .withTitle(
              LanguageString.of(undefined, concept.websites[1].title.nlFormal),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                concept.websites[1].description.nlFormal,
              ),
            )
            .withOrder(2)
        ...
        .withCosts([
          new CostBuilder()
            ...
            .withTitle(
              LanguageString.of(undefined, concept.costs[0].title.nlFormal),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                concept.costs[0].description.nlFormal,
              ),
            )
            .withOrder(1)
            .build(),
          new CostBuilder()
            ...
            .withTitle(
              LanguageString.of(undefined, concept.costs[1].title.nlFormal),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                concept.costs[1].description.nlFormal,
              ),
            )
            .withOrder(2)
            .build(),
        ...
        .withFinancialAdvantages([
          new FinancialAdvantageBuilder()
            ...
            .withTitle(
              LanguageString.of(
                undefined,
                concept.financialAdvantages[0].title.nlFormal,
              ),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                concept.financialAdvantages[0].description.nlFormal,
              ),
            )
            .withOrder(1)
            .build(),
          new FinancialAdvantageBuilder()
            ...
            .withTitle(
              LanguageString.of(
                undefined,
                concept.financialAdvantages[1].title.nlFormal,
              ),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                concept.financialAdvantages[1].description.nlFormal,
              ),
            )
            .withOrder(2)
            .build(),
        ...
        .withLegalResources([
          new LegalResourceBuilder()
            ...
            .withTitle(
              LanguageString.of(
                undefined,
                concept.legalResources[0].title.nlFormal,
              ),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                concept.legalResources[0].description.nlFormal,
              ),
            )
          ...
          new LegalResourceBuilder()
            ...
            .withTitle(
              LanguageString.of(
                undefined,
                concept.legalResources[1].title.nlFormal,
              ),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                concept.legalResources[1].description.nlFormal,
              ),
            )
      ...
      expect(createdInstance).toEqual(expectedInstance);
      expect(reloadedInstance).toEqual(expectedInstance);
      expect(createdInstance.requirements[0].id).not.toEqual(
        concept.requirements[0].id,
      );
      expect(createdInstance.requirements[0].uuid).not.toEqual(
        concept.requirements[0].uuid,
      );
      expect(createdInstance.requirements[1].id).not.toEqual(
        concept.requirements[1].id,
      );
      expect(createdInstance.requirements[1].uuid).not.toEqual(
        concept.requirements[1].uuid,
      );
      expect(createdInstance.requirements[0].evidence.id).not.toEqual(
        concept.requirements[0].evidence.id,
      );
      expect(createdInstance.requirements[0].evidence.uuid).not.toEqual(
        concept.requirements[0].evidence.uuid,
      );
      expect(createdInstance.requirements[1].evidence.id).not.toEqual(
        concept.requirements[1].evidence.id,
      );
      expect(createdInstance.requirements[1].evidence.uuid).not.toEqual(
        concept.requirements[1].evidence.uuid,
      );
      expect(createdInstance.procedures[0].id).not.toEqual(
        concept.procedures[0].id,
      );
      expect(createdInstance.procedures[0].uuid).not.toEqual(
        concept.procedures[0].uuid,
      );
      expect(createdInstance.procedures[1].id).not.toEqual(
        concept.procedures[1].id,
      );
      expect(createdInstance.procedures[1].uuid).not.toEqual(
        concept.procedures[1].uuid,
      );
      expect(createdInstance.procedures[0].websites[0].id).not.toEqual(
        concept.procedures[0].websites[0].id,
      );
      expect(createdInstance.procedures[0].websites[0].uuid).not.toEqual(
        concept.procedures[0].websites[0].uuid,
      );
      expect(createdInstance.procedures[0].websites[1].id).not.toEqual(
        concept.procedures[0].websites[1].id,
      );
      expect(createdInstance.procedures[0].websites[1].uuid).not.toEqual(
        concept.procedures[0].websites[1].uuid,
      );
      expect(createdInstance.procedures[1].websites[0].id).not.toEqual(
        concept.procedures[1].websites[0].id,
      );
      expect(createdInstance.procedures[1].websites[0].uuid).not.toEqual(
        concept.procedures[1].websites[0].uuid,
      );
      expect(createdInstance.procedures[1].websites[1].id).not.toEqual(
        concept.procedures[1].websites[1].id,
      );
      expect(createdInstance.procedures[1].websites[1].uuid).not.toEqual(
        concept.procedures[1].websites[1].uuid,
      );
      expect(createdInstance.websites[0].id).not.toEqual(
        concept.websites[0].id,
      );
      expect(createdInstance.websites[0].uuid).not.toEqual(
        concept.websites[0].uuid,
      );
      expect(createdInstance.websites[1].id).not.toEqual(
        concept.websites[1].id,
      );
      expect(createdInstance.websites[1].uuid).not.toEqual(
        concept.websites[1].uuid,
      );
      ...
      expect(createdInstance.financialAdvantages[0].id).not.toEqual(
        concept.financialAdvantages[0].id,
      );
      expect(createdInstance.financialAdvantages[0].uuid).not.toEqual(
        concept.financialAdvantages[0].uuid,
      );
      expect(createdInstance.financialAdvantages[1].id).not.toEqual(
        concept.financialAdvantages[1].id,
      );
      expect(createdInstance.financialAdvantages[1].uuid).not.toEqual(
        concept.financialAdvantages[1].uuid,
      );
      expect(createdInstance.legalResources[0].id).not.toEqual(
        concept.legalResources[0].id,
      );
      expect(createdInstance.legalResources[0].uuid).not.toEqual(
        concept.legalResources[0].uuid,
      );
      expect(createdInstance.legalResources[1].id).not.toEqual(
        concept.legalResources[1].id,
      );
      expect(createdInstance.legalResources[1].uuid).not.toEqual(
        concept.legalResources[1].uuid,
      );
    });
    ...
    test("Create new from concept when chosen form is formal", async () => {
      ...
      await formalInformalChoiceTestRepository.save(
        bestuurseenheid,
    ...
    test("Create new from concept when chosen form is informal", async () => {
      ...
      const expectedInstance = new InstanceBuilder()
        ...
        .withSpatials([spatial1, spatial2])
        .withTitle(
          LanguageString.of(undefined, undefined, concept.title.nlInformal),
        )
        .withDescription(
          LanguageString.of(
            undefined,
            undefined,
            concept.description.nlInformal,
          ),
        )
        .withAdditionalDescription(
          LanguageString.of(
            undefined,
            undefined,
            concept.additionalDescription.nlInformal,
          ),
        )
        .withException(
          LanguageString.of(undefined, undefined, concept.exception.nlInformal),
        )
        .withRegulation(
          LanguageString.of(
            undefined,
            undefined,
            concept.regulation.nlInformal,
          ),
        )
        .withStartDate(concept.startDate)
        .withEndDate(concept.endDate)
          ...
          new RequirementBuilder()
            ...
            .withTitle(
              LanguageString.of(
                undefined,
                undefined,
                concept.requirements[0].title.nlInformal,
              ),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                undefined,
                concept.requirements[0].description.nlInformal,
              ),
            )
            .withOrder(1)
            .withEvidence(
              new EvidenceBuilder()
                ...
                .withTitle(
                  LanguageString.of(
                    undefined,
                    undefined,
                    concept.requirements[0].evidence.title.nlInformal,
                  ),
                )
                .withDescription(
                  LanguageString.of(
                    undefined,
                    undefined,
                    concept.requirements[0].evidence.description.nlInformal,
                  ),
                )
                .build(),
            )
          ...
          new RequirementBuilder()
            ...
            .withTitle(
              LanguageString.of(
                undefined,
                undefined,
                concept.requirements[1].title.nlInformal,
              ),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                undefined,
                concept.requirements[1].description.nlInformal,
              ),
            )
            .withOrder(2)
            .withEvidence(
              new EvidenceBuilder()
                ...
                .withTitle(
                  LanguageString.of(
                    undefined,
                    undefined,
                    concept.requirements[1].evidence.title.nlInformal,
                  ),
                )
                .withDescription(
                  LanguageString.of(
                    undefined,
                    undefined,
                    concept.requirements[1].evidence.description.nlInformal,
                  ),
                )
                .build(),
            )
          ...
          new ProcedureBuilder()
            ...
            .withTitle(
              LanguageString.of(
                undefined,
                undefined,
                concept.procedures[0].title.nlInformal,
              ),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                undefined,
                concept.procedures[0].description.nlInformal,
              ),
            )
            .withOrder(1)
            .withWebsites([
              new WebsiteBuilder()
                ...
                .withTitle(
                  LanguageString.of(
                    undefined,
                    undefined,
                    concept.procedures[0].websites[0].title.nlInformal,
                  ),
                )
                .withDescription(
                  LanguageString.of(
                    undefined,
                    undefined,
                    concept.procedures[0].websites[0].description.nlInformal,
                  ),
                )
                .withOrder(1)
                .withUrl(concept.procedures[0].websites[0].url)
              ...
              new WebsiteBuilder()
                ...
                .withTitle(
                  LanguageString.of(
                    undefined,
                    undefined,
                    concept.procedures[0].websites[1].title.nlInformal,
                  ),
                )
                .withDescription(
                  LanguageString.of(
                    undefined,
                    undefined,
                    concept.procedures[0].websites[1].description.nlInformal,
                  ),
                )
                .withOrder(2)
                .withUrl(concept.procedures[0].websites[1].url)
          ...
          new ProcedureBuilder()
            ...
            .withTitle(
              LanguageString.of(
                undefined,
                undefined,
                concept.procedures[1].title.nlInformal,
              ),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                undefined,
                concept.procedures[1].description.nlInformal,
              ),
            )
            .withOrder(2)
            .withWebsites([
              new WebsiteBuilder()
                ...
                .withTitle(
                  LanguageString.of(
                    undefined,
                    undefined,
                    concept.procedures[1].websites[0].title.nlInformal,
                  ),
                )
                .withDescription(
                  LanguageString.of(
                    undefined,
                    undefined,
                    concept.procedures[1].websites[0].description.nlInformal,
                  ),
                )
                .withOrder(1)
                .withUrl(concept.procedures[1].websites[0].url)
              ...
              new WebsiteBuilder()
                ...
                .withTitle(
                  LanguageString.of(
                    undefined,
                    undefined,
                    concept.procedures[1].websites[1].title.nlInformal,
                  ),
                )
                .withDescription(
                  LanguageString.of(
                    undefined,
                    undefined,
                    concept.procedures[1].websites[1].description.nlInformal,
                  ),
                )
                .withOrder(2)
                .withUrl(concept.procedures[1].websites[1].url)
          ...
          new WebsiteBuilder()
            ...
            .withTitle(
              LanguageString.of(
                undefined,
                undefined,
                concept.websites[0].title.nlInformal,
              ),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                undefined,
                concept.websites[0].description.nlInformal,
              ),
            )
            .withOrder(1)
            .withUrl(concept.websites[0].url)
          ...
          new WebsiteBuilder()
            ...
            .withTitle(
              LanguageString.of(
                undefined,
                undefined,
                concept.websites[1].title.nlInformal,
              ),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                undefined,
                concept.websites[1].description.nlInformal,
              ),
            )
            .withOrder(2)
            .withUrl(concept.websites[1].url)
          ...
          new CostBuilder()
            ...
            .withTitle(
              LanguageString.of(
                undefined,
                undefined,
                concept.costs[0].title.nlInformal,
              ),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                undefined,
                concept.costs[0].description.nlInformal,
              ),
            )
            .withOrder(1)
            .build(),
          new CostBuilder()
            ...
            .withTitle(
              LanguageString.of(
                undefined,
                undefined,
                concept.costs[1].title.nlInformal,
              ),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                undefined,
                concept.costs[1].description.nlInformal,
              ),
            )
            .withOrder(2)
            .build(),
          ...
          new FinancialAdvantageBuilder()
            ...
            .withTitle(
              LanguageString.of(
                undefined,
                undefined,
                concept.financialAdvantages[0].title.nlInformal,
              ),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                undefined,
                concept.financialAdvantages[0].description.nlInformal,
              ),
            )
            .withOrder(1)
            .build(),
          new FinancialAdvantageBuilder()
            ...
            .withTitle(
              LanguageString.of(
                undefined,
                undefined,
                concept.financialAdvantages[1].title.nlInformal,
              ),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                undefined,
                concept.financialAdvantages[1].description.nlInformal,
              ),
            )
            .withOrder(2)
            .build(),
          ...
          new LegalResourceBuilder()
            ...
            .withTitle(
              LanguageString.of(
                undefined,
                undefined,
                concept.legalResources[0].title.nlInformal,
              ),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                undefined,
                concept.legalResources[0].description.nlInformal,
              ),
            )
            .withUrl(concept.legalResources[0].url)
            .withOrder(1)
          ...
          new LegalResourceBuilder()
            ...
            .withTitle(
              LanguageString.of(
                undefined,
                undefined,
                concept.legalResources[1].title.nlInformal,
              ),
            )
            .withDescription(
              LanguageString.of(
                undefined,
                undefined,
                concept.legalResources[1].description.nlInformal,
              ),
            )
            .withUrl(concept.legalResources[1].url)
            .withOrder(2)
    ...
    test("Create new from concept where concept already includes competent authority of bestuurseenheid", async () => {
      ...
      expect(createdInstance.competentAuthorities).toEqual([
        bestuurseenheid.id,
        BestuurseenheidTestBuilder.PEPINGEN_IRI,
      ]);
      expect(createdInstance.executingAuthorities).toEqual([
        bestuurseenheid.id,
        BestuurseenheidTestBuilder.ASSENEDE_IRI,
      ]);
    });
    ...
    test("Create new from concept should update displayConfiguration", async () => {
      ...
      const updatedConceptDisplayConfiguration =
        await conceptDisplayConfigurationTestRepository.findByConceptId(
          bestuurseenheid,
          concept.id,
        );

      expect(updatedConceptDisplayConfiguration.conceptIsNew).toEqual(false);
      expect(updatedConceptDisplayConfiguration.conceptIsInstantiated).toEqual(
        true,
      );
    });
  });
  ...
  describe("copy instance", () => {
    test("Copy instance, when instance is a full instance", async () => {
      ...
      const reloadedCopiedInstance = await instanceRepository.findById(
        bestuurseenheid,
        copiedInstance.id,
      );
      ...
      expect(copiedInstance.title).toEqual(
        LanguageString.ofValueInLanguage(
          "Kopie van " + instance.title.nlFormal,
          Language.FORMAL,
        ),
      );
      expect(copiedInstance.description).toEqual(instance.description);
      expect(copiedInstance.additionalDescription).toEqual(
      ...
      expect(copiedInstance.competentAuthorityLevels).toEqual(
        instance.competentAuthorityLevels,
      );
      expect(copiedInstance.competentAuthorities).toEqual(
        instance.competentAuthorities,
      );
      expect(copiedInstance.executingAuthorityLevels).toEqual(
        instance.executingAuthorityLevels,
      );
      expect(copiedInstance.executingAuthorities).toEqual(
        instance.executingAuthorities,
      );
      expect(copiedInstance.publicationMedia).toEqual(
        instance.publicationMedia,
      );
      expect(copiedInstance.yourEuropeCategories).toEqual(
        instance.yourEuropeCategories,
      );
      expect(copiedInstance.keywords).toEqual(instance.keywords);
      expect(copiedInstance.requirements).toEqual(
        expect.arrayContaining([
          ...
          expect.objectContaining({
            ...
            _evidence: expect.objectContaining({
              _id: expect.not.objectContaining(
                instance.requirements[1].evidence.id,
              ),
              _uuid: expect.stringMatching(uuidRegex),
      ...
      expect(copiedInstance.procedures).toEqual(
        expect.arrayContaining([
          expect.objectContaining({
            ...
            _websites: expect.arrayContaining([
              ...
              expect.objectContaining({
                _id: expect.not.objectContaining(
                  instance.procedures[0].websites[1].id,
                ),
                _uuid: expect.stringMatching(uuidRegex),
          ...
          expect.objectContaining({
            ...
            _websites: expect.arrayContaining([
              expect.objectContaining({
                _id: expect.not.objectContaining(
                  instance.procedures[1].websites[0].id,
                ),
                _uuid: expect.stringMatching(uuidRegex),
              ...
              expect.objectContaining({
                _id: expect.not.objectContaining(
                  instance.procedures[1].websites[1].id,
                ),
                _uuid: expect.stringMatching(uuidRegex),
      ...
      expect(copiedInstance.websites).toEqual(
        expect.arrayContaining([
          expect.objectContaining({
      ...
      expect(copiedInstance.costs).toEqual(
        expect.arrayContaining([
          expect.objectContaining({
      ...
      expect(copiedInstance.financialAdvantages).toEqual(
        expect.arrayContaining([
          expect.objectContaining({
            _id: expect.not.objectContaining(
      ...
      expect(copiedInstance.contactPoints).toEqual(
        expect.arrayContaining([
          expect.objectContaining({
          ...
          expect.objectContaining({
            ...
            _address: expect.objectContaining({
              _id: expect.not.objectContaining(
                instance.contactPoints[1].address.id,
              ),
              _uuid: expect.stringMatching(uuidRegex),
      ...
      expect(copiedInstance.conceptSnapshotId).toEqual(
      ...
      expect(copiedInstance.dutchLanguageVariant).toEqual(
        instance.dutchLanguageVariant,
      );
      expect(copiedInstance.needsConversionFromFormalToInformal).toEqual(
      ...
      expect(copiedInstance.legalResources).toEqual(
        expect.arrayContaining([
          expect.objectContaining({
    ...
    test("Copy instance, when instance is a minimal instance", async () => {
      ...
      expect(copiedInstance.createdBy).toEqual(instance.createdBy);
      expect(copiedInstance.title).toEqual(
        LanguageString.ofValueInLanguage("Kopie van ", Language.FORMAL),
      );
      expect(copiedInstance.description).toEqual(instance.description);
      expect(copiedInstance.additionalDescription).toEqual(
        instance.additionalDescription,
    ...
    test("copy instance for municipality merger, competent authority level not Lokaal", async () => {
      ...
      const instance = aMinimalInstance()
        ...
        .withExecutingAuthorityLevels(
          InstanceTestBuilder.EXECUTING_AUTHORITY_LEVELS,
        )
