...
describe('Creating a new Instance domain service', () => {
    ...
    test('Copy instance, when instance is a full instance', async () => {
        ...
        const copiedInstance = await newInstanceDomainService.copyFrom(bestuurseenheid, instance);
        ...
        expect(copiedInstance.forMunicipalityMerger).toEqual(instance.forMunicipalityMerger);
    });
