...
import { instancePublishedOnIpdcTni } from "../../driven/external/instance-informal-language-strings-fetcher-ipdc.it-test";
...
describe("Convert Instance To Informal Domain Service", () => {
  const instanceTestRepository = new InstanceSparqlTestRepository(
    TEST_SPARQL_ENDPOINT,
  );
  ...
  describe("Confirm instance already informal", () => {
    ...
    test("When instance dutchLanguageVersion already is informal, then throw error", async () => {
      ...
      const instance = aMinimalPublishedInstance()
        ...
        .withDescription(
          LanguageString.of(undefined, undefined, "beschrijving"),
        )
    ...
    test("When instance is not published, then throw error", async () => {
      ...
      await expect(() =>
        ...
        InvariantError,
        "Instantie moet gepubliceerd zijn",
      );
    });
    ...
    test("When bestuurseenheid chose formal, then throw error", async () => {
      ...
      await expect(() =>
        ...
        InvariantError,
        "Je moet gekozen hebben voor de je-vorm",
      );
    });
    ...
    test("should transform all language fields nl or nl-be-x-formal languageStrings to nl-be-x-informal", async () => {
      ...
      const actualInstance = await instanceTestRepository.findById(
        bestuurseenheid,
        instance.id,
      );

      expect(actualInstance.calculatedInstanceLanguages()).toEqual([
        Language.INFORMAL,
      ]);
      expect(actualInstance.title).toEqual(
        LanguageString.of(undefined, undefined, "Instance Title - nl-formal"),
      );
      expect(actualInstance.description).toEqual(
        LanguageString.of(
          undefined,
          undefined,
      ...
      expect(actualInstance.additionalDescription).toEqual(
        LanguageString.of(
          undefined,
          undefined,
      ...
      expect(actualInstance.exception).toEqual(
        LanguageString.of(
          undefined,
          undefined,
          "Instance Exception - nl-formal",
        ),
      );
      expect(actualInstance.regulation).toEqual(
        LanguageString.of(
          undefined,
          undefined,
      ...
      expect(actualInstance.requirements[0].title).toEqual(
        LanguageString.of(
          undefined,
          undefined,
          "Requirement Title - nl-formal",
        ),
      );
      expect(actualInstance.requirements[0].description).toEqual(
        LanguageString.of(
          undefined,
          undefined,
      ...
      expect(actualInstance.requirements[0].evidence.title).toEqual(
        LanguageString.of(undefined, undefined, "Evidence Title - nl-formal"),
      );
      expect(actualInstance.requirements[0].evidence.description).toEqual(
        LanguageString.of(
          undefined,
          undefined,
      ...
      expect(actualInstance.requirements[1].title).toEqual(
        LanguageString.of(
          undefined,
          undefined,
          "Requirement Title - nl-formal",
      ...
      expect(actualInstance.requirements[1].description).toEqual(
        LanguageString.of(
          undefined,
          undefined,
          "Requirement Description - nl-formal",
      ...
      expect(actualInstance.procedures[0].title).toEqual(
        LanguageString.of(undefined, undefined, "Procedure Title - nl-formal"),
      );
      expect(actualInstance.procedures[0].description).toEqual(
        LanguageString.of(
          undefined,
          undefined,
      ...
      expect(actualInstance.procedures[0].websites[0].title).toEqual(
        LanguageString.of(undefined, undefined, "Website Title - nl-formal"),
      );
      expect(actualInstance.procedures[0].websites[0].description).toEqual(
        LanguageString.of(
          undefined,
          undefined,
      ...
      expect(actualInstance.procedures[1].title).toEqual(
        LanguageString.of(undefined, undefined, "Procedure Title - nl-formal"),
      );
      expect(actualInstance.procedures[1].description).toEqual(
        LanguageString.of(
          undefined,
          undefined,
          "Procedure Description - nl-formal",
      ...
      expect(actualInstance.websites[0].title).toEqual(
        LanguageString.of(undefined, undefined, "Website Title - nl-formal"),
      );
      expect(actualInstance.websites[0].description).toEqual(
        LanguageString.of(
          undefined,
          undefined,
          "Website Description - nl-formal",
      ...
      expect(actualInstance.websites[1].title).toEqual(
        LanguageString.of(undefined, undefined, "Website Title - nl-formal"),
      );
      expect(actualInstance.websites[1].description).toEqual(
        LanguageString.of(
          undefined,
          undefined,
          "Website Description - nl-formal",
      ...
      expect(actualInstance.costs[0].title).toEqual(
        LanguageString.of(undefined, undefined, "Cost Title - nl-formal"),
      );
      expect(actualInstance.costs[0].description).toEqual(
        LanguageString.of(undefined, undefined, "Cost Description - nl-formal"),
      );
      expect(actualInstance.costs[1].title).toEqual(
        LanguageString.of(undefined, undefined, "Cost Title - nl-formal"),
      );
      expect(actualInstance.costs[1].description).toEqual(
        LanguageString.of(undefined, undefined, "Cost Description - nl-formal"),
      );
      expect(actualInstance.financialAdvantages[0].title).toEqual(
        LanguageString.of(
          undefined,
          undefined,
      ...
      expect(actualInstance.financialAdvantages[0].description).toEqual(
        LanguageString.of(
          undefined,
          undefined,
      ...
      expect(actualInstance.financialAdvantages[1].title).toEqual(
        LanguageString.of(
          undefined,
          undefined,
          "Financial Advantage Title - nl-formal",
      ...
      expect(actualInstance.financialAdvantages[1].description).toEqual(
        LanguageString.of(
          undefined,
          undefined,
          "Financial Advantage Description - nl-formal",
      ...
      expect(actualInstance.legalResources[0].title).toEqual(
        LanguageString.of(
          undefined,
          undefined,
      ...
      expect(actualInstance.legalResources[0].description).toEqual(
        LanguageString.of(
          undefined,
          undefined,
      ...
      expect(actualInstance.legalResources[1].title).toEqual(
        LanguageString.of(
          undefined,
          undefined,
          "Legal Resource Title - nl-formal",
      ...
      expect(actualInstance.legalResources[1].description).toEqual(
        LanguageString.of(
          undefined,
          undefined,
          "Legal Resource Description - nl-formal",
    ...
    test("When instance dutchLanguageVersion already is informal, then throw error", async () => {
      ...
      const instance = aFullInstance()
        ...
        .withRequirements([
          aFullRequirementForInstance()
            .withUuid(uuidv4())
            .withEvidence(aFullEvidenceForInstance().withUuid(uuidv4()).build())
            .build(),
        ])
        .withProcedures([
          aFullProcedureForInstance()
            .withUuid(uuidv4())
            .withWebsites([
              aFullWebsiteForInstance().withUuid(uuidv4()).withOrder(1).build(),
              anotherFullWebsiteForInstance(uuidv4()).withOrder(2).build(),
            ])
            .build(),
        ])
        .build()
