...
} from "../../../src/core/domain/concept-snapshot";
...
import {
  aFullCost,
  aMinimalCostForConceptSnapshot,
  CostTestBuilder,
...
describe("constructing", () => {
  test("identifier is extracted from id", () => {
    ...
    const aConceptSnapshot = aFullConceptSnapshot().withId(id).build();

    expect(aConceptSnapshot.identifier).toEqual(aUUID);
  });

  test("keywords are sorted", () => {
    const aConceptSnapshot = aFullConceptSnapshot()
      .withKeywords([LanguageString.of("def"), LanguageString.of("abc")])
      .build();
  ...
  test("Undefined id throws error", () => {
    expect(() =>
      aFullConceptSnapshot().withId(undefined).build(),
    ).toThrowWithMessage(InvariantError, "id mag niet ontbreken");
  });

  test("Invalid iri id throws error", () => {
    expect(() =>
      aFullConceptSnapshot().withId(new Iri("   ")).build(),
    ).toThrowWithMessage(InvariantError, "iri mag niet leeg zijn");
  });

  test("Undefined title throws error", () => {
    expect(() =>
      aFullConceptSnapshot().withTitle(undefined).build(),
    ).toThrowWithMessage(InvariantError, "title mag niet ontbreken");
  });

  test("Undefined description throws error", () => {
    expect(() =>
      aFullConceptSnapshot().withDescription(undefined).build(),
    ).toThrowWithMessage(InvariantError, "description mag niet ontbreken");
  });

  test("Undefined productId throws error", () => {
    expect(() =>
      aFullConceptSnapshot().withProductId(undefined).build(),
    ).toThrowWithMessage(InvariantError, "productId mag niet ontbreken");
  });

  test("Blank productId throws error", () => {
    expect(() =>
      aFullConceptSnapshot().withProductId("   ").build(),
    ).toThrowWithMessage(InvariantError, "productId mag niet leeg zijn");
  });

  test("TargetAudience with duplicates throws error", () => {
    const conceptTestBuilder = aFullConceptSnapshot().withTargetAudiences([
      TargetAudienceType.BURGER,
      TargetAudienceType.BURGER,
    ]);
    expect(() => conceptTestBuilder.build()).toThrowWithMessage(
      InvariantError,
  ...
  test("Themes with duplicates throws error", () => {
    const conceptTestBuilder = aFullConceptSnapshot().withThemes([
  ...
  test("CompetentAuthorityLevels with duplicates throws error", () => {
    const conceptTestBuilder =
      aFullConceptSnapshot().withCompetentAuthorityLevels([
  ...
  test("CompetentAuthorities with duplicates throws error", () => {
    const conceptTestBuilder = aFullConceptSnapshot().withCompetentAuthorities([
  ...
  test("ExecutingAuthorityLevels with duplicates throws error", () => {
    const conceptTestBuilder =
      aFullConceptSnapshot().withExecutingAuthorityLevels([
  ...
  test("ExecutingAuthorities with duplicates throws error", () => {
    const conceptTestBuilder = aFullConceptSnapshot().withExecutingAuthorities([
      BestuurseenheidTestBuilder.PEPINGEN_IRI,
      BestuurseenheidTestBuilder.PEPINGEN_IRI,
    ]);
    expect(() => conceptTestBuilder.build()).toThrowWithMessage(
  ...
  test("PublicationMedia with duplicates throws error", () => {
    const conceptTestBuilder = aFullConceptSnapshot().withPublicationMedia([
  ...
  test("YourEuropeCategories with duplicates throws error", () => {
    const conceptTestBuilder = aFullConceptSnapshot().withYourEuropeCategories([
  ...
  test("keywords with duplicates throws error", () => {
    const conceptTestBuilder = aFullConceptSnapshot().withKeywords([
  ...
  test("keywords with other nl language does not throws error", () => {
    ...
    expect(() => conceptTestBuilder.build()).not.toThrowWithMessage(
      InvariantError,
  ...
  describe("dateCreated", () => {
    test("Invalid dateCreated throws error", () => {
      expect(() =>
        aFullConceptSnapshot()
          .withDateCreated(FormatPreservingDate.of(undefined))
          .build(),
    ...
    test("Undefined dateCreated throws error", () => {
      expect(() =>
        aFullConceptSnapshot().withDateCreated(undefined).build(),
      ).toThrowWithMessage(InvariantError, "dateCreated mag niet ontbreken");
    });
    ...
    test("Blank dateCreated throws error", () => {
      expect(() =>
        aFullConceptSnapshot()
          .withDateCreated(FormatPreservingDate.of(""))
          .build(),
      ).toThrowWithMessage(InvariantError, "dateCreated mag niet ontbreken");
    });
  });
  ...
  describe("dateModified", () => {
    test("Invalid dateModified throws error", () => {
      expect(() =>
        aFullConceptSnapshot()
          .withDateModified(FormatPreservingDate.of(undefined))
          .build(),
    ...
    test("Undefined dateModified throws error", () => {
      expect(() =>
        aFullConceptSnapshot().withDateModified(undefined).build(),
      ).toThrowWithMessage(InvariantError, "dateModified mag niet ontbreken");
    });
    ...
    test("Blank dateModified throws error", () => {
      expect(() =>
        aFullConceptSnapshot()
          .withDateModified(FormatPreservingDate.of(""))
          .build(),
      ).toThrowWithMessage(InvariantError, "dateModified mag niet ontbreken");
    });
  });
  ...
  describe("generatedAtTime", () => {
    test("Invalid generatedAtTime throws error", () => {
      expect(() =>
        aFullConceptSnapshot()
          .withGeneratedAtTime(FormatPreservingDate.of(undefined))
          .build(),
      ).toThrowWithMessage(
        InvariantError,
        "generatedAtTime mag niet ontbreken",
      );
    });

    test("Undefined generatedAtTime throws error", () => {
      expect(() =>
        aFullConceptSnapshot().withGeneratedAtTime(undefined).build(),
      ).toThrowWithMessage(
        InvariantError,
        "generatedAtTime mag niet ontbreken",
      );
    ...
    test("Blank generatedAtTime throws error", () => {
      expect(() =>
        aFullConceptSnapshot()
          .withGeneratedAtTime(FormatPreservingDate.of(""))
          .build(),
      ).toThrowWithMessage(
        InvariantError,
        "generatedAtTime mag niet ontbreken",
  ...
  test("conceptTags with duplicates throws error", () => {
    const conceptTestBuilder = aFullConceptSnapshot().withConceptTags([
      ConceptTagType.YOUREUROPEVERPLICHT,
      ConceptTagType.YOUREUROPEVERPLICHT,
    ]);
    expect(() => conceptTestBuilder.build()).toThrowWithMessage(
      InvariantError,
      "conceptTags mag geen duplicaten bevatten",
    );
  });
  ...
  describe("Legal Resource", () => {
    test("valid legal resource does not throw error", () => {
      const validLegalResource = LegalResource.reconstitute(
        ...
        undefined,
        undefined,
        buildCodexVlaanderenIri("123").value,
        1,
      );

      expect(() =>
        aFullConceptSnapshot().withLegalResources([validLegalResource]).build(),
      ).not.toThrow();
    });
    ...
    test("legal resources that dont have unique order throws error", () => {
      const legalResource1 = aMinimalLegalResourceForConceptSnapshot()
        .withOrder(1)
        .build();
      const legalResource2 = aMinimalLegalResourceForConceptSnapshot()
        .withOrder(1)
        .build();
      ...
      expect(() =>
        ...
        InvariantError,
        "legalResources > order mag geen duplicaten bevatten",
      );
    });
  ...
  describe("cost ", () => {
    test("valid cost does not throw error", () => {
      ...
      expect(() =>
        aFullConceptSnapshot().withCosts([validCost]).build(),
      ).not.toThrow();
    });
    ...
    test("invalid cost does throw error", () => {
      ...
      expect(() =>
        aFullConceptSnapshot().withCosts([invalidCost]).build(),
      ).toThrow();
    });

    test("costs that dont have unique order throws error", () => {
      const cost1 = aMinimalCostForConceptSnapshot().withOrder(1).build();
      const cost2 = aMinimalCostForConceptSnapshot().withOrder(1).build();

      expect(() =>
        aFullConceptSnapshot().withCosts([cost1, cost2]).build(),
      ).toThrowWithMessage(
        InvariantError,
    ...
    test("costs that have unique order does not throw error", () => {
      const cost1 = aMinimalCostForConceptSnapshot().withOrder(1).build();
      const cost2 = aMinimalCostForConceptSnapshot().withOrder(2).build();
  ...
  describe("financialAdvantage ", () => {
    test("valid financial advantage does not throw error", () => {
      const validFinancialAdvantage = FinancialAdvantage.reconstitute(
        ...
        undefined,
        aMinimalLanguageString(FinancialAdvantageTestBuilder.TITLE).build(),
    ...
    test("financial advantages that dont have unique order throws error", () => {
      const financialAdvantage1 = aMinimalFinancialAdvantageForConceptSnapshot()
        .withOrder(1)
        .build();
      const financialAdvantage2 = aMinimalFinancialAdvantageForConceptSnapshot()
        .withOrder(1)
        .build();
  ...
  describe("procedure ", () => {
    test("valid procedure does not throw error", () => {
      ...
      expect(() =>
        aFullConceptSnapshot().withProcedures([validProcedure]).build(),
      ).not.toThrow();
    });
    ...
    test("invalid procedure does throw error", () => {
      ...
      expect(() =>
        aFullConceptSnapshot().withProcedures([invalidProcedure]).build(),
      ).toThrow();
    });

    test("procedures that dont have unique order throws error", () => {
      const procedure1 = aMinimalProcedureForConceptSnapshot()
        .withOrder(1)
        .build();
      const procedure2 = aMinimalProcedureForConceptSnapshot()
        .withOrder(1)
        .build();

      expect(() =>
        aFullConceptSnapshot().withProcedures([procedure1, procedure2]).build(),
      ).toThrowWithMessage(
        InvariantError,
  ...
  describe("website ", () => {
    test("valid website does not throw error", () => {
      ...
      expect(() =>
        aFullConceptSnapshot().withWebsites([validWebsite]).build(),
      ).not.toThrow();
    });
    ...
    test("invalid website does throw error", () => {
      ...
      expect(() =>
        aFullConceptSnapshot().withWebsites([invalidWebsite]).build(),
      ).toThrow();
    });

    test("websites that dont have unique order throws error", () => {
      const website1 = aMinimalWebsiteForConceptSnapshot().withOrder(1).build();
      const website2 = aMinimalWebsiteForConceptSnapshot().withOrder(1).build();

      expect(() =>
        aFullConceptSnapshot().withWebsites([website1, website2]).build(),
      ).toThrowWithMessage(
        InvariantError,
    ...
    test("websites that have unique order does not throw error", () => {
      const website1 = aMinimalWebsiteForConceptSnapshot().withOrder(1).build();
      const website2 = aMinimalWebsiteForConceptSnapshot().withOrder(2).build();
  ...
  describe("requirement ", () => {
    test("valid requirement does not throw error", () => {
      ...
      const validRequirement = Requirement.reconstitute(
        ...
        undefined,
        aMinimalLanguageString(RequirementTestBuilder.TITLE).build(),
        aMinimalLanguageString(RequirementTestBuilder.DESCRIPTION).build(),
        1,
        undefined,
      );

      expect(() =>
        aFullConceptSnapshot().withRequirements([validRequirement]).build(),
      ).not.toThrow();
    });
    ...
    test("invalid requirement does throw error", () => {
      ...
      expect(() =>
        aFullConceptSnapshot().withRequirements([invalidRequirement]).build(),
      ).toThrow();
    });

    test("requirements that dont have unique order throws error", () => {
      const requirement1 = aMinimalRequirementForConceptSnapshot()
        .withOrder(1)
        .build();
      const requirement2 = aMinimalRequirementForConceptSnapshot()
        .withOrder(1)
        .build();

      expect(() =>
        aFullConceptSnapshot()
          .withRequirements([requirement1, requirement2])
          .build(),
      ).toThrowWithMessage(
        InvariantError,
    ...
    describe("evidence ", () => {
      test("valid evidence does not throw error", () => {
        ...
        const validRequirement = aFullRequirement()
      ...
      test("invalid evidence does throw error", () => {
        ...
        const invalidRequirement = aFullRequirement()
...
describe("is functionally changed", () => {
  ...
  const aConceptSnapshot = aFullConceptSnapshot().build();

  const functionallyUnchangedTestCases: TestCase[] = [
    ["exactly the same data", aConceptSnapshot, aConceptSnapshot],
    [
      "equal data",
      aFullConceptSnapshot().withId(aConceptSnapshotId).build(),
      aFullConceptSnapshot().withId(aConceptSnapshotId).build(),
    ],
    [
  ...
  for (const testCase of functionallyUnchangedTestCases) {
    test(`not functionally changed when ${testCase[0]}`, () => {
      expect(
        ConceptSnapshot.isFunctionallyChanged(testCase[1], testCase[2]),
      ).toEqual([]);
    });
  }
  ...
  const functionallyChangedTestCases: TestCase[] = [
    [
      ...
      aFullConceptSnapshot()
        .withTitle(
          LanguageString.of("text-nl-veranderd", "text-nl-formal-veranderd"),
        )
        .build(),
      "basisinformatie",
    ],
    ...
    [
      "start date appeared",
      aFullConceptSnapshot().withStartDate(undefined).build(),
      aFullConceptSnapshot()
        .withStartDate(FormatPreservingDate.of("2023-11-09T00:00:00.000Z"))
        .build(),
      "algemene info (eigenschappen)",
    ...
    [
      "end date appeared",
      aFullConceptSnapshot().withEndDate(undefined).build(),
      aFullConceptSnapshot()
        .withEndDate(FormatPreservingDate.of("2023-11-09T00:00:00.000Z"))
        .build(),
      "algemene info (eigenschappen)",
    ...
    [
      "type changed",
      aFullConceptSnapshot().withType(ProductType.FINANCIEELVOORDEEL).build(),
      aFullConceptSnapshot().withType(ProductType.BEWIJS).build(),
      "algemene info (eigenschappen)",
    ],
    [
      "type appeared",
      aFullConceptSnapshot().withType(undefined).build(),
      aFullConceptSnapshot().withType(ProductType.FINANCIEELVOORDEEL).build(),
      "algemene info (eigenschappen)",
    ],
    [
    ...
    [
      "theme updated",
      aFullConceptSnapshot().withThemes([ThemeType.WELZIJNGEZONDHEID]).build(),
      aFullConceptSnapshot()
    ...
    [
      ...
      aFullConceptSnapshot()
        .withYourEuropeCategories([
          YourEuropeCategoryType.BEDRIJFINTELLECTUELEEIGENDOMSRECHTEN,
        ])
        .build(),
      "gerelateerd (eigenschappen)",
    ],
    [
      ...
      aFullConceptSnapshot()
        .withYourEuropeCategories([
          YourEuropeCategoryType.BEDRIJFKREDIETVERZEKERING,
        ])
        .build(),
      aFullConceptSnapshot()
        .withYourEuropeCategories([
          YourEuropeCategoryType.BEDRIJFKREDIETVERZEKERING,
          YourEuropeCategoryType.GEZONDHEIDSZORG,
        ])
        .build(),
      "gerelateerd (eigenschappen)",
    ],
    [
      ...
      aFullConceptSnapshot()
        .withYourEuropeCategories([
          YourEuropeCategoryType.PROCEDUREVERHUIZINGADRESWIJZIGING,
          YourEuropeCategoryType.ONDERWIJSOFSTAGESTAGE,
        ])
        .build(),
      aFullConceptSnapshot()
        .withYourEuropeCategories([
    ...
    [
      "requirement added",
      aFullConceptSnapshot().withRequirements([]).build(),
      aFullConceptSnapshot()
    ...
    [
      ...
      aFullConceptSnapshot()
        .withRequirements([
          aMinimalRequirementForConceptSnapshot()
            .withTitle(LanguageString.of("requirement-title-nl-1"))
            .withOrder(1)
            .build(),
          aMinimalRequirementForConceptSnapshot()
            .withTitle(LanguageString.of("requirement-title-nl-2"))
            .withOrder(2)
            .build(),
        ])
        .build(),
    ...
    [
      ...
      aFullConceptSnapshot()
        .withRequirements([
          aMinimalRequirementForConceptSnapshot()
            .withTitle(LanguageString.of("requirement-title-nl"))
            .build(),
        ])
        .build(),
      aFullConceptSnapshot()
    ...
    [
      ...
      aFullConceptSnapshot()
        .withRequirements([
          aMinimalRequirementForConceptSnapshot()
            .withTitle(LanguageString.of("requirement-title-changed"))
            .build(),
        ])
        .build(),
      "voorwaarden",
    ...
    [
      ...
      aFullConceptSnapshot()
        .withRequirements([
          aMinimalRequirementForConceptSnapshot()
            .withDescription(LanguageString.of("requirement-description-nl"))
            .build(),
        ])
        .build(),
      "voorwaarden",
    ...
    [
      ...
      aFullConceptSnapshot()
        .withRequirements([
          aMinimalRequirementForConceptSnapshot()
            .withDescription(
              LanguageString.of("requirement-description-changed"),
            )
            .build(),
        ])
        .build(),
    ...
    [
      ...
      aFullConceptSnapshot()
        .withRequirements([
          aMinimalRequirementForConceptSnapshot()
            .withEvidence(aFullEvidence().build())
            .build(),
        ])
        .build(),
      "voorwaarden",
      ...
      aFullConceptSnapshot()
        .withRequirements([
          aMinimalRequirementForConceptSnapshot()
            .withEvidence(
              aMinimalEvidenceForConceptSnapshot()
                .withTitle(LanguageString.of("evidence title nl"))
                .build(),
            )
            .build(),
        ])
      ...
      aFullConceptSnapshot()
        .withRequirements([
          aMinimalRequirementForConceptSnapshot()
            .withEvidence(
              aMinimalEvidenceForConceptSnapshot()
                .withTitle(LanguageString.of("evidence title nl updated"))
                .build(),
            )
            .build(),
        ])
      ...
      aFullConceptSnapshot()
        .withRequirements([
          aMinimalRequirementForConceptSnapshot()
            .withEvidence(
              aMinimalEvidenceForConceptSnapshot()
                .withDescription(LanguageString.of("evidence description nl"))
                .build(),
            )
            .build(),
        ])
        ...
        .withRequirements([
          aMinimalRequirementForConceptSnapshot()
            .withEvidence(
              aMinimalEvidenceForConceptSnapshot()
                .withDescription(
                  LanguageString.of("evidence description nl updated"),
                )
                .build(),
            )
            .build(),
    ...
    [
      "procedure added",
      aFullConceptSnapshot().withProcedures([]).build(),
      aFullConceptSnapshot().withProcedures([aFullProcedure().build()]).build(),
      "procedure",
    ],
    [
      "procedure removed",
    ...
    [
      ...
      aFullConceptSnapshot()
        .withProcedures([
          aFullProcedure()
            .withTitle(LanguageString.of("procedure title nl"))
            .withOrder(1)
            .build(),
          aFullProcedure()
            .withTitle(LanguageString.of("procedure title nl another"))
            .withOrder(2)
            .build(),
        ])
        .build(),
    ...
    [
      ...
      aFullConceptSnapshot()
        .withProcedures([
          aFullProcedure()
            .withTitle(LanguageString.of("procedure title nl updated"))
            .build(),
        ])
        .build(),
      "procedure",
    ...
    [
      ...
      aFullConceptSnapshot()
        .withProcedures([
          aFullProcedure()
            .withDescription(LanguageString.of("procedure description nl"))
            .build(),
        ])
        .build(),
      aFullConceptSnapshot()
        .withProcedures([
          aFullProcedure()
            .withDescription(
              LanguageString.of("procedure description nl updated"),
            )
            .build(),
        ])
        .build(),
      ...
      aFullConceptSnapshot()
        .withProcedures([
          aFullProcedure()
            .withWebsites([
              aMinimalWebsiteForConceptSnapshot()
                .withTitle(LanguageString.of("procedure website title nl"))
                .build(),
            ])
            .build(),
        ])
        ...
        .withProcedures([
          aFullProcedure()
            .withWebsites([
              aMinimalWebsiteForConceptSnapshot()
                .withTitle(
                  LanguageString.of("procedure website title nl updated"),
                )
                .build(),
            ])
            .build(),
        ...
        .withProcedures([
          aFullProcedure()
            .withWebsites([
              aMinimalWebsiteForConceptSnapshot()
                .withDescription(
                  LanguageString.of("procedure website description nl"),
                )
                .build(),
            ])
            .build(),
        ...
        .withProcedures([
          aFullProcedure()
            .withWebsites([
              aMinimalWebsiteForConceptSnapshot()
                .withDescription(
                  LanguageString.of("procedure website description nl updated"),
                )
                .build(),
            ])
            .build(),
    ...
    [
      ...
      aFullConceptSnapshot()
        .withProcedures([
          aFullProcedure().withWebsites([aFullWebsite().build()]).build(),
        ])
        .build(),
      "procedure",
    ],
    ...
    [
      "website added",
      aFullConceptSnapshot().withWebsites([]).build(),
      aFullConceptSnapshot().withWebsites([aFullWebsite().build()]).build(),
      "meer info",
    ],
    [
      "website removed",
    ...
    [
      ...
      aFullConceptSnapshot()
        .withWebsites([
          aMinimalWebsiteForConceptSnapshot()
            .withTitle(LanguageString.of("website title nl"))
            .build(),
        ])
        .build(),
      aFullConceptSnapshot()
        .withWebsites([
          aMinimalWebsiteForConceptSnapshot()
            .withTitle(LanguageString.of("website title nl updated"))
            .build(),
        ])
        .build(),
      "meer info",
    ...
    [
      ...
      aFullConceptSnapshot()
        .withWebsites([
          aMinimalWebsiteForConceptSnapshot()
            .withDescription(LanguageString.of("website description nl"))
            .build(),
        ])
        .build(),
      aFullConceptSnapshot()
        .withWebsites([
          aMinimalWebsiteForConceptSnapshot()
            .withDescription(
              LanguageString.of("website description nl updated"),
            )
            .build(),
        ])
        .build(),
    ...
    [
      "cost added",
      aFullConceptSnapshot().withCosts([]).build(),
      aFullConceptSnapshot().withCosts([aFullCost().build()]).build(),
      "kosten",
    ],
    [
      "cost removed",
    ...
    [
      ...
      aFullConceptSnapshot()
        .withCosts([
          aFullCost().withTitle(LanguageString.of("cost title nl")).build(),
        ])
        .build(),
      aFullConceptSnapshot()
        .withCosts([
          aFullCost()
            .withTitle(LanguageString.of("cost title nl updated"))
            .build(),
        ])
        .build(),
      "kosten",
    ...
    [
      ...
      aFullConceptSnapshot()
        .withCosts([
          aFullCost()
            .withDescription(LanguageString.of("cost description nl"))
            .build(),
        ])
        .build(),
      aFullConceptSnapshot()
        .withCosts([
          aFullCost()
            .withDescription(LanguageString.of("cost description nl updated"))
            .build(),
        ])
        .build(),
      "kosten",
    ...
    [
      ...
      aFullConceptSnapshot()
        .withCosts([
          aFullCost()
            .withTitle(LanguageString.of("cost title 1 nl"))
            .withOrder(1)
            .build(),
          aFullCost()
            .withTitle(LanguageString.of("cost title 2 nl"))
            .withOrder(2)
            .build(),
        ])
        .build(),
    ...
    [
      ...
      aFullConceptSnapshot().withFinancialAdvantages([]).build(),
      aFullConceptSnapshot()
    ...
    [
      ...
      aFullConceptSnapshot()
        .withFinancialAdvantages([
          aFullFinancialAdvantage()
            .withTitle(LanguageString.of("financial advantage title nl"))
            .build(),
        ])
        .build(),
      aFullConceptSnapshot()
        .withFinancialAdvantages([
          aFullFinancialAdvantage()
            .withTitle(
              LanguageString.of("financial advantage title nl updated"),
            )
            .build(),
        ])
        .build(),
    ...
    [
      ...
      aFullConceptSnapshot()
        .withFinancialAdvantages([
          aFullFinancialAdvantage()
            .withDescription(
              LanguageString.of("financial advantage description nl"),
            )
            .build(),
        ])
        .build(),
      aFullConceptSnapshot()
        .withFinancialAdvantages([
          aFullFinancialAdvantage()
            .withDescription(
              LanguageString.of("financial advantage description nl updated"),
            )
            .build(),
        ])
        .build(),
    ...
    [
      ...
      aFullConceptSnapshot()
        .withFinancialAdvantages([
          aFullFinancialAdvantage()
            .withTitle(LanguageString.of("financial advantage title 1 nl"))
            .withOrder(1)
            .build(),
          aFullFinancialAdvantage()
            .withTitle(LanguageString.of("financial advantage title 2 nl"))
            .withOrder(2)
            .build(),
        ])
        .build(),
    ...
    [
      ...
      aFullConceptSnapshot().withLegalResources([]).build(),
      aFullConceptSnapshot()
    ...
    [
      ...
      aFullConceptSnapshot()
        .withLegalResources([
          aFullLegalResourceForConceptSnapshot()
            .withTitle(LanguageString.of("legal resource title nl"))
            .build(),
        ])
        .build(),
      aFullConceptSnapshot()
        .withLegalResources([
          aFullLegalResourceForConceptSnapshot()
            .withTitle(LanguageString.of("legal resource title nl updated"))
            .build(),
        ])
        .build(),
      "regelgeving",
    ...
    [
      ...
      aFullConceptSnapshot()
        .withLegalResources([
          aFullLegalResourceForConceptSnapshot()
            .withDescription(LanguageString.of("legal resource description nl"))
            .build(),
        ])
        .build(),
      aFullConceptSnapshot()
        .withLegalResources([
          aFullLegalResourceForConceptSnapshot()
            .withDescription(
              LanguageString.of("legal resource description nl updated"),
            )
            .build(),
        ])
        .build(),
    ...
    [
      ...
      aFullConceptSnapshot()
        .withLegalResources([
          aFullLegalResourceForConceptSnapshot()
            .withUrl(buildCodexVlaanderenIri("1234").value)
            .build(),
        ])
        .build(),
      aFullConceptSnapshot()
        .withLegalResources([
          aFullLegalResourceForConceptSnapshot()
            .withUrl(buildCodexVlaanderenIri("12345").value)
            .build(),
        ])
        .build(),
      "regelgeving",
    ...
    [
      ...
      aFullConceptSnapshot()
        .withLegalResources([
          aFullLegalResourceForConceptSnapshot()
            .withTitle(LanguageString.of("legal resource title 1"))
            .withOrder(1)
            .build(),
          aFullLegalResourceForConceptSnapshot()
            .withTitle(LanguageString.of("legal resource title 2"))
            .withOrder(2)
            .build(),
        ])
        .build(),
    ...
    [
      "is archived changed",
      aFullConceptSnapshot().withIsArchived(false).build(),
      aFullConceptSnapshot().withIsArchived(true).build(),
      "gearchiveerd",
    ],
  ];
  ...
  test("functionally changed returns in a fixed order", () => {
    const conceptSnapshot = aFullConceptSnapshot()
      ...
      .withPublicationMedia([PublicationMediumType.RECHTENVERKENNER])
      .withYourEuropeCategories([
        YourEuropeCategoryType.BEDRIJFAANSPRAKELIJKHEIDBESTUURDERS,
      ])
    ...
    const anotherConceptSnapshot = aFullConceptSnapshot()
      ...
      .withAdditionalDescription(
        LanguageString.of("additionalDescription-nl-changed"),
      )
      ...
      .withPublicationMedia([PublicationMediumType.YOUREUROPE])
      .withYourEuropeCategories([
        YourEuropeCategoryType.GEZONDHEIDVEILIGHEIDWERK,
      ])
...
describe("builder", () => {
  test("from copies all fields", () => {
    ...
    const fromConceptSnapshot =
      ConceptSnapshotBuilder.from(conceptSnapshot).build();
...
test("transform language for full concept snapshot", () => {
  ...
  expect(
    aConceptSnapshot.transformLanguage(
      Language.GENERATED_INFORMAL,
      Language.INFORMAL,
    ),
  ).toEqual(
    ConceptSnapshotBuilder.from(aConceptSnapshot)
      ...
      .withRequirements(
        [0, 1].map((index) =>
          RequirementBuilder.from(aConceptSnapshot.requirements[index])
            .withTitle(
              LanguageString.ofValueInLanguage(
                aConceptSnapshot.requirements[index].title.nlGeneratedInformal,
                Language.INFORMAL,
              ),
            )
            .withDescription(
              LanguageString.ofValueInLanguage(
                aConceptSnapshot.requirements[index].description
                  .nlGeneratedInformal,
                Language.INFORMAL,
              ),
            )
            .withEvidence(
              EvidenceBuilder.from(
                aConceptSnapshot.requirements[index].evidence,
              )
                .withTitle(
                  LanguageString.ofValueInLanguage(
                    aConceptSnapshot.requirements[index].evidence.title
                      .nlGeneratedInformal,
                    Language.INFORMAL,
                  ),
                )
                .withDescription(
                  LanguageString.ofValueInLanguage(
                    aConceptSnapshot.requirements[index].evidence.description
                      .nlGeneratedInformal,
                    Language.INFORMAL,
                  ),
                )
      ...
      .withProcedures(
        [0, 1].map((index) =>
          ProcedureBuilder.from(aConceptSnapshot.procedures[index])
            .withTitle(
              LanguageString.ofValueInLanguage(
                aConceptSnapshot.procedures[index].title.nlGeneratedInformal,
                Language.INFORMAL,
              ),
            )
            .withDescription(
              LanguageString.ofValueInLanguage(
                aConceptSnapshot.procedures[index].description
                  .nlGeneratedInformal,
                Language.INFORMAL,
              ),
            )
            .withWebsites(
              [0, 1].map((innerIndex) =>
                WebsiteBuilder.from(
                  aConceptSnapshot.procedures[index].websites[innerIndex],
                )
                  .withTitle(
                    LanguageString.ofValueInLanguage(
                      aConceptSnapshot.procedures[index].websites[innerIndex]
                        .title.nlGeneratedInformal,
                      Language.INFORMAL,
                    ),
                  )
                  .withDescription(
                    LanguageString.ofValueInLanguage(
                      aConceptSnapshot.procedures[index].websites[innerIndex]
                        .description.nlGeneratedInformal,
                      Language.INFORMAL,
                    ),
                  )
                  .build(),
      ...
      .withWebsites(
        [0, 1].map((index) =>
          WebsiteBuilder.from(aConceptSnapshot.websites[index])
            .withTitle(
              LanguageString.ofValueInLanguage(
                aConceptSnapshot.websites[index].title.nlGeneratedInformal,
                Language.INFORMAL,
              ),
            )
            .withDescription(
              LanguageString.ofValueInLanguage(
                aConceptSnapshot.websites[index].description
                  .nlGeneratedInformal,
                Language.INFORMAL,
              ),
            )
      ...
      .withCosts(
        [0, 1].map((index) =>
          CostBuilder.from(aConceptSnapshot.costs[index])
            .withTitle(
              LanguageString.ofValueInLanguage(
                aConceptSnapshot.costs[index].title.nlGeneratedInformal,
                Language.INFORMAL,
              ),
            )
            .withDescription(
              LanguageString.ofValueInLanguage(
                aConceptSnapshot.costs[index].description.nlGeneratedInformal,
                Language.INFORMAL,
              ),
            )
            .build(),
      ...
      .withFinancialAdvantages(
        [0, 1].map((index) =>
          FinancialAdvantageBuilder.from(
            aConceptSnapshot.financialAdvantages[index],
          )
            .withTitle(
              LanguageString.ofValueInLanguage(
                aConceptSnapshot.financialAdvantages[index].title
                  .nlGeneratedInformal,
                Language.INFORMAL,
              ),
            )
            .withDescription(
              LanguageString.ofValueInLanguage(
                aConceptSnapshot.financialAdvantages[index].description
                  .nlGeneratedInformal,
                Language.INFORMAL,
              ),
            )
      ...
      .withLegalResources(
        [0, 1].map((index) =>
          LegalResourceBuilder.from(aConceptSnapshot.legalResources[index])
            .withTitle(
              LanguageString.ofValueInLanguage(
                aConceptSnapshot.legalResources[index].title
                  .nlGeneratedInformal,
                Language.INFORMAL,
              ),
            )
            .withDescription(
              LanguageString.ofValueInLanguage(
                aConceptSnapshot.legalResources[index].description
                  .nlGeneratedInformal,
                Language.INFORMAL,
              ),
            )
...
test("transform language for minimal concept snapshot", () => {
  ...
  expect(
    aMinimalConceptSnapshotInNLOnly.transformLanguage(
      Language.GENERATED_INFORMAL,
      Language.INFORMAL,
    ),
  ).toEqual(
    ConceptSnapshotBuilder.from(aMinimalConceptSnapshotInNLOnly)
      ...
      .withDescription(
        LanguageString.ofValueInLanguage(undefined, Language.INFORMAL),
      )
      .build(),
  );

  const aMinimalConceptSnapshotInRequestedLanguage = aMinimalConceptSnapshot()
    .withTitle(
      LanguageString.ofValueInLanguage("title", Language.GENERATED_INFORMAL),
    )
    .withDescription(
      LanguageString.ofValueInLanguage(
        "description",
    ...
    .build();
  expect(
    aMinimalConceptSnapshotInRequestedLanguage.transformLanguage(
      Language.GENERATED_INFORMAL,
      Language.INFORMAL,
    ),
  ).toEqual(
    ConceptSnapshotBuilder.from(aMinimalConceptSnapshotInRequestedLanguage)
      ...
      .withDescription(
        LanguageString.ofValueInLanguage("description", Language.INFORMAL),
      )
      .build(),
  );
});
