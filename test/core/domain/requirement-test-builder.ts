...
export function aMinimalRequirementForInstanceSnapshot(): RequirementBuilder {
  ...
  return new RequirementBuilder()
    ...
    .withOrder(1)
    .withTitle(
      aMinimalInformalLanguageString(RequirementTestBuilder.TITLE).build(),
    )
    .withDescription(
      aMinimalInformalLanguageString(
        RequirementTestBuilder.DESCRIPTION,
      ).build(),
    );
}
...
export function aFullRequirementForInstance(): RequirementBuilder {
  ...
  return new RequirementBuilder()
    ...
    .withUuid(uniqueId)
    .withTitle(
      LanguageString.of(undefined, RequirementTestBuilder.TITLE_NL_FORMAL),
    )
    .withDescription(
      LanguageString.of(
        undefined,
...
export function anotherFullRequirementForInstanceSnapshot(): RequirementBuilder {
  ...
  return new RequirementBuilder()
    ...
    .withOrder(2)
    .withEvidence(
      RequirementTestBuilder.ANOTHER_EVIDENCE_FOR_INSTANCE_SNAPSHOT,
    );
}
...
export class RequirementTestBuilder {
  ...
  public static readonly TITLE_NL_GENERATED_FORMAL =
    "Requirement Title - nl-generated-formal";
  public static readonly TITLE_NL_GENERATED_INFORMAL =
    "Requirement Title - nl-generated-informal";
  ...
  public static readonly DESCRIPTION_NL_INFORMAL =
    "Requirement Description - nl-informal";
  public static readonly DESCRIPTION_NL_GENERATED_FORMAL =
    "Requirement Description - nl-generated-formal";
  public static readonly DESCRIPTION_NL_GENERATED_INFORMAL =
    "Requirement Description - nl-generated-informal";

  public static readonly ANOTHER_TITLE_NL = "Requirement Another Title - nl";
  public static readonly ANOTHER_TITLE_NL_FORMAL =
    "Requirement Another Title - nl-formal";
  public static readonly ANOTHER_TITLE_NL_INFORMAL =
    "Requirement Another Title - nl-informal";
  public static readonly ANOTHER_TITLE_NL_GENERATED_FORMAL =
    "Requirement Another Title - nl-generated-formal";
  public static readonly ANOTHER_TITLE_NL_GENERATED_INFORMAL =
    "Requirement Another Title - nl-generated-informal";

  public static readonly ANOTHER_DESCRIPTION_NL =
    "Requirement Another Description - nl";
  public static readonly ANOTHER_DESCRIPTION_NL_FORMAL =
    "Requirement Another Description - nl-formal";
  public static readonly ANOTHER_DESCRIPTION_NL_INFORMAL =
    "Requirement Another Description - nl-informal";
  public static readonly ANOTHER_DESCRIPTION_NL_GENERATED_FORMAL =
    "Requirement Another Description - nl-generated-formal";
  public static readonly ANOTHER_DESCRIPTION_NL_GENERATED_INFORMAL =
    "Requirement Another Description - nl-generated-informal";

  public static readonly EVIDENCE = aFullEvidence().build();
  public static readonly EVIDENCE_FOR_INSTANCE =
    aFullEvidenceForInstance().build();
  public static readonly EVIDENCE_FOR_INSTANCE_SNAPSHOT =
    aFullEvidenceForInstanceSnapshot().build();
  public static readonly ANOTHER_EVIDENCE = anotherFullEvidence().build();
  public static readonly ANOTHER_EVIDENCE_FOR_INSTANCE =
    anotherFullEvidenceForInstance().build();
  public static readonly ANOTHER_EVIDENCE_FOR_INSTANCE_SNAPSHOT =
    anotherFullEvidenceForInstanceSnapshot().build();
}
