...
export function aMinimalProcedureForInstanceSnapshot(): ProcedureBuilder {
  ...
  return new ProcedureBuilder()
    ...
    .withOrder(1)
    .withTitle(
      aMinimalInformalLanguageString(ProcedureTestBuilder.TITLE).build(),
    )
    .withDescription(
      aMinimalInformalLanguageString(ProcedureTestBuilder.DESCRIPTION).build(),
    );
}
...
export function aFullProcedureForInstance(): ProcedureBuilder {
  ...
  return new ProcedureBuilder()
    ...
    .withUuid(uniqueId)
    .withTitle(
      LanguageString.of(undefined, ProcedureTestBuilder.TITLE_NL_FORMAL),
    )
    .withDescription(
      LanguageString.of(undefined, ProcedureTestBuilder.DESCRIPTION_NL_FORMAL),
    )
    .withOrder(1)
...
export class ProcedureTestBuilder {
  ...
  public static readonly TITLE_NL_GENERATED_FORMAL =
    "Procedure Title - nl-generated-formal";
  public static readonly TITLE_NL_GENERATED_INFORMAL =
    "Procedure Title - nl-generated-informal";
  ...
  public static readonly DESCRIPTION_NL_INFORMAL =
    "Procedure Description - nl-informal";
  public static readonly DESCRIPTION_NL_GENERATED_FORMAL =
    "Procedure Description - nl-generated-formal";
  public static readonly DESCRIPTION_NL_GENERATED_INFORMAL =
    "Procedure Description - nl-generated-informal";

  public static readonly ANOTHER_TITLE_NL = "Procedure Another Title - nl";
  public static readonly ANOTHER_TITLE_NL_FORMAL =
    "Procedure Another Title - nl-formal";
  public static readonly ANOTHER_TITLE_NL_INFORMAL =
    "Procedure Another Title - nl-informal";
  public static readonly ANOTHER_TITLE_NL_GENERATED_FORMAL =
    "Procedure Another Title - nl-generated-formal";
  public static readonly ANOTHER_TITLE_NL_GENERATED_INFORMAL =
    "Procedure Another Title - nl-generated-informal";

  public static readonly ANOTHER_DESCRIPTION_NL =
    "Procedure Another Description - nl";
  public static readonly ANOTHER_DESCRIPTION_NL_FORMAL =
    "Procedure Another Description - nl-formal";
  public static readonly ANOTHER_DESCRIPTION_NL_INFORMAL =
    "Procedure Another Description - nl-informal";
  public static readonly ANOTHER_DESCRIPTION_NL_GENERATED_FORMAL =
    "Procedure Another Description - nl-generated-formal";
  public static readonly ANOTHER_DESCRIPTION_NL_GENERATED_INFORMAL =
    "Procedure Another Description - nl-generated-informal";

  public static readonly WEBSITES = [
    aFullWebsite().withOrder(1).build(),
    anotherFullWebsite(uuid()).withOrder(2).build(),
  ];
  public static readonly ANOTHER_WEBSITES = [
    anotherFullWebsite(uuid()).withOrder(1).build(),
    anotherFullWebsite(uuid()).withOrder(2).build(),
  ];
  public static readonly WEBSITES_FOR_INSTANCE = [
    aFullWebsiteForInstance().withOrder(1).build(),
    anotherFullWebsiteForInstance(uuid()).withOrder(2).build(),
  ];
  public static readonly ANOTHER_WEBSITES_FOR_INSTANCE = [
    anotherFullWebsiteForInstance(uuid()).withOrder(1).build(),
    anotherFullWebsiteForInstance(uuid()).withOrder(2).build(),
  ];
  public static readonly WEBSITES_FOR_INSTANCE_SNAPSHOT = [
    aFullWebsiteForInstanceSnapshot().withOrder(1).build(),
    anotherFullWebsiteForInstanceSnapshot(uuid()).withOrder(2).build(),
  ];
  public static readonly ANOTHER_WEBSITES_FOR_INSTANCE_SNAPSHOT = [
