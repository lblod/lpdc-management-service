...
describe("forConcept", () => {
  test("Undefined id throws error", () => {
    ...
    expect(() => Evidence.forConcept(evidence.build())).toThrowWithMessage(
      InvariantError,
  ...
  test("Invalid iri id throws error", () => {
    expect(() =>
      Evidence.forConcept(aFullEvidence().withId(new Iri("   ")).build()),
...
describe("forConceptSnapshot", () => {
  test("Undefined id throws error", () => {
    const evidence = aFullEvidence().withId(undefined);
    expect(() =>
      Evidence.forConceptSnapshot(evidence.build()),
    ).toThrowWithMessage(InvariantError, "id mag niet ontbreken");
  });

  test("Invalid iri id throws error", () => {
    expect(() =>
      Evidence.forConceptSnapshot(
        aFullEvidence().withId(new Iri("   ")).build(),
      ),
    ).toThrowWithMessage(InvariantError, "iri mag niet leeg zijn");
  });
  ...
  test("Undefined title throws error", () => {
    ...
    expect(() => Evidence.forConceptSnapshot(evidence)).toThrowWithMessage(
      InvariantError,
      "title mag niet ontbreken",
    );
  });
...
describe("for instance", () => {
  ...
  test("Undefined id throws error", () => {
    ...
    expect(() => Evidence.forInstance(evidence.build())).toThrowWithMessage(
      InvariantError,
      "id mag niet ontbreken",
    );
  });
  ...
  test("Undefined Uuid throws error", () => {
    ...
    expect(() => Evidence.forInstance(evidence).uuid).toThrowWithMessage(
      InvariantError,
      "uuid mag niet ontbreken",
    );
  });
  ...
  test("If title and description have different nl languages, throws error", () => {
    ...
    expect(() => Evidence.forInstance(evidence)).toThrowWithMessage(
      InvariantError,
...
describe("for instance snapshot", () => {
  ...
  test("Undefined id throws error", () => {
    ...
    expect(() =>
      Evidence.forInstanceSnapshot(evidence.build()),
    ).toThrowWithMessage(InvariantError, "id mag niet ontbreken");
  });
  ...
  test("Undefined title throws error", () => {
    expect(() =>
      Evidence.forInstanceSnapshot(
        aFullEvidenceForInstanceSnapshot().withTitle(undefined).build(),
      ),
  ...
  test("Undefined description throws error", () => {
    expect(() =>
      Evidence.forInstanceSnapshot(
        aFullEvidenceForInstanceSnapshot().withDescription(undefined).build(),
      ),
  ...
  test("If title and description have different nl languages, throws error", () => {
    ...
    expect(() => Evidence.forInstanceSnapshot(evidence)).toThrowWithMessage(
      InvariantError,
      "Er is meer dan een nl-taal aanwezig",
    );
  });
...
describe("transformLanguage", () => {
  test("should transform Evidence with title, description", () => {
    ...
    expect(
      evidence.transformLanguage(Language.FORMAL, Language.INFORMAL),
    ).toEqual(
      EvidenceBuilder.from(evidence)
        .withTitle(
    ...
    expect(
      evidence.transformLanguage(Language.FORMAL, Language.FORMAL),
    ).toEqual(
      EvidenceBuilder.from(evidence)
        .withTitle(
          LanguageString.ofValueInLanguage(
    ...
    expect(evidence.transformLanguage(Language.NL, Language.FORMAL)).toEqual(
      EvidenceBuilder.from(evidence)
        .withTitle(
          LanguageString.ofValueInLanguage(
