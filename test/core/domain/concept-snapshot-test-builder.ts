...
export function aMinimalConceptSnapshot(): ConceptSnapshotBuilder {
  return new ConceptSnapshotBuilder()
    ...
    .withDescription(
      aMinimalLanguageString("Concept Snapshot Description").build(),
    )
...
export class ConceptSnapshotTestBuilder {
  ...
  public static readonly TITLE_NL_INFORMAL =
    "Concept Snapshot Title - nl-informal";
  public static readonly TITLE_NL_GENERATED_FORMAL =
    "Concept Snapshot Title - nl-generated-formal";
  public static readonly TITLE_NL_GENERATED_INFORMAL =
    "Concept Snapshot Title - nl-generated-informal";
  ...
  public static readonly REQUIREMENTS = [
    aFullRequirement().build(),
    anotherFullRequirement().build(),
  ];

  public static readonly PROCEDURES = [
    aFullProcedure().build(),
    anotherFullProcedure().build(),
  ];
  ...
  public static readonly COSTS = [
    aFullCost().build(),
    anotherFullCost().build(),
  ];

  public static readonly FINANCIAL_ADVANTAGES = [
    aFullFinancialAdvantage().build(),
    anotherFullFinancialAdvantage().build(),
  ];
