            ...
            new InstanceBuilder()
                ...
                .withLegalResources([
                    new LegalResourceBuilder()
                        ...
                        .withTitle(LanguageString.of(concept.legalResources[0].title.en, undefined, concept.legalResources[0].title.nlFormal))
                    ...
                    new LegalResourceBuilder()
                        ...
                        .withTitle(LanguageString.of(concept.legalResources[1].title.en, undefined, concept.legalResources[1].title.nlFormal))
            ...
            new InstanceBuilder()
                ...
                .withLegalResources([
                    new LegalResourceBuilder()
                        .withId(createdInstance.legalResources[0].id)
                        .withUuid(createdInstance.legalResources[0].uuid)
                        .withTitle(LanguageString.of(concept.legalResources[0].title.en, undefined, undefined, concept.legalResources[0].title.nlInformal))
                    ...
                    new LegalResourceBuilder()
                        .withId(createdInstance.legalResources[1].id)
                        .withUuid(createdInstance.legalResources[1].uuid)
                        .withTitle(LanguageString.of(concept.legalResources[1].title.en, undefined, undefined, concept.legalResources[1].title.nlInformal))
