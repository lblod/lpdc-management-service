...
export function aFullInstanceSnapshot(): InstanceSnapshotTestBuilder {
  return aMinimalInstanceSnapshot()
    ...
    .withCompetentAuthorityLevels(
      InstanceSnapshotTestBuilder.COMPETENT_AUTHORITY_LEVELS,
    )
    .withCompetentAuthorities(InstanceSnapshotTestBuilder.COMPETENT_AUTHORITIES)
    .withExecutingAuthorityLevels(
      InstanceSnapshotTestBuilder.EXECUTING_AUTHORITY_LEVELS,
    )
    ...
    .withYourEuropeCategories(
      InstanceSnapshotTestBuilder.YOUR_EUROPE_CATEGORIES,
    )
...
export class InstanceSnapshotTestBuilder {
  ...
  public withIsVersionOfInstance(
