...
describe("forConcept", () => {
  test("Undefined id throws error", () => {
    ...
    expect(() => Procedure.forConcept(procedure.build())).toThrowWithMessage(
      InvariantError,
  ...
  test("Invalid iri id throws error", () => {
    expect(() =>
      Procedure.forConcept(aFullProcedure().withId(new Iri("   ")).build()),
  ...
  test("Undefined description throws error", () => {
    ...
    expect(() => Procedure.forConcept(procedure.build())).toThrowWithMessage(
      InvariantError,
      "description mag niet ontbreken",
    );
  });
    ...
    test("websites that dont have unique order throws error", () => {
      ...
      expect(() =>
        Procedure.forConcept(
          aFullProcedure().withWebsites([website1, website2]).build(),
        ),
      ).toThrowWithMessage(
        InvariantError,
  ...
  test("Undefined order throws error", () => {
    expect(() =>
      Procedure.forConcept(aFullProcedure().withOrder(undefined).build()),
...
describe("forConceptSnapshot", () => {
  test("Undefined id throws error", () => {
    const procedure = aFullProcedure().withId(undefined);
    expect(() =>
      Procedure.forConceptSnapshot(procedure.build()),
    ).toThrowWithMessage(InvariantError, "id mag niet ontbreken");
  });

  test("Invalid iri id throws error", () => {
    expect(() =>
      Procedure.forConceptSnapshot(
        aFullProcedure().withId(new Iri("   ")).build(),
      ),
    ).toThrowWithMessage(InvariantError, "iri mag niet leeg zijn");
  });
  ...
  test("Undefined title throws error", () => {
    ...
    expect(() => Procedure.forConceptSnapshot(procedure)).toThrowWithMessage(
      InvariantError,
      "title mag niet ontbreken",
    );
  });
  ...
  test("Undefined order throws error", () => {
    expect(() =>
      Procedure.forConceptSnapshot(
        aFullProcedure().withOrder(undefined).build(),
      ),
    ).toThrowWithMessage(InvariantError, "order mag niet ontbreken");
  });
});
...
describe("for instance", () => {
  ...
  test("Undefined id throws error", () => {
    ...
    expect(() => Procedure.forInstance(procedure.build())).toThrowWithMessage(
      InvariantError,
      "id mag niet ontbreken",
    );
  });
  ...
  test("Undefined Uuid throws error", () => {
    ...
    expect(() => Procedure.forInstance(procedure).uuid).toThrowWithMessage(
      InvariantError,
      "uuid mag niet ontbreken",
    );
  });
  ...
  test("If title and description have the same nl language procedure is created", () => {
    ...
    const procedure = aFullProcedureForInstance()
  ...
  test("If title and description have different nl languages, throws error", () => {
    ...
    expect(() => Procedure.forInstance(procedure)).toThrowWithMessage(
      InvariantError,
  ...
  test("If title description and all websites have the same nl language procedure is created", () => {
    ...
    const website = aFullWebsiteForInstance()
      .withTitle(LanguageString.of(undefined, "nl-formal-website1"))
      .withOrder(1)
      .build();
    const anotherWebsite = aFullWebsiteForInstance()
      .withTitle(LanguageString.of(undefined, "nl-formal-website2"))
      .withOrder(2)
      .build();
    ...
    const procedure = aFullProcedureForInstance()
      .withTitle(langString)
      .withDescription(langString)
      .withWebsites([website, anotherWebsite])
      .build();
    expect(() => Procedure.forInstance(procedure)).not.toThrow();
  });
  ...
  test("If a website has a different nl language than title or description, throws error", () => {
    ...
    const website = aFullWebsiteForInstance()
      ...
      .build();
    const procedure = aFullProcedureForInstance()
      .withDescription(languageString)
      .withTitle(languageString)
  ...
  test("Undefined order throws error", () => {
    expect(() =>
      Procedure.forInstance(
        aFullProcedureForInstance().withOrder(undefined).build(),
      ),
    ).toThrowWithMessage(InvariantError, "order mag niet ontbreken");
  });
});
...
describe("for instance snapshot", () => {
  ...
  test("Undefined id throws error", () => {
    ...
    expect(() =>
      Procedure.forInstanceSnapshot(procedure.build()),
    ).toThrowWithMessage(InvariantError, "id mag niet ontbreken");
  });

  test("Undefined Uuid does not throw error", () => {
    const procedure = aFullProcedureForInstanceSnapshot()
      .withUuid(undefined)
      .build();
  ...
  test("Undefined description throws error", () => {
    const procedure =
      aFullProcedureForInstanceSnapshot().withDescription(undefined);
    expect(() =>
      Procedure.forInstanceSnapshot(procedure.build()),
  ...
  test("If title and description have different nl languages, throws error", () => {
    ...
    expect(() => Procedure.forInstanceSnapshot(procedure)).toThrowWithMessage(
      InvariantError,
      "Er is meer dan een nl-taal aanwezig",
    );
  });
  ...
  test("If a website has a different nl language than title or description, throws error", () => {
    ...
    const website = aFullWebsiteForInstance()
      .withTitle(anotherLanguageString)
      .withDescription(anotherLanguageString)
      .build();
    const procedure = aFullProcedureForInstanceSnapshot()
      .withDescription(languageString)
      .withTitle(languageString)
  ...
  test("websites that dont have unique order throws error", () => {
    const website1 = aMinimalWebsiteForInstanceSnapshot().withOrder(1).build();
    const website2 = aMinimalWebsiteForInstanceSnapshot().withOrder(1).build();

    expect(() =>
      Procedure.forInstanceSnapshot(
        aMinimalProcedureForInstanceSnapshot()
          .withWebsites([website1, website2])
          .build(),
      ),
  ...
  test("websites that have unique orderorder does not throw error", () => {
    const website1 = aMinimalWebsiteForInstanceSnapshot().withOrder(1).build();
    const website2 = aMinimalWebsiteForInstanceSnapshot().withOrder(2).build();
  ...
  test("Undefined order throws error", () => {
    expect(() =>
      Procedure.forInstanceSnapshot(
        aFullProcedureForInstanceSnapshot().withOrder(undefined).build(),
      ),
    ).toThrowWithMessage(InvariantError, "order mag niet ontbreken");
  });
});
...
describe("transformLanguage", () => {
  test("should transform procedure with title, description and website", () => {
    ...
    const transformedProcedure = procedure.transformLanguage(
      Language.FORMAL,
      Language.INFORMAL,
    );
      ...
      ProcedureBuilder.from(procedure)
        ...
        .withWebsites([
          WebsiteBuilder.from(procedure.websites[0])
            .withTitle(
              LanguageString.ofValueInLanguage(
                procedure.websites[0].title.getLanguageValue(Language.FORMAL),
                Language.INFORMAL,
              ),
            )
            .withDescription(
              LanguageString.ofValueInLanguage(
                procedure.websites[0].description.getLanguageValue(
                  Language.FORMAL,
                ),
                Language.INFORMAL,
              ),
          ...
          WebsiteBuilder.from(procedure.websites[1])
            .withTitle(
              LanguageString.ofValueInLanguage(
                procedure.websites[1].title.getLanguageValue(Language.FORMAL),
                Language.INFORMAL,
              ),
            )
            .withDescription(
              LanguageString.ofValueInLanguage(
                procedure.websites[1].description.getLanguageValue(
                  Language.FORMAL,
                ),
                Language.INFORMAL,
              ),
  ...
  test("should transform procedure with title, description to informal", () => {
    ...
    expect(
      procedure.transformLanguage(Language.FORMAL, Language.INFORMAL),
    ).toEqual(procedure);
  });
});
