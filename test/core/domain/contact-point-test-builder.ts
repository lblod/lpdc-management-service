...
export function aMinimalContactPointForInstanceSnapshot(): ContactPointBuilder {
  return aMinimalContactPointForInstance().withUuid(undefined);
}
...
export class ContactPointTestBuilder {
  ...
  public static readonly ADDRESS_FOR_INSTANCE =
    aFullAddressForInstance().build();
  public static readonly ANOTHER_ADDRESS_FOR_INSTANCE =
    anotherFullAddressForInstance().build();
  public static readonly ADDRESS_FOR_INSTANCE_SNAPSHOT =
    aFullAddressForInstanceSnapshot().build();
  public static readonly ANOTHER_ADDRESS_FOR_INSTANCE_SNAPSHOT =
    anotherFullAddressForInstanceSnapshot().build();
