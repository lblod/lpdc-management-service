...
describe("forConcept", () => {
  test("Undefined id throws error", () => {
    ...
    expect(() => Cost.forConcept(cost.build())).toThrowWithMessage(
      InvariantError,
  ...
  test("Invalid iri id throws error", () => {
    expect(() =>
      Cost.forConcept(aFullCost().withId(new Iri("   ")).build()),
...
describe("forReconstituted", () => {
  test("Undefined order throws error", () => {
    expect(() => aFullCost().withOrder(undefined).build()).toThrowWithMessage(
      InvariantError,
      "order mag niet ontbreken",
    );
  });
...
describe("forConceptSnapshot", () => {
  test("Undefined id throws error", () => {
    const cost = aFullCost().withId(undefined);
    expect(() => Cost.forConceptSnapshot(cost.build())).toThrowWithMessage(
      InvariantError,
      "id mag niet ontbreken",
    );
  });
  ...
  test("Undefined title throws error", () => {
    ...
    expect(() => Cost.forConceptSnapshot(cost)).toThrowWithMessage(
      InvariantError,
      "title mag niet ontbreken",
    );
  });
  ...
  test("Undefined order throws error", () => {
    expect(() =>
      Cost.forConceptSnapshot(aFullCost().withOrder(undefined).build()),
...
describe("for instance", () => {
  ...
  test("Undefined id throws error", () => {
    ...
    expect(() => Cost.forInstance(cost.build())).toThrowWithMessage(
      InvariantError,
      "id mag niet ontbreken",
    );
  });
  ...
  test("Undefined Uuid throws error", () => {
    ...
    expect(() => Cost.forInstance(cost).uuid).toThrowWithMessage(
      InvariantError,
      "uuid mag niet ontbreken",
    );
  });
  ...
  test("If title and description have different nl languages, throws error", () => {
    ...
    expect(() => Cost.forInstance(cost)).toThrowWithMessage(
      InvariantError,
  ...
  test("Undefined order throws error", () => {
    expect(
      () =>
        Cost.forInstance(aFullCostForInstance().withOrder(undefined).build())
          .uuid,
    ).toThrowWithMessage(InvariantError, "order mag niet ontbreken");
  });
});
...
describe("for instance snapshot", () => {
  ...
  test("Undefined id throws error", () => {
    ...
    expect(() => Cost.forInstanceSnapshot(cost.build())).toThrowWithMessage(
      InvariantError,
      "id mag niet ontbreken",
    );
  });
  ...
  test("If title and description have the same nl language cost is created", () => {
    const langString = LanguageString.of("nl");
    const cost = aFullCostForInstanceSnapshot()
      .withTitle(langString)
      .withDescription(langString)
      .build();
  ...
  test("If title and description have different nl languages, throws error", () => {
    ...
    expect(() => Cost.forInstanceSnapshot(cost)).toThrowWithMessage(
      InvariantError,
      "Er is meer dan een nl-taal aanwezig",
    );
  });
  ...
  test("Undefined order throws error", () => {
    expect(() =>
      Cost.forInstanceSnapshot(
        aFullCostForInstanceSnapshot().withOrder(undefined).build(),
      ),
    ).toThrowWithMessage(InvariantError, "order mag niet ontbreken");
  });
});
...
describe("transformLanguage", () => {
  test("should transform cost with title, description", () => {
    ...
    expect(cost.transformLanguage(Language.FORMAL, Language.INFORMAL)).toEqual(
