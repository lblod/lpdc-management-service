...
export function aFullCostForInstance(): CostBuilder {
  return new CostBuilder()
    .withId(CostBuilder.buildIri(uuid()))
    .withUuid(uuid())
    .withTitle(LanguageString.of(undefined, CostTestBuilder.TITLE_NL_FORMAL))
    .withDescription(
      LanguageString.of(undefined, CostTestBuilder.DESCRIPTION_NL_FORMAL),
    )
    .withOrder(1);
}
...
export function anotherFullCostForInstance(): CostBuilder {
  return new CostBuilder()
    ...
    .withUuid(uuid())
    .withTitle(
      LanguageString.of(undefined, CostTestBuilder.ANOTHER_TITLE_NL_FORMAL),
    )
    .withDescription(
      LanguageString.of(
        undefined,
...
export class CostTestBuilder {
  ...
  public static readonly TITLE_NL_GENERATED_FORMAL =
    "Cost Title - nl-generated-formal";
  public static readonly TITLE_NL_GENERATED_INFORMAL =
    "Cost Title - nl-generated-informal";
