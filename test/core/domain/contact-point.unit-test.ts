...
describe("constructing", () => {
  describe("forInstance", () => {
    test("Undefined id throws error", () => {
      expect(() =>
        ContactPoint.forInstance(
          aFullContactPointForInstance().withId(undefined).build(),
        ),
    ...
    test("Invalid iri id throws error", () => {
      expect(() =>
        ContactPoint.forInstance(
          aFullContactPointForInstance().withId(new Iri("  ")).build(),
        ),
    ...
    test("Undefined uuid throws error", () => {
      expect(() =>
        ContactPoint.forInstance(
          aFullContactPointForInstance().withUuid(undefined).build(),
        ),
    ...
    test("Blank uuid throws error", () => {
      expect(() =>
        ContactPoint.forInstance(
          aFullContactPointForInstance().withUuid("   ").build(),
        ),
    ...
    test("Blank order throws error", () => {
      expect(() =>
        ContactPoint.forInstance(
          aFullContactPointForInstance().withOrder(undefined).build(),
        ),
    ...
    describe("address ", () => {
      test("valid address does not throw error", () => {
        ...
        const contactPoint =
          aFullContactPointForInstance().withAddress(validAddress);
        expect(() =>
          ContactPoint.forInstance(contactPoint.build()),
        ).not.toThrow();
      });
        ...
        expect(() =>
          ContactPoint.forInstance(
            aFullContactPointForInstance()
              .withAddress(invalidAddress.build())
              .build(),
          ),
        ).toThrow();
      });
  ...
  describe("forInstanceSnapshot", () => {
    test("Undefined id throws error", () => {
      expect(() =>
        ContactPoint.forInstanceSnapshot(
          aFullContactPointForInstance().withId(undefined).build(),
        ),
      ).toThrowWithMessage(InvariantError, "id mag niet ontbreken");
    });
    ...
    describe("address ", () => {
      test("valid address does not throw error", () => {
        ...
        const contactPoint =
          aFullContactPointForInstance().withAddress(validAddress);
        expect(() =>
          ContactPoint.forInstanceSnapshot(contactPoint.build()),
        ).not.toThrow();
      });
  ...
  test("copies in builder", () => {
    ...
    expect(ContactPointBuilder.from(aContactPoint).build()).toEqual(
      aContactPoint,
    );
  });
});
