...
import {
  aMinimalInformalLanguageString,
...
import {
  aMinimalContactPointForInstanceSnapshot,
...
describe("constructing", () => {
  test("undefined id throws error", () => {
    expect(() =>
      aFullPublishedInstanceSnapshot().withId(undefined).build(),
  ...
  describe("generatedAtTime", () => {
    test("Undefined generatedAtTime throws error", () => {
      expect(() =>
        aFullPublishedInstanceSnapshot().withGeneratedAtTime(undefined).build(),
      ).toThrowWithMessage(
        InvariantError,
    ...
    test("Blank generatedAtTime throws error", () => {
      expect(() =>
        aFullPublishedInstanceSnapshot()
  ...
  test("undefined isPublishedVersionOf throws error", () => {
    expect(() =>
      aFullPublishedInstanceSnapshot()
        .withIsPublishedVersionOf(undefined)
        .build(),
    ).toThrowWithMessage(
      InvariantError,
      "isPublishedVersionOf mag niet ontbreken",
    );
  });

  test("undefined createdBy throws error", () => {
    expect(() =>
      aFullPublishedInstanceSnapshot().withCreatedBy(undefined).build(),
    ).toThrowWithMessage(InvariantError, "createdBy mag niet ontbreken");
  });

  test("undefined title throws error", () => {
    expect(() =>
      aFullPublishedInstanceSnapshot().withTitle(undefined).build(),
    ).toThrowWithMessage(InvariantError, "title mag niet ontbreken");
  });

  test("Undefined description throws error", () => {
    expect(() =>
      aFullPublishedInstanceSnapshot().withDescription(undefined).build(),
  ...
  test("Themes with duplicates throws error", () => {
    expect(() =>
      aFullPublishedInstanceSnapshot()
        .withThemes([ThemeType.WELZIJNGEZONDHEID, ThemeType.WELZIJNGEZONDHEID])
        .build(),
  ...
  test("CompetentAuthorities with not at least one value throws error", () => {
    expect(() =>
      aFullPublishedInstanceSnapshot().withCompetentAuthorities([]).build(),
    ).toThrowWithMessage(
      InvariantError,
      "competentAuthorities moet minstens een waarde bevatten",
    );
  });
  ...
  test("YourEuropeCategories with not at least one value throws error when publicationMedia includes yourEurope", () => {
    expect(() =>
      ...
      InvariantError,
      "yourEuropeCategories moet minstens een waarde bevatten",
    );
  });
  ...
  test("keywords with other nl language throws error", () => {
    const publishedInstanceSnapshotTestBuilder =
      aFullPublishedInstanceSnapshot().withKeywords([
        LanguageString.of(undefined, "overlijden"),
        LanguageString.of(undefined, "geboorte"),
      ]);
    expect(() =>
      publishedInstanceSnapshotTestBuilder.build(),
  ...
  test("languages with duplicates throws error", () => {
    expect(() =>
      aFullPublishedInstanceSnapshot()
        .withLanguages([LanguageType.ENG, LanguageType.ENG])
        .build(),
    ).toThrowWithMessage(
      InvariantError,
  ...
  describe("dateCreated", () => {
    test("Undefined dateCreated throws error", () => {
      expect(() =>
        aFullPublishedInstanceSnapshot().withDateCreated(undefined).build(),
  ...
  describe("dateModified", () => {
    test("Undefined dateModified throws error", () => {
      expect(() =>
        aFullPublishedInstanceSnapshot().withDateModified(undefined).build(),
  ...
  describe("requirement", () => {
    test("valid requirement does not throw error", () => {
      ...
      expect(() =>
        aFullPublishedInstanceSnapshot()
          .withRequirements([validRequirement])
          .build(),
      ).not.toThrow();
    });
    ...
    test("invalid requirement does throw error", () => {
      ...
      expect(() =>
        aFullPublishedInstanceSnapshot()
          .withRequirements([invalidRequirement])
          .build(),
      ).toThrow();
    });

    test("requirements that dont have unique order throws error", () => {
      const requirement1 = aMinimalRequirementForInstanceSnapshot()
        .withOrder(1)
        .build();
      const requirement2 = aMinimalRequirementForInstanceSnapshot()
        .withOrder(1)
        .build();
    ...
    describe("evidence ", () => {
      test("valid evidence does not throw error", () => {
        ...
        const validRequirement = aFullRequirementForInstanceSnapshot()
      ...
      test("invalid evidence does throw error", () => {
        ...
        const invalidRequirement = aFullRequirementForInstanceSnapshot()
  ...
  describe("procedure", () => {
    ...
    test("invalid procedure does throw error", () => {
      ...
      expect(() =>
        aFullPublishedInstanceSnapshot()
          .withProcedures([invalidProcedure])
          .build(),
      ).toThrow();
    });

    test("procedures that dont have unique order throws error", () => {
      const procedure1 = aMinimalProcedureForInstanceSnapshot()
        .withOrder(1)
        .build();
      const procedure2 = aMinimalProcedureForInstanceSnapshot()
        .withOrder(1)
        .build();

      expect(() =>
        aFullPublishedInstanceSnapshot()
          .withProcedures([procedure1, procedure2])
          .build(),
      ).toThrowWithMessage(
        InvariantError,
  ...
  describe("website ", () => {
    test("valid website does not throw error", () => {
      ...
      expect(() =>
        aFullPublishedInstanceSnapshot().withWebsites([validWebsite]).build(),
      ).not.toThrow();
    });
    ...
    test("invalid website does throw error", () => {
      ...
      expect(() =>
        aFullPublishedInstanceSnapshot().withWebsites([invalidWebsite]).build(),
      ).toThrow();
    });

    test("websites that dont have unique order throws error", () => {
      const website1 = aMinimalWebsiteForInstanceSnapshot()
        .withOrder(1)
        .build();
      const website2 = aMinimalWebsiteForInstanceSnapshot()
        .withOrder(1)
        .build();

      expect(() =>
        aFullPublishedInstanceSnapshot()
          .withWebsites([website1, website2])
          .build(),
      ).toThrowWithMessage(
        InvariantError,
  ...
  describe("cost ", () => {
    test("valid cost does not throw error", () => {
      ...
      expect(() =>
        aFullPublishedInstanceSnapshot().withCosts([validCost]).build(),
      ).not.toThrow();
    });
    ...
    test("invalid cost does throw error", () => {
      ...
      expect(() =>
        aFullPublishedInstanceSnapshot().withCosts([invalidCost]).build(),
      ).toThrow();
    });

    test("costs that dont have unique order throws error", () => {
      const cost1 = aMinimalCostForInstanceSnapshot().withOrder(1).build();
      const cost2 = aMinimalCostForInstanceSnapshot().withOrder(1).build();

      expect(() =>
        aFullPublishedInstanceSnapshot().withCosts([cost1, cost2]).build(),
      ).toThrowWithMessage(
        InvariantError,
    ...
    test("costs that have unique order does not throw error", () => {
      const cost1 = aMinimalCostForInstanceSnapshot().withOrder(1).build();
      const cost2 = aMinimalCostForInstanceSnapshot().withOrder(2).build();
  ...
  describe("contact points ", () => {
    ...
    test("contact points that dont have unique order throws error", () => {
      const contactPoint1 = aMinimalContactPointForInstanceSnapshot()
        .withOrder(1)
        .build();
      const contactPoint2 = aMinimalContactPointForInstanceSnapshot()
        .withOrder(1)
        .build();
  ...
  describe("legalResources", () => {
    test("valid legalResource does not throw error", () => {
      ...
      expect(() =>
        aFullPublishedInstanceSnapshot()
          .withLegalResources([validLegalResource])
          .build(),
      ).not.toThrow();
    });
    ...
    test("legalResources that dont have unique order throws error", () => {
      const legalResource1 = aFullLegalResourceForInstanceSnapshot()
        .withOrder(1)
        .build();
      const legalResource2 = aFullLegalResourceForInstanceSnapshot()
        .withOrder(1)
        .build();
...
describe("builder", () => {
  test("from instance without sent date throws error", () => {
    expect(() =>
      PublishedInstanceSnapshotBuilder.from(
        aFullInstance().withDateSent(undefined).build(),
      ),
  ...
  test("from instance, copies all fields and generates new ids", () => {
    ...
    expect(publishedInstanceSnapshot.generatedAtTime).toEqual(
      instance.dateSent,
    );
    ...
    expect(publishedInstanceSnapshot.additionalDescription).toEqual(
    ...
    expect(publishedInstanceSnapshot.targetAudiences).toEqual(
      instance.targetAudiences,
    );
    expect(publishedInstanceSnapshot.themes).toEqual(instance.themes);
    expect(publishedInstanceSnapshot.competentAuthorityLevels).toEqual(
      instance.competentAuthorityLevels,
    );
    expect(publishedInstanceSnapshot.competentAuthorities).toEqual(
      instance.competentAuthorities,
    );
    expect(publishedInstanceSnapshot.executingAuthorityLevels).toEqual(
      instance.executingAuthorityLevels,
    );
    expect(publishedInstanceSnapshot.executingAuthorities).toEqual(
      instance.executingAuthorities,
    );
    expect(publishedInstanceSnapshot.executingAuthorityLevels).toEqual(
      instance.executingAuthorityLevels,
    );
    expect(publishedInstanceSnapshot.publicationMedia).toEqual(
      instance.publicationMedia,
    );
    expect(publishedInstanceSnapshot.yourEuropeCategories).toEqual(
      instance.yourEuropeCategories,
    );
    expect(publishedInstanceSnapshot.keywords).toEqual(instance.keywords);
    expect(publishedInstanceSnapshot.requirements).toEqual(
    ...
    expect(publishedInstanceSnapshot.procedures).toEqual(
      expect.arrayContaining([
        expect.objectContaining({
    ...
    expect(publishedInstanceSnapshot.websites).toEqual(
      expect.arrayContaining([
        expect.objectContaining({
    ...
    expect(publishedInstanceSnapshot.costs).toEqual(
      expect.arrayContaining([
        expect.objectContaining({
    ...
    expect(publishedInstanceSnapshot.financialAdvantages).toEqual(
      expect.arrayContaining([
        expect.objectContaining({
    ...
    expect(publishedInstanceSnapshot.contactPoints).toEqual(
      expect.arrayContaining([
        expect.objectContaining({
    ...
    expect(publishedInstanceSnapshot.dateModified).toEqual(
      instance.dateModified,
    );
    expect(publishedInstanceSnapshot.spatials).toEqual(instance.spatials);
    expect(publishedInstanceSnapshot.legalResources).toEqual(
      expect.arrayContaining([
        expect.objectContaining({
