...
import {
  aMinimalFinancialAdvantageForConcept,
...
describe("constructing", () => {
  ...
  test("defined languages", () => {
    ...
    expect(aConcept.definedLanguages).toEqual([
      Language.NL,
      Language.FORMAL,
      Language.INFORMAL,
  ...
  test("applied concept snapshots", () => {
    ...
    const aConcept = aFullConcept()
      ...
      .withPreviousConceptSnapshots([
        previousConceptSnapshot1,
        previousConceptSnapshot2,
      ])
      .build();

    expect(aConcept.appliedConceptSnapshots).toEqual([
  ...
  test("Undefined id throws error", () => {
    expect(() => aFullConcept().withId(undefined).build()).toThrowWithMessage(
      InvariantError,
  ...
  test("Invalid iri id throws error", () => {
    expect(() =>
      aFullConcept().withId(new Iri("  ")).build(),
    ).toThrowWithMessage(InvariantError, "iri mag niet leeg zijn");
  });

  test("Undefined uuid throws error", () => {
    expect(() => aFullConcept().withUuid(undefined).build()).toThrowWithMessage(
      InvariantError,
      "uuid mag niet ontbreken",
    );
  });

  test("Blank uuid throws error", () => {
    expect(() => aFullConcept().withUuid("   ").build()).toThrowWithMessage(
      InvariantError,
  ...
  test("Undefined LatestFunctionallyChangedConceptSnapshot throws error", () => {
    expect(() =>
      aFullConcept()
        .withLatestFunctionallyChangedConceptSnapshot(undefined)
        .build(),
    ).toThrowWithMessage(
      InvariantError,
      "latestFunctionallyChangedConceptSnapshot mag niet ontbreken",
    );
  });
  ...
  test("invalid Iri LatestFunctionallyChangedConceptSnapshot throws error", () => {
    expect(() =>
      aFullConcept()
        .withLatestFunctionallyChangedConceptSnapshot(new Iri("   "))
        .build(),
    ).toThrowWithMessage(InvariantError, "iri mag niet leeg zijn");
  });

  test("TargetAudience with duplicates throws error", () => {
    const conceptTestBuilder = aFullConcept().withTargetAudiences([
  ...
  test("Themes with duplicates throws error", () => {
    const conceptTestBuilder = aFullConcept().withThemes([
  ...
  test("CompetentAuthorityLevels with duplicates throws error", () => {
    const conceptTestBuilder = aFullConcept().withCompetentAuthorityLevels([
  ...
  test("CompetentAuthorities with duplicates throws error", () => {
    const conceptTestBuilder = aFullConcept().withCompetentAuthorities([
  ...
  test("ExecutingAuthorityLevels with duplicates throws error", () => {
    const conceptTestBuilder = aFullConcept().withExecutingAuthorityLevels([
  ...
  test("ExecutingAuthorities with duplicates throws error", () => {
    const conceptTestBuilder = aFullConcept().withExecutingAuthorities([
      BestuurseenheidTestBuilder.PEPINGEN_IRI,
      BestuurseenheidTestBuilder.PEPINGEN_IRI,
    ]);
    expect(() => conceptTestBuilder.build()).toThrowWithMessage(
  ...
  test("PublicationMedia with duplicates throws error", () => {
    const conceptTestBuilder = aFullConcept().withPublicationMedia([
  ...
  test("YourEuropeCategories with duplicates throws error", () => {
    const conceptTestBuilder = aFullConcept().withYourEuropeCategories([
  ...
  test("keywords with duplicates throws error", () => {
    const conceptTestBuilder = aFullConcept().withKeywords([
  ...
  test("previousConceptSnapshots with duplicates throws error", () => {
    const iri = uuid();
    const conceptTestBuilder = aFullConcept().withPreviousConceptSnapshots([
      buildConceptSnapshotIri(iri),
      buildConceptSnapshotIri(iri),
    ]);
    expect(() => conceptTestBuilder.build()).toThrowWithMessage(
      InvariantError,
      "previousConceptSnapshots mag geen duplicaten bevatten",
    );
  });

  test("conceptTags with duplicates throws error", () => {
    const conceptTestBuilder = aFullConcept().withConceptTags([
  ...
  describe("cost ", () => {
    ...
    test("costs that dont have unique order throws error", () => {
      const cost1 = aMinimalCostForConcept().withOrder(1).build();
      const cost2 = aMinimalCostForConcept().withOrder(1).build();

      expect(() =>
        aFullConcept().withCosts([cost1, cost2]).build(),
      ).toThrowWithMessage(
        InvariantError,
    ...
    test("costs that have unique order does not throw error", () => {
      const cost1 = aMinimalCostForConcept().withOrder(1).build();
      const cost2 = aMinimalCostForConcept().withOrder(2).build();
  ...
  describe("financialAdvantage ", () => {
    ...
    test("financial advantages that dont have unique order throws error", () => {
      const financialAdvantage1 = aMinimalFinancialAdvantageForConcept()
        .withOrder(1)
        .build();
      const financialAdvantage2 = aMinimalFinancialAdvantageForConcept()
        .withOrder(1)
        .build();
  ...
  describe("procedure ", () => {
    test("valid procedure for concept does not throw error", () => {
      ...
      expect(() =>
        aFullConcept().withProcedures([validProcedure]).build(),
      ).not.toThrow();
    });
    ...
    test("invalid procedure for concept does throw error", () => {
      ...
      expect(() =>
        aFullConcept().withProcedures([invalidProcedure]).build(),
      ).toThrow();
    });

    test("procedures that dont have unique order throws error", () => {
      const procedure1 = aMinimalProcedureForConcept().withOrder(1).build();
      const procedure2 = aMinimalProcedureForConcept().withOrder(1).build();

      expect(() =>
        aFullConcept().withProcedures([procedure1, procedure2]).build(),
      ).toThrowWithMessage(
        InvariantError,
    ...
    test("procedures that have unique order does not throw error", () => {
      const procedure1 = aMinimalProcedureForConcept().withOrder(1).build();
      const procedure2 = aMinimalProcedureForConcept().withOrder(2).build();
  ...
  describe("website ", () => {
    test("valid website does not throw error", () => {
      ...
      expect(() =>
        aFullConcept().withWebsites([validWebsite]).build(),
      ).not.toThrow();
    });
    ...
    test("invalid website does throw error", () => {
      ...
      expect(() =>
        aFullConcept().withWebsites([invalidWebsite]).build(),
      ).toThrow();
    });

    test("websites that dont have unique order throws error", () => {
      const website1 = aMinimalWebsiteForConcept().withOrder(1).build();
      const website2 = aMinimalWebsiteForConcept().withOrder(1).build();

      expect(() =>
        aFullConcept().withWebsites([website1, website2]).build(),
      ).toThrowWithMessage(
        InvariantError,
    ...
    test("websites that have unique order does not throw error", () => {
      const website1 = aMinimalWebsiteForConcept().withOrder(1).build();
      const website2 = aMinimalWebsiteForConcept().withOrder(2).build();
  ...
  describe("requirement ", () => {
    test("valid requirement does not throw error", () => {
      ...
      expect(() =>
        aFullConcept().withRequirements([validRequirement]).build(),
      ).not.toThrow();
    });
    ...
    test("invalid requirement does throw error", () => {
      ...
      expect(() =>
        aFullConcept().withRequirements([invalidRequirement]).build(),
      ).toThrow();
    });

    test("requirements that dont have unique order throws error", () => {
      const requirement1 = aMinimalRequirementForConcept().withOrder(1).build();
      const requirement2 = aMinimalRequirementForConcept().withOrder(1).build();

      expect(() =>
        aFullConcept().withRequirements([requirement1, requirement2]).build(),
      ).toThrowWithMessage(
        InvariantError,
    ...
    test("requirements that have unique order does not throw error", () => {
      const requirement1 = aMinimalRequirementForConcept().withOrder(1).build();
      const requirement2 = aMinimalRequirementForConcept().withOrder(2).build();
  ...
  describe("legalResources", () => {
    test("valid legalResource does not throw error", () => {
      ...
      expect(() =>
        aFullConcept().withLegalResources([validLegalResource]).build(),
      ).not.toThrow();
    });
    ...
    test("invalid legalResource does throw error", () => {
      ...
      expect(() =>
        aFullConcept().withLegalResources([invalidLegalResource]).build(),
      ).toThrow();
    });
