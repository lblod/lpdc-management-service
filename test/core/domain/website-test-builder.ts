  ...
  return new WebsiteBuilder()
    ...
    .withDescription(
      LanguageString.of(
        ...
        WebsiteTestBuilder.ANOTHER_DESCRIPTION_TEMPLATE_NL_GENERATED_FORMAL(
          aUuid,
        ),
        WebsiteTestBuilder.ANOTHER_DESCRIPTION_TEMPLATE_NL_GENERATED_INFORMAL(
          aUuid,
        ),
      ),
    )
...
export function aFullWebsiteForInstance(): WebsiteBuilder {
  ...
  return new WebsiteBuilder()
    .withId(WebsiteBuilder.buildIri(uniqueId))
    .withUuid(uniqueId)
    .withTitle(LanguageString.of(undefined, WebsiteTestBuilder.TITLE_NL_FORMAL))
    .withDescription(
      LanguageString.of(undefined, WebsiteTestBuilder.DESCRIPTION_NL_FORMAL),
    )
    .withOrder(1)
    .withUrl(WebsiteTestBuilder.URL);
}
...
export function anotherFullWebsiteForInstanceSnapshot(
  aUuid: string,
): WebsiteBuilder {
  const uniqueId = uuid();
  return new WebsiteBuilder()
...
export class WebsiteTestBuilder {
  ...
  public static readonly TITLE_NL_GENERATED_FORMAL =
    "Website Title - nl-generated-formal";
  public static readonly TITLE_NL_GENERATED_INFORMAL =
    "Website Title - nl-generated-informal";
