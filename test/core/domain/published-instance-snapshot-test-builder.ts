...
export function aFullPublishedInstanceSnapshot(): PublishedInstanceSnapshotTestBuilder {
    ...
    return new PublishedInstanceSnapshotTestBuilder()
        ...
        .withCompetentAuthorityLevels(PublishedInstanceSnapshotTestBuilder.COMPETENT_AUTHORITY_LEVELS)
        .withCompetentAuthorities(PublishedInstanceSnapshotTestBuilder.COMPETENT_AUTHORITIES)
        .withExecutingAuthorityLevels(PublishedInstanceSnapshotTestBuilder.EXECUTING_AUTHORITY_LEVELS)
        .withExecutingAuthorities(PublishedInstanceSnapshotTestBuilder.EXECUTING_AUTHORITIES)
        .withPublicationMedia(PublishedInstanceSnapshotTestBuilder.PUBLICATION_MEDIA)
        .withYourEuropeCategories(PublishedInstanceSnapshotTestBuilder.YOUR_EUROPE_CATEGORIES)
        ...
        .withFinancialAdvantages(PublishedInstanceSnapshotTestBuilder.FINANCIAL_ADVANTAGES)
...
export class PublishedInstanceSnapshotTestBuilder extends PublishedInstanceSnapshotBuilder {
    ...
    withGeneratedAtTime(generatedAtTime: FormatPreservingDate): PublishedInstanceSnapshotTestBuilder {
        this.generatedAtTime = generatedAtTime;
        return this;
    }

    withIsPublishedVersionOf(instanceId: Iri): PublishedInstanceSnapshotTestBuilder {
    ...
    withDescription(description: LanguageString): PublishedInstanceSnapshotTestBuilder {
        this.description = description;
        return this;
    }

    withAdditionalDescription(additionalDescription: LanguageString): PublishedInstanceSnapshotTestBuilder {
        this.additionalDescription = additionalDescription;
        return this;
    }

    withException(exception: LanguageString): PublishedInstanceSnapshotTestBuilder {
        this.exception = exception;
        return this;
    }

    withRegulation(regulation: LanguageString): PublishedInstanceSnapshotTestBuilder {
        this.regulation = regulation;
        return this;
    }

    withStartDate(startDate: FormatPreservingDate): PublishedInstanceSnapshotTestBuilder {
        this.startDate = startDate;
        return this;
    }

    withEndDate(endDate: FormatPreservingDate): PublishedInstanceSnapshotTestBuilder {
    ...
    withTargetAudiences(targetAudiences: TargetAudienceType[]): PublishedInstanceSnapshotTestBuilder {
    ...
    withCompetentAuthorityLevels(competentAuthorityLevels: CompetentAuthorityLevelType[]): PublishedInstanceSnapshotTestBuilder {
        this.competentAuthorityLevels = competentAuthorityLevels;
        return this;
    }

    withCompetentAuthorities(competentAuthorities: Iri[]): PublishedInstanceSnapshotTestBuilder {
        this.competentAuthorities = competentAuthorities;
        return this;
    }

    withExecutingAuthorityLevels(executingAuthorityLevels: ExecutingAuthorityLevelType[]): PublishedInstanceSnapshotTestBuilder {
        this.executingAuthorityLevels = executingAuthorityLevels;
        return this;
    }

    withExecutingAuthorities(executingAuthorities: Iri[]): PublishedInstanceSnapshotTestBuilder {
        this.executingAuthorities = executingAuthorities;
        return this;
    }

    withPublicationMedia(publicationMedia: PublicationMediumType[]): PublishedInstanceSnapshotTestBuilder {
        this.publicationMedia = publicationMedia;
        return this;
    }

    withYourEuropeCategories(yourEuropeCategories: YourEuropeCategoryType[]): PublishedInstanceSnapshotTestBuilder {
        this.yourEuropeCategories = yourEuropeCategories;
        return this;
    }

    withKeywords(keywords: LanguageString[]): PublishedInstanceSnapshotTestBuilder {
        this.keywords = keywords;
        return this;
    }

    withRequirements(requirements: Requirement[]): PublishedInstanceSnapshotTestBuilder {
        this.requirements = requirements;
        return this;
    }

    withProcedures(procedures: Procedure[]): PublishedInstanceSnapshotTestBuilder {
    ...
    withFinancialAdvantages(financialAdvantages: FinancialAdvantage[]): PublishedInstanceSnapshotTestBuilder {
        this.financialAdvantages = financialAdvantages;
        return this;
    }

    withContactPoints(contactPoinst: ContactPoint[]): PublishedInstanceSnapshotTestBuilder {
    ...
    withLanguages(languages: LanguageType[]): PublishedInstanceSnapshotTestBuilder {
        this.languages = languages;
        return this;
    }

    withDateCreated(dateCreated: FormatPreservingDate): PublishedInstanceSnapshotTestBuilder {
        this.dateCreated = dateCreated;
        return this;
    }

    withDateModified(dateModified: FormatPreservingDate): PublishedInstanceSnapshotTestBuilder {
    ...
    withLegalResources(legalResources: LegalResource[]): PublishedInstanceSnapshotTestBuilder {
