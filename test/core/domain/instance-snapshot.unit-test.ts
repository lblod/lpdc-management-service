...
describe("constructing", () => {
  ...
  test("CompetentAuthorities with not at least one value throws error", () => {
    expect(() =>
      aFullInstanceSnapshot().withCompetentAuthorities([]).build(),
    ).toThrowWithMessage(
      InvariantError,
  ...
  test("keywords with other nl language throws error", () => {
    const instanceSnapshotTestBuilder = aFullInstanceSnapshot().withKeywords([
      LanguageString.of(undefined, "overlijden"),
      LanguageString.of(undefined, "geboorte"),
    ]);
    expect(() => instanceSnapshotTestBuilder.build()).toThrowWithMessage(
      InvariantError,
  ...
  test("Undefined isVersionOf throws error", () => {
    expect(() =>
      aFullInstanceSnapshot().withIsVersionOfInstance(undefined).build(),
    ).toThrowWithMessage(InvariantError, "isVersionOf mag niet ontbreken");
  });

  describe("dateCreated", () => {
    test("Undefined dateCreated throws error", () => {
      expect(() =>
        aFullInstanceSnapshot().withDateCreated(undefined).build(),
  ...
  describe("dateModified", () => {
    test("Undefined dateModified throws error", () => {
      expect(() =>
        aFullInstanceSnapshot().withDateModified(undefined).build(),
  ...
  describe("generatedAtTime", () => {
    test("Undefined generatedAtTime throws error", () => {
      expect(() =>
        aFullInstanceSnapshot().withGeneratedAtTime(undefined).build(),
      ).toThrowWithMessage(
        InvariantError,
  ...
  test("Undefined isArchived throws error", () => {
    expect(() =>
      aFullInstanceSnapshot().withIsArchived(undefined).build(),
  ...
  test("Spatials with not at least one value throws error", () => {
    expect(() =>
      aFullInstanceSnapshot().withSpatials([]).build(),
    ).toThrowWithMessage(
      InvariantError,
      "spatials moet minstens een waarde bevatten",
    );
  });
  ...
  describe("requirement", () => {
    test("valid requirement does not throw error", () => {
      ...
      expect(() =>
        aFullInstanceSnapshot().withRequirements([validRequirement]).build(),
      ).not.toThrow();
    });
    ...
    test("invalid requirement does throw error", () => {
      ...
      expect(() =>
        aFullInstanceSnapshot().withRequirements([invalidRequirement]).build(),
      ).toThrow();
    });
  ...
  describe("procedure", () => {
    test("valid procedure does not throw error", () => {
      ...
      expect(() =>
        aFullInstanceSnapshot().withProcedures([validProcedure]).build(),
      ).not.toThrow();
    });
    ...
    test("invalid procedure does throw error", () => {
      ...
      expect(() =>
        aFullInstanceSnapshot().withProcedures([invalidProcedure]).build(),
      ).toThrow();
    });
  ...
  describe("website ", () => {
    test("valid website does not throw error", () => {
      ...
      expect(() =>
        aFullInstanceSnapshot().withWebsites([validWebsite]).build(),
      ).not.toThrow();
    });
    ...
    test("invalid website does throw error", () => {
      ...
      expect(() =>
        aFullInstanceSnapshot().withWebsites([invalidWebsite]).build(),
      ).toThrow();
    });
    ...
    test("websites that dont have unique order throws error", () => {
      ...
      expect(() =>
        aFullInstanceSnapshot().withWebsites([website1, website2]).build(),
      ).toThrowWithMessage(
        InvariantError,
  ...
  describe("cost ", () => {
    test("valid cost does not throw error", () => {
      ...
      expect(() =>
        aFullInstanceSnapshot().withCosts([validCost]).build(),
      ).not.toThrow();
    });
    ...
    test("invalid cost does throw error", () => {
      ...
      expect(() =>
        aFullInstanceSnapshot().withCosts([invalidCost]).build(),
      ).toThrow();
    });
    ...
    test("costs that dont have unique order throws error", () => {
      ...
      expect(() =>
        aFullInstanceSnapshot().withCosts([cost1, cost2]).build(),
      ).toThrowWithMessage(
        InvariantError,
  ...
  describe("contact points ", () => {
    test("valid contact point does not throw error", () => {
      ...
      expect(() =>
        aFullInstanceSnapshot().withContactPoints([validContactPoint]).build(),
      ).not.toThrow();
    });
...
describe("validateLanguages", () => {
  ...
  test("if values have different nl language strings, then throws error", () => {
    ...
    expect(() => instanceSnapshot.build()).toThrowWithMessage(
      InvariantError,
