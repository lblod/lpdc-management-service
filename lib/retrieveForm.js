...
export async function retrieveForm(publicServiceId, formId, muSessionId) {
  ...
  const tailoredSchemes = await generateRuntimeConceptSchemes(muSessionId);
 ...
 */
async function generateRuntimeConceptSchemes(muSessionId) {
