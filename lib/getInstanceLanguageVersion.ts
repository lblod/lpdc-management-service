...
export async function getLanguageVersionOfInstance(publicServiceId: string): Promise<string> {
...
async function getPublicServiceTriples(publicServiceUUID: string): Promise<any[]> {
