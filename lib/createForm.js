  ...
  const query=`
    INSERT DATA {
      GRAPH <http://mu.semte.ch/graphs/application> {
        ${publicServiceUri} <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://purl.org/vocab/cpsv#PublicService> .
        ${publicServiceUri} <http://purl.org/dc/terms/created> ${sparqlEscapeDateTime(now)} .
        ${publicServiceUri} <http://purl.org/dc/terms/modified> ${sparqlEscapeDateTime(now)} . 
        ${publicServiceUri} <http://mu.semte.ch/vocabularies/core/uuid> """${publicServiceId}""" .

        ${publicServiceUri} <http://lblod.data.gift/vocabularies/lpdc-ipdc/exception> """ """@nl .
        ${publicServiceUri} <http://www.w3.org/ns/dcat#keyword> """ """@nl .
        ${publicServiceUri} <http://purl.org/dc/terms/title> """ """@en .
        ${publicServiceUri} <http://purl.org/dc/terms/title> """ """@nl .
        ${publicServiceUri} <http://www.w3.org/ns/dcat#keyword> """ """@nl .
        ${publicServiceUri} <http://www.w3.org/ns/dcat#keyword> """ """@nl .
        ${publicServiceUri} <http://www.w3.org/ns/dcat#keyword> """ """@nl .
        ${publicServiceUri} <http://www.w3.org/ns/dcat#keyword> """ """@nl .
        ${publicServiceUri} <http://lblod.data.gift/vocabularies/lpdc-ipdc/exception> """ """@en .
        ${publicServiceUri} <http://www.w3.org/ns/dcat#keyword> """ """@nl .
        ${publicServiceUri} <http://www.w3.org/ns/dcat#keyword> """ """@nl .
        ${publicServiceUri} <http://www.w3.org/ns/dcat#keyword> """ """@nl .
        ${publicServiceUri} <http://purl.org/dc/terms/language> <http://publications.europa.eu/resource/authority/language/NLD> .
        ${publicServiceUri} <http://www.w3.org/ns/dcat#keyword> """ """@nl .
        ${publicServiceUri} <http://purl.org/dc/terms/description> """ """@en .
        ${publicServiceUri} <http://purl.org/dc/terms/description> """ """@nl .
        ${publicServiceUri} <http://purl.org/dc/terms/source> <http://data.lblod.info/id/public-services/a139c22b4691447ca9ab3409d380c95c> .

        ${publicServiceUri} <http://data.europa.eu/m8g/hasCost> <http://data.lblod.info/id/cost/${costId}> .
        ${publicServiceUri} <http://purl.org/vocab/cpsv#follows> <http://data.lblod.info/id/rule/${ruleId}> .
        ${publicServiceUri} <http://vocab.belgif.be/ns/publicservice#hasRequirement> <http://data.lblod.info/id/requirement/${requirementId}> .

        ${publicServiceUri} <http://data.europa.eu/m8g/hasCompetentAuthority> <http://data.lblod.info/id/concept/organisatie/e3b06565249fb4273d056f4e4e0c8cc7> .
        ${publicServiceUri} <http://lblod.data.gift/vocabularies/lpdc-ipdc/targetAudience> <http://data.lblod.info/id/concept/target-audience/00cedfbb-dd81-4691-8e69-e0170dc9bcb8> .
        ${publicServiceUri} <http://purl.org/dc/terms/spatial> <http://data.lblod.info/id/concept/plaats/05205ec41c6d82162e70447b9609695e> .
        ${publicServiceUri} <http://vocab.belgif.be/ns/publicservice#lifecycleStatus> <http://lblod.data.gift/concepts/79a52da4-f491-4e2f-9374-89a13cde8ecd> .
        ${publicServiceUri} <http://data.europa.eu/m8g/thematicArea> <http://data.lblod.info/id/concept/ipdc-thema/af1a1d7dbf9b12d423315706133141b8> .
        ${publicServiceUri} <http://purl.org/dc/terms/source> <http://data.lblod.info/id/public-services/a139c22b4691447ca9ab3409d380c95c> .



        <http://data.lblod.info/id/cost/${costId}> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://data.europa.eu/m8g/Cost> .
        <http://data.lblod.info/id/cost/${costId}> <http://mu.semte.ch/vocabularies/core/uuid> """${costId}""" .

        <http://data.lblod.info/id/cost/${costId}> <http://purl.org/dc/terms/title> """ """@nl .
        <http://data.lblod.info/id/cost/${costId}> <http://purl.org/dc/terms/title> """ """@en .
        <http://data.lblod.info/id/cost/${costId}> <http://purl.org/dc/terms/description> """ """@en .
        <http://data.lblod.info/id/cost/${costId}> <http://purl.org/dc/terms/description> """ """@nl .
        
        <http://data.lblod.info/id/cost/${costId}> <http://purl.org/dc/terms/source> <http://data.lblod.info/id/cost/7dae44408cdd490ca75779bdb57f6c29> .



        <http://data.lblod.info/id/rule/${ruleId}> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://purl.org/vocab/cpsv#Rule> .
        <http://data.lblod.info/id/rule/${ruleId}> <http://mu.semte.ch/vocabularies/core/uuid> """${ruleId}""" .

        <http://data.lblod.info/id/rule/${ruleId}> <http://purl.org/dc/terms/title> """ """@nl .
        <http://data.lblod.info/id/rule/${ruleId}> <http://purl.org/dc/terms/description> """ """@nl .
        <http://data.lblod.info/id/rule/${ruleId}> <http://purl.org/dc/terms/description> """ """@en .
        <http://data.lblod.info/id/rule/${ruleId}> <http://purl.org/dc/terms/title> """ """@en .

        <http://data.lblod.info/id/rule/${ruleId}> <http://lblod.data.gift/vocabularies/lpdc-ipdc/hasOnlineProcedure> <http://data.lblod.info/id/website/${websiteId}> .

        <http://data.lblod.info/id/rule/${ruleId}> <http://purl.org/dc/terms/source> <http://data.lblod.info/id/rule/33b49d1600014ffebf84d03dd7f8f96b_4> .
        


        <http://data.lblod.info/id/requirement/${requirementId}> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://data.europa.eu/m8g/Requirement> .
        <http://data.lblod.info/id/requirement/${requirementId}> <http://mu.semte.ch/vocabularies/core/uuid> """${requirementId}""" .

        <http://data.lblod.info/id/requirement/${requirementId}> <http://purl.org/dc/terms/title> """ """@en .
        <http://data.lblod.info/id/requirement/${requirementId}> <http://data.europa.eu/m8g/hasSupportingEvidence> <http://data.lblod.info/id/evidence/${evidenceId}> .
        <http://data.lblod.info/id/requirement/${requirementId}> <http://purl.org/dc/terms/title> """ """@nl .
        <http://data.lblod.info/id/requirement/${requirementId}> <http://purl.org/dc/terms/description> """ """@en .
        <http://data.lblod.info/id/requirement/${requirementId}> <http://purl.org/dc/terms/description> """ """@nl .

        <http://data.lblod.info/id/requirement/${requirementId}> <http://purl.org/dc/terms/source> <http://data.lblod.info/id/requirement/3f7d6ac1e48b4308a2ef19d0a09ada33> .
        


        <http://data.lblod.info/id/website/${websiteId}> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://schema.org/Website> .
        <http://data.lblod.info/id/website/${websiteId}> <http://mu.semte.ch/vocabularies/core/uuid> """${websiteId}""" .

        <http://data.lblod.info/id/website/${websiteId}> <http://purl.org/dc/terms/description> """ """@nl .
        <http://data.lblod.info/id/website/${websiteId}> <http://schema.org/url> <https://www.google.com> .
        <http://data.lblod.info/id/website/${websiteId}> <http://purl.org/dc/terms/description> """ """@en .
        <http://data.lblod.info/id/website/${websiteId}> <http://purl.org/dc/terms/title> """ """@en .
        <http://data.lblod.info/id/website/${websiteId}> <http://purl.org/dc/terms/title> """ """@nl .

        <http://data.lblod.info/id/website/${websiteId}> <http://purl.org/dc/terms/source> <http://data.lblod.info/id/website/ac71fc7d-8c47-4b27-95b5-f95e57cb42c9> .



        <http://data.lblod.info/id/evidence/${evidenceId}> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://data.europa.eu/m8g/Evidence> .
        <http://data.lblod.info/id/evidence/${evidenceId}> <http://mu.semte.ch/vocabularies/core/uuid> """${evidenceId}""" .
        
        <http://data.lblod.info/id/evidence/${evidenceId}> <http://purl.org/dc/terms/description> """ """@en .
        <http://data.lblod.info/id/evidence/${evidenceId}> <http://purl.org/dc/terms/description> """ """@nl .
        <http://data.lblod.info/id/evidence/${evidenceId}> <http://purl.org/dc/terms/title> """ """@en .
        <http://data.lblod.info/id/evidence/${evidenceId}> <http://purl.org/dc/terms/title> """ """@nl .

        <http://data.lblod.info/id/evidence/${evidenceId}> <http://purl.org/dc/terms/source> <http://data.lblod.info/id/evidence/8f642632-c3ed-4eb1-8d59-b2f2c9a73218> .
