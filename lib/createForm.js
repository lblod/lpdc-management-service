...
export async function createForm(conceptId) {
  ...
  const publicServiceQuery = `
    ...
    CONSTRUCT  {
      <http://dummy> a cpsv:PublicService;
    ...
    WHERE  {
      ...
      OPTIONAL{ ${sparqlEscapeUri(conceptUri)} lpdcExt:yourEuropeCategory ?eucategory . }
      OPTIONAL{ ${sparqlEscapeUri(conceptUri)} lpdcExt:publicationMedium ?medium . }
      OPTIONAL{ ${sparqlEscapeUri(conceptUri)} lpdcExt:hasExecutingAuthority ?executingAuthority . }
      OPTIONAL{ ${sparqlEscapeUri(conceptUri)} lpdcExt:executingAuthorityLevel ?executingAuthorityLevel . }
      OPTIONAL{ ${sparqlEscapeUri(conceptUri)} lpdcExt:competentAuthorityLevel ?competentAuthorityLevel .}
      ...
      OPTIONAL{ ${sparqlEscapeUri(conceptUri)} lpdcExt:hasAttachment ?attachment. }
