...
async function isConceptChanged(newSnapshotUri, currentSnapshotUri) {
...
async function updateLatestFunctionalChange(conceptSnapshotUri, conceptUri) {
    const queryStr = `
   ${PREFIXES}
   DELETE {
...
//     DELETE {
//     GRAPH <http://mu.semte.ch/graphs/public> {
//     <https://ipdc.tni-vlaanderen.be/id/concept/9a69eb39-c6c2-4244-aedd-1847d4f72586> lpdcExt:hasLatestFunctionalChange ?snapshot.
// }
//     }
//     INSERT {
//     GRAPH <http://mu.semte.ch/graphs/public> {
//     <https://ipdc.tni-vlaanderen.be/id/concept/9a69eb39-c6c2-4244-aedd-1847d4f72586> lpdcExt:hasLatestFunctionalChange <https://ipdc.tni-vlaanderen.be/id/conceptsnapshot/ad6635b9-6259-414b-968e-458e7e4a38e1>.
// }
//     }
//     WHERE {
//     GRAPH <http://mu.semte.ch/graphs/public> {
//     <https://ipdc.tni-vlaanderen.be/id/concept/9a69eb39-c6c2-4244-aedd-1847d4f72586> a lpdcExt:ConceptualPublicService.
//     OPTIONAL {
//     <https://ipdc.tni-vlaanderen.be/id/concept/9a69eb39-c6c2-4244-aedd-1847d4f72586> lpdcExt:hasLatestFunctionalChange ?snapshot.
// }
//     }
