...
async function setStatus(status, conceptUri){
  ...
  let statusStr = "";
  if(status==='updated'){
    statusStr="<http://lblod.data.gift/concepts/5a3168e2-f39b-4b5d-8638-29f935023c83>."
  }
  else if(status==='deleted'){
    statusStr="<http://lblod.data.gift/concepts/cf22e8d1-23c3-45da-89bc-00826eaf23c3>."
  }
  else{
    return;
  }
  ...
  const queryStr=`
    ...
    INSERT{
      GRAPH ?g {
        ?service ext:reviewStatus ${statusStr}
      }
    }
    DELETE{
      GRAPH ?g {
