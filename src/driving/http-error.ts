...
export class BadRequest extends HttpError {
  constructor(
    message = "Aanvraag ongeldig. Controleer en probeer opnieuw.",
    invariantError: InvariantError = undefined,
  ) {
    super(
      400,
      invariantError?.message ? invariantError.message : message,
      invariantError,
    );
  }
}
...
export class Forbidden extends HttpError {
  constructor(
    ...
    super(
      403,
      forbiddenError?.message ? forbiddenError.message : message,
      forbiddenError,
    );
  }
}
...
export class NotFound extends HttpError {
  constructor(
    ...
    super(
      404,
      notFoundError?.message ? notFoundError.message : message,
      notFoundError,
    );
  }
}
