...
export class Requirement {
  ...
  static forConcept(requirement: Requirement): Requirement {
    return new Requirement(
      ...
      requirement.evidence
        ? Evidence.forConcept(requirement.evidence)
        : undefined,
    );
  }
  ...
  static forConceptSnapshot(requirement: Requirement): Requirement {
    return new Requirement(
      ...
      requirement.order,
      requirement.evidence
        ? Evidence.forConceptSnapshot(requirement.evidence)
        : undefined,
    );
  }
  ...
  static forInstance(requirement: Requirement): Requirement {
    ...
    return new Requirement(
      ...
      requirement.order,
      requirement.evidence
        ? Evidence.forInstance(requirement.evidence)
        : undefined,
    );
  }
  ...
  static forInstanceSnapshot(requirement: Requirement): Requirement {
    ...
    return new Requirement(
      ...
      requirement.order,
      requirement.evidence
        ? Evidence.forInstanceSnapshot(requirement.evidence)
        : undefined,
    );
  }
  ...
  get nlLanguage(): Language | undefined {
    return (
      LanguageString.extractLanguages([this._title, this._description])[0] ??
      this._evidence?.nlLanguage
    );
  }
  ...
  static isFunctionallyChanged(
    ...
    return (
      ...
      zip(value, other).some((reqs: [Requirement, Requirement]) => {
        return (
          LanguageString.isFunctionallyChanged(reqs[0].title, reqs[1].title) ||
