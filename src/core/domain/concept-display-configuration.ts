...
export class ConceptDisplayConfiguration {
  ...
  public constructor(
    ...
    this._conceptIsInstantiated = requiredValue(
      conceptIsInstantiated,
      "conceptIsInstantiated",
    );
...
export class ConceptDisplayConfigurationBuilder {
  ...
  public static from(
  ...
  ): ConceptDisplayConfigurationBuilder {
    return new ConceptDisplayConfigurationBuilder()
      ...
      .withConceptIsInstantiated(
        conceptDisplayConfiguration.conceptIsInstantiated,
      )
  ...
  public withConceptIsInstantiated(
    conceptIsInstantiated: boolean,
  ): ConceptDisplayConfigurationBuilder {
