...
export class EnsureLinkedAuthoritiesExistAsCodeListDomainService {
    ...
    private readonly _logger: Logger = new Logger('EnsureLinkedAuthoritiesExistAsCodeListDomainService');
    ...
    async ensureLinkedAuthoritiesExistAsCodeList(linkedAuthorities: Iri[]): Promise<void> {
