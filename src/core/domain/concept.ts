...
export class Concept {
  ...
  constructor(
    ...
    this._latestConceptSnapshot = requiredValue(
      latestConceptSnapshot,
      "latestConceptSnapshot",
    );
    this._previousConceptSnapshots = requireNoDuplicates(
      asSortedArray(previousConceptSnapshots, Iri.compare),
      "previousConceptSnapshots",
    );
    this._latestFunctionallyChangedConceptSnapshot = requiredValue(
  ...
  get appliedConceptSnapshots(): Iri[] {
    return [
      ...uniqWith(
        [this._latestConceptSnapshot, ...this._previousConceptSnapshots],
        isEqual,
      ),
    ];
  }
