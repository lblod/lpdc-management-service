...
export class InvariantError extends LpdcError {
  constructor(
    message: string = "Validatie mislukt. Controleer de ingevoerde gegevens en probeer opnieuw.",
  ) {
    super(message);
  }
}
...
export class ConcurrentUpdateError extends LpdcError {
  constructor(
    message: string = "De gegevens zijn gelijktijdig aangepast door een andere gebruiker. Herlaad de pagina en geef je aanpassingen opnieuw in.",
  ) {
    super(message);
  }
}
...
export class ForbiddenError extends LpdcError {
  constructor(
    message: string = "Toegang geweigerd. U heeft geen rechten voor deze actie.",
  ) {
    super(message);
  }
}
...
export class SystemError extends LpdcError {
  constructor(
    message: string = "Er is een serverfout opgetreden. Probeer het later opnieuw of neem contact op indien het probleem aanhoudt. Onze excuses voor het ongemak.",
  ) {
    super(message);
  }
}
