import { BestuurseenheidRegistrationCodeFetcher } from "../../core/port/driven/external/bestuurseenheid-registration-code-fetcher";
import { Iri } from "../../core/domain/shared/iri";

export class BestuurseenheidRegistrationCodeThroughSubjectPageOrApiFetcher
  implements BestuurseenheidRegistrationCodeFetcher
{
  async fetchOrgRegistryCodelistEntry(
    uriEntry: string,
  ...
  private async fetchOrgRegistryCodelistEntryThroughSubjectPage(
    uriEntry: string,
  ): Promise<{
    uri?: Iri;
    prefLabel?: string;
  ...
  private async fetchOrgRegistryCodelistEntryThroughAPI(
    uriEntry: string,
  ): Promise<{
    uri?: Iri;
    prefLabel?: string;
