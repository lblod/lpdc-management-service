...
const dataVlaanderenConceptNS = Namespace(
...
export const NS = {
  ...
  dvc: {
    ...
    bevoegdBestuursniveau: Namespace(
      dataVlaanderenConceptNS("BevoegdBestuursniveau/").value,
    ),
    uitvoerendBestuursniveau: Namespace(
      dataVlaanderenConceptNS("UitvoerendBestuursniveau/").value,
    ),
    publicatieKanaal: Namespace(
      dataVlaanderenConceptNS("PublicatieKanaal/").value,
    ),
    yourEuropeCategorie: Namespace(
      dataVlaanderenConceptNS("YourEuropeCategorie/").value,
    ),
