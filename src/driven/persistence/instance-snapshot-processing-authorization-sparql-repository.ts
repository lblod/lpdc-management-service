...
import { InstanceSnapshotProcessingAuthorizationRepository } from "../../core/port/driven/persistence/instance-snapshot-processing-authorization-repository";
...
export class InstanceSnapshotProcessingAuthorizationSparqlRepository
  implements InstanceSnapshotProcessingAuthorizationRepository
{
  ...
  async canPublishInstanceToGraph(
