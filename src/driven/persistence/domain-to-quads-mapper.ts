...
export class DomainToQuadsMapper {
  ...
  public conceptToQuads(concept: Concept): Statement[] {
    return [
      ...
      concept.uuid
        ? this.buildQuad(
            namedNode(concept.id.value),
            NS.mu("uuid"),
            literal(concept.uuid),
          )
        : undefined,
      ...
      ...this.previousConceptSnapshots(
        concept.id,
        concept.previousConceptSnapshots,
      ),
  ...
  public conceptSnapshotToQuads(conceptSnapshot: ConceptSnapshot): Statement[] {
    return [
      this.rdfType(
        conceptSnapshot.id,
        NS.lpdcExt("ConceptualPublicServiceSnapshot"),
      ),
      ...
      this.buildQuad(
        namedNode(conceptSnapshot.id.value),
        NS.schema("identifier"),
        literal(conceptSnapshot.identifier),
      ),
      ...
      this.buildQuad(
        namedNode(conceptSnapshot.id.value),
        NS.lpdcExt("isArchived"),
        literal(conceptSnapshot.isArchived.toString(), NS.xsd("boolean")),
      ),
      ...this.legalResources(
        conceptSnapshot.id,
    ...
    return [
      ...
      instance.dateSent
        ? this.buildQuad(
            namedNode(instance.id.value),
            NS.schema("dateSent"),
            literal(instance.dateSent.value, NS.xsd("dateTime")),
          )
        : undefined,
  ...
  public instanceSnapshotToQuads(
    instanceSnapshot: InstanceSnapshot,
  ): Statement[] {
    return [
      this.rdfType(
        instanceSnapshot.id,
        NS.lpdcExt("InstancePublicServiceSnapshot"),
      ),
      ...
      this.buildQuad(
        namedNode(instanceSnapshot.id.value),
        NS.lpdcExt("isArchived"),
        literal(instanceSnapshot.isArchived.toString(), NS.xsd("boolean")),
      ),
      ...this.requirements(instanceSnapshot.id, instanceSnapshot.requirements),
      ...this.websites(
        instanceSnapshot.id,
        NS.rdfs("seeAlso"),
        instanceSnapshot.websites,
      ),
      ...this.procedures(instanceSnapshot.id, instanceSnapshot.procedures),
      ...this.costs(instanceSnapshot.id, instanceSnapshot.costs),
      ...this.financialAdvantages(
        instanceSnapshot.id,
        instanceSnapshot.financialAdvantages,
      ),
      ...this.contactPoints(
        instanceSnapshot.id,
        instanceSnapshot.contactPoints,
      ),
    ].filter((t) => t !== undefined);
  }

  public publishedInstanceSnapshotToQuads(
    publishedInstanceSnapshot: PublishedInstanceSnapshot,
  ): Statement[] {
    return [
      this.rdfType(
        publishedInstanceSnapshot.id,
        NS.lpdcExt("PublishedInstancePublicServiceSnapshot"),
      ),
      this.generatedAtTime(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.generatedAtTime,
      ),
      this.isPublishedVersionOf(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.isPublishedVersionOf,
      ),
      this.createdBy(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.createdBy,
      ),
      ...this.title(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.title,
      ),
      ...this.description(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.description,
      ),
      ...this.additionalDescription(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.additionalDescription,
      ),
      ...this.exception(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.exception,
      ),
      ...this.regulation(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.regulation,
      ),
      this.startDate(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.startDate,
      ),
      this.endDate(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.endDate,
      ),
      this.type(publishedInstanceSnapshot.id, publishedInstanceSnapshot.type),
      ...this.targetAudiences(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.targetAudiences,
      ),
      ...this.themes(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.themes,
      ),
      ...this.competentAuthorityLevels(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.competentAuthorityLevels,
      ),
      ...this.competentAuthorities(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.competentAuthorities,
      ),
      ...this.executingAuthorityLevels(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.executingAuthorityLevels,
      ),
      ...this.executingAuthorities(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.executingAuthorities,
      ),
      ...this.publicationMedia(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.publicationMedia,
      ),
      ...this.yourEuropeCategories(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.yourEuropeCategories,
      ),
      ...this.keywords(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.keywords,
      ),
      ...this.requirements(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.requirements,
      ),
      ...this.procedures(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.procedures,
      ),
      ...this.websites(
        publishedInstanceSnapshot.id,
        NS.rdfs("seeAlso"),
        publishedInstanceSnapshot.websites,
      ),
      ...this.costs(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.costs,
      ),
      ...this.financialAdvantages(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.financialAdvantages,
      ),
      ...this.contactPoints(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.contactPoints,
      ),
      this.conceptId(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.conceptId,
      ),
      ...this.languages(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.languages,
      ),
      this.dateCreated(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.dateCreated,
      ),
      this.dateModified(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.dateModified,
      ),
      ...this.spatials(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.spatials,
      ),
      ...this.legalResources(
        publishedInstanceSnapshot.id,
        publishedInstanceSnapshot.legalResources,
      ),
    ].filter((t) => t !== undefined);
  }

  private buildQuad(subject: any, predicate: any, object: any) {
  ...
  private creator(id: Iri, value: Iri | undefined) {
    return value
      ? this.buildQuad(
          namedNode(id.value),
          NS.dct("creator"),
  ...
  private lastModifier(id: Iri, value: Iri | undefined) {
    return value
      ? this.buildQuad(
          namedNode(id.value),
  ...
  type(id: Iri, value: ProductType): Statement | undefined {
    return value
      ? this.buildQuad(
          namedNode(id.value),
          NS.dct("type"),
          namedNode(this.enumToIri(value, NS.dvc.type).value),
        )
      : undefined;
  }
  ...
  private title(id: Iri, value: LanguageString): Statement[] {
    return this.languageStringToQuads(
      namedNode(id.value),
      NS.dct("title"),
      value,
    );
  ...
  private additionalDescription(id: Iri, value: LanguageString): Statement[] {
    return this.languageStringToQuads(
      namedNode(id.value),
      NS.lpdcExt("additionalDescription"),
      value,
    );
  }
  ...
  private regulation(id: Iri, value: LanguageString): Statement[] {
    return this.languageStringToQuads(
      namedNode(id.value),
      NS.lpdcExt("regulation"),
      value,
    );
  }

  targetAudiences(id: Iri, values: TargetAudienceType[]): Statement[] {
    return this.irisToQuads(
      namedNode(id.value),
      NS.lpdcExt("targetAudience"),
      this.enumsToIris(values, NS.dvc.doelgroep),
    );
  }
  ...
  themes(id: Iri, values: ThemeType[]): Statement[] {
    return this.irisToQuads(
      namedNode(id.value),
      NS.m8g("thematicArea"),
      this.enumsToIris(values, NS.dvc.thema),
    );
  }

  competentAuthorityLevels(
    id: Iri,
    values: CompetentAuthorityLevelType[],
  ): Statement[] {
    return this.irisToQuads(
      namedNode(id.value),
      NS.lpdcExt("competentAuthorityLevel"),
      this.enumsToIris(values, NS.dvc.bevoegdBestuursniveau),
    );
  }
  ...
  executingAuthorityLevels(
    id: Iri,
    values: ExecutingAuthorityLevelType[],
  ): Statement[] {
    return this.irisToQuads(
      namedNode(id.value),
      NS.lpdcExt("executingAuthorityLevel"),
      this.enumsToIris(values, NS.dvc.uitvoerendBestuursniveau),
    );
  }
  ...
  private executingAuthorities(id: Iri, values: Iri[]): Statement[] {
    return this.irisToQuads(
      namedNode(id.value),
      NS.lpdcExt("hasExecutingAuthority"),
      values,
    );
  }
  ...
  publicationMedia(id: Iri, values: PublicationMediumType[]): Statement[] {
    return this.irisToQuads(
      namedNode(id.value),
      NS.lpdcExt("publicationMedium"),
      this.enumsToIris(values, NS.dvc.publicatieKanaal),
    );
  }
  ...
  yourEuropeCategories(id: Iri, values: YourEuropeCategoryType[]): Statement[] {
    return this.irisToQuads(
      namedNode(id.value),
      NS.lpdcExt("yourEuropeCategory"),
      this.enumsToIris(values, NS.dvc.yourEuropeCategorie),
    );
  }

  private keywords(id: Iri, values: LanguageString[]): Statement[] {
    return values.flatMap((keyword) =>
      this.languageStringToQuads(
        namedNode(id.value),
        namedNode(NS.dcat("keyword").value),
        keyword,
      ),
    );
  }
  ...
  conceptTags(id: Iri, values: ConceptTagType[]): Statement[] {
    return this.irisToQuads(
      namedNode(id.value),
      NS.lpdcExt("conceptTag"),
      this.enumsToIris(values, NS.dvc.conceptTag),
    );
  }
  ...
  instanceStatus(id: Iri, value: InstanceStatusType): Statement {
    return this.buildQuad(
      namedNode(id.value),
      NS.adms("status"),
      namedNode(this.enumToIri(value, NS.concepts.instanceStatus).value),
    );
  }

  reviewStatus(
    id: Iri,
    value: InstanceReviewStatusType | undefined,
  ): Statement | undefined {
    return value
      ? this.buildQuad(
          namedNode(id.value),
          NS.ext("reviewStatus"),
          namedNode(this.enumToIri(value, NS.concepts.reviewStatus).value),
        )
      : undefined;
  }
  ...
  private latestConceptSnapshot(id: Iri, value: Iri): Statement {
    return this.buildQuad(
      namedNode(id.value),
      NS.ext("hasVersionedSource"),
      namedNode(value.value),
    );
  }

  private latestFunctionallyChangedConceptSnapshot(
    id: Iri,
    value: Iri,
  ): Statement {
    return this.buildQuad(
      namedNode(id.value),
      NS.lpdc("hasLatestFunctionalChange"),
      namedNode(value.value),
    );
  }
  ...
  private previousConceptSnapshots(id: Iri, values: Iri[]): Statement[] {
    return values.map((v) =>
      this.buildQuad(
        namedNode(id.value),
        NS.ext("previousVersionedSource"),
        namedNode(v.value),
      ),
    );
  }
  ...
  private requirements(id: Iri, values: Requirement[]): Statement[] {
    return values.flatMap((requirement) => [
      this.buildQuad(
        namedNode(id.value),
        NS.ps("hasRequirement"),
        namedNode(requirement.id.value),
      ),
      requirement.uuid
        ? this.buildQuad(
            namedNode(requirement.id.value),
            NS.mu("uuid"),
            literal(requirement.uuid),
          )
        : undefined,
      this.buildQuad(
        namedNode(requirement.id.value),
      ...
      this.buildQuad(
        namedNode(requirement.id.value),
        NS.sh("order"),
        literal(requirement.order.toString(), NS.xsd("integer")),
      ),
      ...this.evidenceToQuads(requirement.id, requirement.evidence),
    ]);
  }

  private evidenceToQuads(
    requirementId: Iri,
    ...
    return evidence
      ? [
          this.buildQuad(
            namedNode(requirementId.value),
            NS.m8g("hasSupportingEvidence"),
            namedNode(evidence.id.value),
          ),
          evidence.uuid
            ? this.buildQuad(
                namedNode(evidence.id.value),
                NS.mu("uuid"),
                literal(evidence.uuid),
              )
            : undefined,
          this.buildQuad(
            namedNode(evidence.id.value),
  ...
  private procedures(id: Iri, values: Procedure[]): Statement[] {
    return values.flatMap((procedure) => [
      this.buildQuad(
        namedNode(id.value),
        NS.cpsv("follows"),
        namedNode(procedure.id.value),
      ),
      procedure.uuid
        ? this.buildQuad(
            namedNode(procedure.id.value),
            NS.mu("uuid"),
            literal(procedure.uuid),
          )
        : undefined,
      this.buildQuad(
        namedNode(procedure.id.value),
      ...
      this.buildQuad(
        namedNode(procedure.id.value),
        NS.sh("order"),
        literal(procedure.order.toString(), NS.xsd("integer")),
      ),
      ...this.websites(
        procedure.id,
        NS.lpdcExt("hasWebsite"),
        procedure.websites,
      ),
    ]);
  }
      ...
      .flatMap((website) => {
        return [
          this.buildQuad(
            namedNode(id.value),
            predicate,
            namedNode(website.id.value),
          ),
          website.uuid
            ? this.buildQuad(
                namedNode(website.id.value),
                NS.mu("uuid"),
                literal(website.uuid),
              )
            : undefined,
          this.buildQuad(
            namedNode(website.id.value),
          ...
          this.buildQuad(
            namedNode(website.id.value),
            NS.sh("order"),
            literal(website.order.toString(), NS.xsd("integer")),
          ),
        ];
      })
      .filter((t) => t != undefined);
    ...
    return values.flatMap((cost) => {
      return [
        ...
        this.buildQuad(
          namedNode(cost.id.value),
          NS.sh("order"),
          literal(cost.order.toString(), NS.xsd("integer")),
        ),
      ];
    });
  }

  private financialAdvantages(
    id: Iri,
    values: FinancialAdvantage[],
  ): Statement[] {
    return values.flatMap((financialAdvantage) => {
      return [
        this.buildQuad(
          namedNode(id.value),
          NS.cpsv("produces"),
          namedNode(financialAdvantage.id.value),
        ),
        financialAdvantage.uuid
          ? this.buildQuad(
              namedNode(financialAdvantage.id.value),
              NS.mu("uuid"),
              literal(financialAdvantage.uuid),
            )
          : undefined,
        this.buildQuad(
          namedNode(financialAdvantage.id.value),
          NS.rdf("type"),
          NS.lpdcExt("FinancialAdvantage"),
        ),
        ...this.languageStringToQuads(
          namedNode(financialAdvantage.id.value),
          NS.dct(`title`),
        ...
        this.buildQuad(
          namedNode(financialAdvantage.id.value),
          NS.sh("order"),
          literal(financialAdvantage.order.toString(), NS.xsd("integer")),
        ),
      ];
    });
  }
  ...
  private legalResources(id: Iri, values: LegalResource[]): Statement[] {
    return values.flatMap((legalResource) => [
      this.buildQuad(
        namedNode(id.value),
        NS.m8g("hasLegalResource"),
        namedNode(legalResource.id.value),
      ),
      legalResource.uuid
        ? this.buildQuad(
            namedNode(legalResource.id.value),
            NS.mu("uuid"),
            literal(legalResource.uuid),
          )
        : undefined,
      this.buildQuad(
        namedNode(legalResource.id.value),
        NS.rdf("type"),
        NS.eli("LegalResource"),
      ),
      ...this.languageStringToQuads(
        namedNode(legalResource.id.value),
        NS.dct("title"),
      ...
      legalResource.url !== undefined
        ? this.buildQuad(
            namedNode(legalResource.id.value),
            NS.schema("url"),
            literal(legalResource.url),
          )
        : undefined,
      this.buildQuad(
        namedNode(legalResource.id.value),
        NS.sh("order"),
        literal(legalResource.order.toString(), NS.xsd("integer")),
      ),
    ]);
  }
  ...
  private contactPoints(id: Iri, values: ContactPoint[]): Statement[] {
    return values.flatMap((contactPoint) => {
      return [
        this.buildQuad(
          namedNode(id.value),
          NS.m8g("hasContactPoint"),
          namedNode(contactPoint.id.value),
        ),
        contactPoint.uuid
          ? this.buildQuad(
              namedNode(contactPoint.id.value),
              NS.mu("uuid"),
              literal(contactPoint.uuid),
            )
          : undefined,
        this.buildQuad(
          namedNode(contactPoint.id.value),
        ...
        contactPoint.telephone !== undefined
          ...
          : undefined,
        contactPoint.openingHours !== undefined
          ? this.buildQuad(
              namedNode(contactPoint.id.value),
              NS.schema("openingHours"),
        ...
        this.buildQuad(
          namedNode(contactPoint.id.value),
          NS.sh("order"),
          literal(contactPoint.order.toString(), NS.xsd("integer")),
        ),
  ...
  private addressToQuads(
    ...
    return address
      ? [
          this.buildQuad(
            namedNode(contactPointId.value),
            NS.lpdcExt("address"),
            namedNode(address.id.value),
          ),
          address.uuid
            ? this.buildQuad(
                namedNode(address.id.value),
                NS.mu("uuid"),
                literal(address.uuid),
              )
            : undefined,
          this.buildQuad(
            namedNode(address.id.value),
  ...
  private isVersionOf(id: Iri, anIri: Iri | undefined): Statement | undefined {
    return anIri
      ? this.buildQuad(
          namedNode(id.value),
          NS.dct("isVersionOf"),
          namedNode(anIri.value),
        )
      : undefined;
  }

  private isPublishedVersionOf(
    id: Iri,
    anIri: Iri | undefined,
  ): Statement | undefined {
    return anIri
      ? this.buildQuad(
          namedNode(id.value),
          NS.lpdcExt("isPublishedVersionOf"),
          namedNode(anIri.value),
        )
      : undefined;
  }
  private conceptSnapshotId(
    id: Iri,
    ...
    return versionedSource
      ? this.buildQuad(
          namedNode(id.value),
          NS.ext("hasVersionedSource"),
          namedNode(versionedSource.value),
        )
      : undefined;
  }
  ...
  languages(id: Iri, values: LanguageType[]): Statement[] {
    return this.irisToQuads(
      namedNode(id.value),
      NS.dct("language"),
      this.enumsToIris(values, NS.pera.languageType),
    );
  }
  ...
  private dutchLanguageVariant(id: Iri, value: Language): Statement {
    return this.buildQuad(
      namedNode(id.value),
      NS.lpdcExt("dutchLanguageVariant"),
      value,
    );
  }

  private needsConversionFromFormalToInformal(
    id: Iri,
  ...
  private forMunicipalityMerger(
    ...
    return this.buildQuad(
      namedNode(id.value),
      NS.lpdcExt("forMunicipalityMerger"),
      literal(forMunicipalityMerger.toString(), NS.xsd("boolean")),
    );
  }

  private verwijstNaar(
    id: Iri,
    ...
    return verwijstNaar
      ? this.buildQuad(
          namedNode(id.value),
          NS.adres("verwijstNaar"),
          namedNode(verwijstNaar.value),
        )
      : undefined;
  }

  private languageStringToQuads(
    subject: NamedNode,
    predicate: NamedNode,
    object: LanguageString | undefined,
  ): Statement[] {
    return object
      ? [
          ["nl", object.nl],
          ...
          .map((tuple) =>
            this.buildQuad(subject, predicate, literal(tuple[1], tuple[0])),
          )
      : [];
  }
